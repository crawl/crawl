...
| levelup_stats | `array of strings` or `str` | No | Which stats the species' periodic stat-up can randomly select from. Defaults to `[str, dex, int]`. Set to `none` for cases where levelup stats happen outside of the usual system. |

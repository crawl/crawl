...
| difficulty | `string` | No | Which column the species is located in on the new game species select screen. Can be `Simple`, `Intermediate`, `Advanced`, or `false` (will not be shown on species select screen). Defaults to `Intermediate`. |

...
static const vector<god_passive> god_passives[NUM_GODS] =
{
    ...
    // Qazlal
    {
        { -1, passive_t::resist_own_clouds, "clouds generated by your actions don't harm you" },
        {  0, passive_t::storm_shield, "generate elemental clouds to protect you" },
        {  3, passive_t::upgraded_storm_shield, "chances to be struck by projectiles are reduced" },
        {  3, passive_t::elemental_adaptation, "elemental attacks leaves you somewhat more resistant to themxo" }
    },

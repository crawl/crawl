...
static const vector<god_passive> god_passives[] =
{
 ...
 //             "GOD NOW summons jellies to protect you" },
        ...
        { -1, passive_t::jiyva_kill_to_slime,
              "GOD NOW Turn a killed enemy into jellies" },
    ...
    // Imus Thea
    {
        ...
        { 2, passive_t::imus_fire_illusory_weapon, "can fire a illusory replication of weapon." },
    },
...
void ash_check_bondage(bool msg)
{
    ...
    if (you.species == SP_FELID)
    {
        ...
        if (you.equip[EQ_CLOAK] != -1 && you.inv[you.equip[EQ_CLOAK]].cursed())
                ++you.bondage_level;
    }
    else
        for (int i = ET_WEAPON; i < NUM_ET; ++i)

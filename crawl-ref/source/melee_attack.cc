...
melee_attack::melee_attack(actor *attk, actor *defn,
    ...
    art_props(0), unrand_entry(NULL), special_damage_flavour(BEAM_NONE),
...
// TODO: Potentially remove, should be a method of monster class, or actor
void melee_attack::_steal_item_from_player(monster* mon)
{
    if (mon->confused())
    {

...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    // SP_FORGE_DWARF
    APT(SP_FORGE_DWARF,  SK_FIGHTING,        0),
    APT(SP_FORGE_DWARF,  SK_SHORT_BLADES,    0),
    APT(SP_FORGE_DWARF,  SK_LONG_BLADES,    -1),
    APT(SP_FORGE_DWARF,  SK_AXES,            0),
    APT(SP_FORGE_DWARF,  SK_MACES_FLAILS,    1),
    APT(SP_FORGE_DWARF,  SK_POLEARMS,       -1),
    APT(SP_FORGE_DWARF,  SK_STAVES,         -2),
    APT(SP_FORGE_DWARF,  SK_SLINGS,         -1),
    APT(SP_FORGE_DWARF,  SK_BOWS,           -2),
    APT(SP_FORGE_DWARF,  SK_CROSSBOWS,       3),
    APT(SP_FORGE_DWARF,  SK_THROWING,       -1),
    APT(SP_FORGE_DWARF,  SK_ARMOUR,          3),
    APT(SP_FORGE_DWARF,  SK_DODGING,        -1),
    APT(SP_FORGE_DWARF,  SK_STEALTH,        -1),
    APT(SP_FORGE_DWARF,  SK_STABBING,       -2),
    APT(SP_FORGE_DWARF,  SK_SHIELDS,         2),
    APT(SP_FORGE_DWARF,  SK_TRAPS_DOORS,     2),
    APT(SP_FORGE_DWARF,  SK_UNARMED_COMBAT,  0),
    APT(SP_FORGE_DWARF,  SK_SPELLCASTING,   -3),
    APT(SP_FORGE_DWARF,  SK_CONJURATIONS,    0),
    APT(SP_FORGE_DWARF,  SK_HEXES,          -1),
    APT(SP_FORGE_DWARF,  SK_CHARMS,         -3),
    APT(SP_FORGE_DWARF,  SK_SUMMONINGS,     -2),
    APT(SP_FORGE_DWARF,  SK_NECROMANCY,     -3),
    APT(SP_FORGE_DWARF,  SK_TRANSLOCATIONS, -2),
    APT(SP_FORGE_DWARF,  SK_TRANSMUTATIONS,  0),
    APT(SP_FORGE_DWARF,  SK_FIRE_MAGIC,      3),
    APT(SP_FORGE_DWARF,  SK_ICE_MAGIC,      -4),
    APT(SP_FORGE_DWARF,  SK_AIR_MAGIC,      -2),
    APT(SP_FORGE_DWARF,  SK_EARTH_MAGIC,     2),
    APT(SP_FORGE_DWARF,  SK_POISON_MAGIC,    0),
    APT(SP_FORGE_DWARF,  SK_INVOCATIONS,     0),
    APT(SP_FORGE_DWARF,  SK_EVOCATIONS,      3),
};

...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    // SP_OGRE
    APT(SP_OGRE,            SK_FIGHTING,        0),
    APT(SP_OGRE,            SK_SHORT_BLADES,   -2),
    APT(SP_OGRE,            SK_LONG_BLADES,    -1),
    APT(SP_OGRE,            SK_AXES,            0),
    APT(SP_OGRE,            SK_MACES_FLAILS,    0),
    ...
    APT(SP_OGRE,            SK_DODGING,        -2),
    APT(SP_OGRE,            SK_STEALTH,        -4),
#if TAG_MAJOR_VERSION == 34
    ...
    APT(SP_OGRE,            SK_SPELLCASTING,   -5),
    APT(SP_OGRE,            SK_CONJURATIONS,   -3),
    APT(SP_OGRE,            SK_HEXES,          -5),
    APT(SP_OGRE,            SK_CHARMS,         -5),
    APT(SP_OGRE,            SK_SUMMONINGS,     -4),
    APT(SP_OGRE,            SK_NECROMANCY,     -2),
    ...
    // SP_ELF
    APT(SP_ELF,             SK_FIGHTING,       -1),
    APT(SP_ELF,             SK_SHORT_BLADES,    1),
    APT(SP_ELF,             SK_LONG_BLADES,    -1),
    APT(SP_ELF,             SK_AXES,           -1),
    APT(SP_ELF,             SK_MACES_FLAILS,   -2),
    APT(SP_ELF,             SK_POLEARMS,       -2),
    APT(SP_ELF,             SK_STAVES,          0),
    APT(SP_ELF,             SK_SLINGS,         -1),
    APT(SP_ELF,             SK_BOWS,            3),
    APT(SP_ELF,             SK_CROSSBOWS,       0),
    APT(SP_ELF,             SK_THROWING,        1),
    APT(SP_ELF,             SK_ARMOUR,         -1),
    APT(SP_ELF,             SK_DODGING,         1),
    APT(SP_ELF,             SK_STEALTH,         1),
#if TAG_MAJOR_VERSION == 34
    APT(SP_ELF,             SK_STABBING,      -99),
#endif
    APT(SP_ELF,             SK_SHIELDS,        -1),
#if TAG_MAJOR_VERSION == 34
    APT(SP_ELF,             SK_TRAPS,         -99),
#endif
    APT(SP_ELF,             SK_UNARMED_COMBAT, -1),
    APT(SP_ELF,             SK_SPELLCASTING,    1),
    APT(SP_ELF,             SK_CONJURATIONS,    0),
    APT(SP_ELF,             SK_HEXES,           2),
    APT(SP_ELF,             SK_CHARMS,          2),
    APT(SP_ELF,             SK_SUMMONINGS,      0),
    APT(SP_ELF,             SK_NECROMANCY,     -1),
    APT(SP_ELF,             SK_TRANSLOCATIONS,  0),
    APT(SP_ELF,             SK_TRANSMUTATIONS,  0),
    APT(SP_ELF,             SK_FIRE_MAGIC,      0),
    APT(SP_ELF,             SK_ICE_MAGIC,       0),
    APT(SP_ELF,             SK_AIR_MAGIC,       2),
    APT(SP_ELF,             SK_EARTH_MAGIC,    -2),
    APT(SP_ELF,             SK_POISON_MAGIC,    1),
    APT(SP_ELF,             SK_INVOCATIONS,     0),
    APT(SP_ELF,             SK_EVOCATIONS,      1),

    // SP_HILL_DWARF
    APT(SP_HILL_DWARF,      SK_FIGHTING,        2),
    APT(SP_HILL_DWARF,      SK_SHORT_BLADES,    1),
    APT(SP_HILL_DWARF,      SK_LONG_BLADES,     1),
    APT(SP_HILL_DWARF,      SK_AXES,            3),
    APT(SP_HILL_DWARF,      SK_MACES_FLAILS,    2),
    APT(SP_HILL_DWARF,      SK_POLEARMS,       -1),
    APT(SP_HILL_DWARF,      SK_STAVES,         -2),
    APT(SP_HILL_DWARF,      SK_SLINGS,         -2),
    APT(SP_HILL_DWARF,      SK_BOWS,           -2),
    APT(SP_HILL_DWARF,      SK_CROSSBOWS,      -1),
    APT(SP_HILL_DWARF,      SK_THROWING,       -1),
    APT(SP_HILL_DWARF,      SK_ARMOUR,          2),
    APT(SP_HILL_DWARF,      SK_DODGING,        -1),
    APT(SP_HILL_DWARF,      SK_STEALTH,        -2),
#if TAG_MAJOR_VERSION == 34
    APT(SP_HILL_DWARF,      SK_STABBING,      -99),
#endif
    APT(SP_HILL_DWARF,      SK_SHIELDS,         2),
#if TAG_MAJOR_VERSION == 34
    APT(SP_HILL_DWARF,      SK_TRAPS,         -99),
#endif
    APT(SP_HILL_DWARF,      SK_UNARMED_COMBAT,  0),
    APT(SP_HILL_DWARF,      SK_SPELLCASTING,   -3),
    APT(SP_HILL_DWARF,      SK_CONJURATIONS,   -1),
    APT(SP_HILL_DWARF,      SK_HEXES,          -2),
    APT(SP_HILL_DWARF,      SK_CHARMS,         -2),
    APT(SP_HILL_DWARF,      SK_SUMMONINGS,     -2),
    APT(SP_HILL_DWARF,      SK_NECROMANCY,     -3),
    APT(SP_HILL_DWARF,      SK_TRANSLOCATIONS, -2),
    APT(SP_HILL_DWARF,      SK_TRANSMUTATIONS, -1),
    APT(SP_HILL_DWARF,      SK_FIRE_MAGIC,      1),
    APT(SP_HILL_DWARF,      SK_ICE_MAGIC,      -1),
    APT(SP_HILL_DWARF,      SK_AIR_MAGIC,      -2),
    APT(SP_HILL_DWARF,      SK_EARTH_MAGIC,     2),
    APT(SP_HILL_DWARF,      SK_POISON_MAGIC,   -2),
    APT(SP_HILL_DWARF,      SK_INVOCATIONS,     0),
    APT(SP_HILL_DWARF,      SK_EVOCATIONS,      3),

    // SP_OGRE_MAGE
    APT(SP_OGRE_MAGE,       SK_FIGHTING,        0),
    APT(SP_OGRE_MAGE,       SK_SHORT_BLADES,   -1),
    APT(SP_OGRE_MAGE,       SK_LONG_BLADES,     0),
    APT(SP_OGRE_MAGE,       SK_AXES,            0),
    APT(SP_OGRE_MAGE,       SK_MACES_FLAILS,    0),
    APT(SP_OGRE_MAGE,       SK_POLEARMS,        0),
    APT(SP_OGRE_MAGE,       SK_STAVES,          0),
    APT(SP_OGRE_MAGE,       SK_SLINGS,         -2),
    APT(SP_OGRE_MAGE,       SK_BOWS,           -2),
    APT(SP_OGRE_MAGE,       SK_CROSSBOWS,      -2),
    APT(SP_OGRE_MAGE,       SK_THROWING,       -2),
    APT(SP_OGRE_MAGE,       SK_ARMOUR,         -3),
    APT(SP_OGRE_MAGE,       SK_DODGING,        -2),
    APT(SP_OGRE_MAGE,       SK_STEALTH,         1),
#if TAG_MAJOR_VERSION == 34
    APT(SP_OGRE_MAGE,       SK_STABBING,      -99),
#endif
    APT(SP_OGRE_MAGE,       SK_SHIELDS,        -2),
#if TAG_MAJOR_VERSION == 34
    APT(SP_OGRE_MAGE,       SK_TRAPS,         -99),
#endif
    APT(SP_OGRE_MAGE,       SK_UNARMED_COMBAT,  0),
    APT(SP_OGRE_MAGE,       SK_SPELLCASTING,    2),
    APT(SP_OGRE_MAGE,       SK_CONJURATIONS,    0),
    APT(SP_OGRE_MAGE,       SK_HEXES,           1),
    APT(SP_OGRE_MAGE,       SK_CHARMS,          1),
    APT(SP_OGRE_MAGE,       SK_SUMMONINGS,      0),
    APT(SP_OGRE_MAGE,       SK_NECROMANCY,      0),
    APT(SP_OGRE_MAGE,       SK_TRANSLOCATIONS,  0),
    APT(SP_OGRE_MAGE,       SK_TRANSMUTATIONS,  0),
    APT(SP_OGRE_MAGE,       SK_FIRE_MAGIC,      0),
    APT(SP_OGRE_MAGE,       SK_ICE_MAGIC,       0),
    APT(SP_OGRE_MAGE,       SK_AIR_MAGIC,       0),
    APT(SP_OGRE_MAGE,       SK_EARTH_MAGIC,     0),
    APT(SP_OGRE_MAGE,       SK_POISON_MAGIC,    0),
    APT(SP_OGRE_MAGE,       SK_INVOCATIONS,     0),
    APT(SP_OGRE_MAGE,       SK_EVOCATIONS,      0),

    // SP_GREY_ELF
    APT(SP_GREY_ELF,        SK_FIGHTING,       -2),
    APT(SP_GREY_ELF,        SK_SHORT_BLADES,    1),
    APT(SP_GREY_ELF,        SK_LONG_BLADES,     0),
    APT(SP_GREY_ELF,        SK_AXES,           -2),
    APT(SP_GREY_ELF,        SK_MACES_FLAILS,   -3),
    APT(SP_GREY_ELF,        SK_POLEARMS,       -3),
    APT(SP_GREY_ELF,        SK_STAVES,          0),
    APT(SP_GREY_ELF,        SK_SLINGS,         -1),
    APT(SP_GREY_ELF,        SK_BOWS,            2),
    APT(SP_GREY_ELF,        SK_CROSSBOWS,       0),
    APT(SP_GREY_ELF,        SK_THROWING,        1),
    APT(SP_GREY_ELF,        SK_ARMOUR,         -2),
    APT(SP_GREY_ELF,        SK_DODGING,         2),
    APT(SP_GREY_ELF,        SK_STEALTH,         2),
#if TAG_MAJOR_VERSION == 34
    APT(SP_GREY_ELF,        SK_STABBING,      -99),
#endif
    APT(SP_GREY_ELF,        SK_SHIELDS,        -2),
#if TAG_MAJOR_VERSION == 34
    APT(SP_GREY_ELF,        SK_TRAPS,         -99),
#endif
    APT(SP_GREY_ELF,        SK_UNARMED_COMBAT, -1),
    APT(SP_GREY_ELF,        SK_SPELLCASTING,    3),
    APT(SP_GREY_ELF,        SK_CONJURATIONS,    1),
    APT(SP_GREY_ELF,        SK_HEXES,           4),
    APT(SP_GREY_ELF,        SK_CHARMS,          4),
    APT(SP_GREY_ELF,        SK_SUMMONINGS,      1),
    APT(SP_GREY_ELF,        SK_NECROMANCY,     -1),
    APT(SP_GREY_ELF,        SK_TRANSLOCATIONS,  1),
    APT(SP_GREY_ELF,        SK_TRANSMUTATIONS,  1),
    APT(SP_GREY_ELF,        SK_FIRE_MAGIC,      1),
    APT(SP_GREY_ELF,        SK_ICE_MAGIC,       1),
    APT(SP_GREY_ELF,        SK_AIR_MAGIC,       3),
    APT(SP_GREY_ELF,        SK_EARTH_MAGIC,    -2),
    APT(SP_GREY_ELF,        SK_POISON_MAGIC,   -1),
    APT(SP_GREY_ELF,        SK_INVOCATIONS,     0),
    APT(SP_GREY_ELF,        SK_EVOCATIONS,      1),

    // SP_GNOME
    APT(SP_GNOME,           SK_FIGHTING,        0),
    APT(SP_GNOME,           SK_SHORT_BLADES,    2),
    APT(SP_GNOME,           SK_LONG_BLADES,     0),
    APT(SP_GNOME,           SK_AXES,            0),
    APT(SP_GNOME,           SK_MACES_FLAILS,   -1),
    APT(SP_GNOME,           SK_POLEARMS,       -2),
    APT(SP_GNOME,           SK_STAVES,         -1),
    APT(SP_GNOME,           SK_SLINGS,          1),
    APT(SP_GNOME,           SK_BOWS,            0),
    APT(SP_GNOME,           SK_CROSSBOWS,       1),
    APT(SP_GNOME,           SK_THROWING,        3),
    APT(SP_GNOME,           SK_ARMOUR,         -2),
    APT(SP_GNOME,           SK_DODGING,         2),
    APT(SP_GNOME,           SK_STEALTH,         2),
#if TAG_MAJOR_VERSION == 34
    APT(SP_GNOME,           SK_STABBING,      -99),
#endif
    ...
    APT(SP_GNOME,           SK_SUMMONINGS,     -1),
    APT(SP_GNOME,           SK_NECROMANCY,     -1),
    APT(SP_GNOME,           SK_TRANSLOCATIONS, -1),
    APT(SP_GNOME,           SK_TRANSMUTATIONS, -1),
    APT(SP_GNOME,           SK_FIRE_MAGIC,      0),
    APT(SP_GNOME,           SK_ICE_MAGIC,       0),
    APT(SP_GNOME,           SK_AIR_MAGIC,      -3),
    APT(SP_GNOME,           SK_EARTH_MAGIC,     3),
    APT(SP_GNOME,           SK_POISON_MAGIC,   -1),
    APT(SP_GNOME,           SK_INVOCATIONS,    -1),
    APT(SP_GNOME,           SK_EVOCATIONS,      3),
...
#if TAG_MAJOR_VERSION == 34
    APT(SP_MOUNTAIN_DWARF,  SK_STABBING,      -99),
#endif
    APT(SP_MOUNTAIN_DWARF,  SK_SHIELDS,         2),
#if TAG_MAJOR_VERSION == 34
    APT(SP_MOUNTAIN_DWARF,  SK_TRAPS,         -99),
#endif

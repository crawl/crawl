...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_GROTESK,         SK_SHORT_BLADES,    0),
    APT(SP_GROTESK,         SK_LONG_BLADES,     1),
    APT(SP_GROTESK,         SK_AXES,            0),
    APT(SP_GROTESK,         SK_MACES_FLAILS,    2),
    APT(SP_GROTESK,         SK_POLEARMS,        0),
    APT(SP_GROTESK,         SK_STAVES,          0),
    APT(SP_GROTESK,         SK_SLINGS,          0),
    ...
    APT(SP_GROTESK,         SK_UNARMED_COMBAT,  1),
    ...
    APT(SP_GROTESK,         SK_NECROMANCY,     -4),

...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    // SP_ONI
    APT(SP_ONI,             SK_FIGHTING,        1),
    APT(SP_ONI,             SK_SHORT_BLADES,   -2),
    APT(SP_ONI,             SK_LONG_BLADES,    -1),
    APT(SP_ONI,             SK_AXES,           -1),
    APT(SP_ONI,             SK_MACES_FLAILS,    0),
    APT(SP_ONI,             SK_POLEARMS,       -1),
    APT(SP_ONI,             SK_STAVES,         -1),
    APT(SP_ONI,             SK_SLINGS,         -2),
    APT(SP_ONI,             SK_BOWS,           -1),
    APT(SP_ONI,             SK_CROSSBOWS,      -2),
    APT(SP_ONI,             SK_THROWING,       -2),
    APT(SP_ONI,             SK_ARMOUR,          0),
...
#endif
    APT(SP_ONI,             SK_UNARMED_COMBAT, -1),

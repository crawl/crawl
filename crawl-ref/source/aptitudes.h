...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_LAVA_ORC,        SK_POLEARMS,       -4),
    APT(SP_LAVA_ORC,        SK_STAVES,         -4),
    APT(SP_LAVA_ORC,        SK_SLINGS,         -4),
    APT(SP_LAVA_ORC,        SK_BOWS,           -4),
    APT(SP_LAVA_ORC,        SK_CROSSBOWS,      -4),
    APT(SP_LAVA_ORC,        SK_THROWING,       -4),
    ...
    APT(SP_LAVA_ORC,        SK_TRANSMUTATIONS,  0),
    APT(SP_LAVA_ORC,        SK_FIRE_MAGIC,      3),
    APT(SP_LAVA_ORC,        SK_ICE_MAGIC,      -4),
    APT(SP_LAVA_ORC,        SK_AIR_MAGIC,      -4),
    APT(SP_LAVA_ORC,        SK_EARTH_MAGIC,     3),
    APT(SP_LAVA_ORC,        SK_POISON_MAGIC,   -1),
    APT(SP_LAVA_ORC,        SK_INVOCATIONS,     0),

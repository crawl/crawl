...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    // SP_CLOUD_ELF
    APT(SP_CLOUD_ELF,       SK_FIGHTING,       -1),
    APT(SP_CLOUD_ELF,       SK_SHORT_BLADES,    1),
    APT(SP_CLOUD_ELF,       SK_LONG_BLADES,     1),
    APT(SP_CLOUD_ELF,       SK_AXES,           -2),
    APT(SP_CLOUD_ELF,       SK_MACES_FLAILS,   -2),
    APT(SP_CLOUD_ELF,       SK_POLEARMS,       -1),
    APT(SP_CLOUD_ELF,       SK_STAVES,          0),
    APT(SP_CLOUD_ELF,       SK_SLINGS,         -1),
    APT(SP_CLOUD_ELF,       SK_BOWS,            1),
    APT(SP_CLOUD_ELF,       SK_CROSSBOWS,       1),
    APT(SP_CLOUD_ELF,       SK_THROWING,        0),
    APT(SP_CLOUD_ELF,       SK_ARMOUR,          1),
    APT(SP_CLOUD_ELF,       SK_DODGING,         1),
    APT(SP_CLOUD_ELF,       SK_STEALTH,         1),
#if TAG_MAJOR_VERSION == 34
    APT(SP_CLOUD_ELF,       SK_STABBING,      UNUSABLE_SKILL),
#endif
    APT(SP_CLOUD_ELF,       SK_SHIELDS,        -1),
#if TAG_MAJOR_VERSION == 34
    APT(SP_CLOUD_ELF,       SK_TRAPS,         UNUSABLE_SKILL),
#endif
    APT(SP_CLOUD_ELF,       SK_UNARMED_COMBAT, -1),
    APT(SP_CLOUD_ELF,       SK_SPELLCASTING,    2),
    APT(SP_CLOUD_ELF,       SK_CONJURATIONS,    3),
    APT(SP_CLOUD_ELF,       SK_HEXES,           2),
    APT(SP_CLOUD_ELF,       SK_CHARMS,          2),
    APT(SP_CLOUD_ELF,       SK_SUMMONINGS,      2),
    APT(SP_CLOUD_ELF,       SK_NECROMANCY,      1),
    APT(SP_CLOUD_ELF,       SK_TRANSLOCATIONS, -1),
    APT(SP_CLOUD_ELF,       SK_TRANSMUTATIONS, -1),
    APT(SP_CLOUD_ELF,       SK_FIRE_MAGIC,      1),
    APT(SP_CLOUD_ELF,       SK_ICE_MAGIC,       0),
    APT(SP_CLOUD_ELF,       SK_AIR_MAGIC,       3),
    APT(SP_CLOUD_ELF,       SK_EARTH_MAGIC,    -3),
    APT(SP_CLOUD_ELF,       SK_POISON_MAGIC,    1),
    APT(SP_CLOUD_ELF,       SK_INVOCATIONS,     1),
    APT(SP_CLOUD_ELF,       SK_EVOCATIONS,      1),

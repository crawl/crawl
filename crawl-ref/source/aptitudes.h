...
static const species_skill_aptitude species_skill_aptitudes[] =
{
	...
	// SP_CYNO
    APT(SP_CYNO,    		SK_FIGHTING,        3),
    APT(SP_CYNO,    		SK_SHORT_BLADES,    3),
    APT(SP_CYNO,    		SK_LONG_BLADES,     3),
    APT(SP_CYNO,    		SK_AXES,            3),
    APT(SP_CYNO,    		SK_MACES_FLAILS,    3),
    APT(SP_CYNO,    		SK_POLEARMS,        3),
    APT(SP_CYNO,    		SK_STAVES,          3),
    APT(SP_CYNO,    		SK_SLINGS,          3),
    APT(SP_CYNO,    		SK_BOWS,            3),
    APT(SP_CYNO,    		SK_CROSSBOWS,       3),
    APT(SP_CYNO,    		SK_THROWING,        3),
    APT(SP_CYNO,    		SK_ARMOUR,          3),
    APT(SP_CYNO,    		SK_DODGING,         3),
    APT(SP_CYNO,    		SK_STEALTH,         3),
#if TAG_MAJOR_VERSION == 34
    APT(SP_CYNO,    		SK_STABBING,      UNUSABLE_SKILL),
#endif
    APT(SP_CYNO,    		SK_SHIELDS,         3),
#if TAG_MAJOR_VERSION == 34
    APT(SP_CYNO,    		SK_TRAPS,         UNUSABLE_SKILL),
#endif
    APT(SP_CYNO,    		SK_UNARMED_COMBAT,  3),
    APT(SP_CYNO,    		SK_SPELLCASTING,    3),
    APT(SP_CYNO,    		SK_CONJURATIONS,    3),
    APT(SP_CYNO,    		SK_HEXES,           3),
    APT(SP_CYNO,    		SK_CHARMS,          3),
    APT(SP_CYNO,    		SK_SUMMONINGS,      3),
    APT(SP_CYNO,    		SK_NECROMANCY,      3),
    APT(SP_CYNO,    		SK_TRANSLOCATIONS,  3),
    APT(SP_CYNO,    		SK_TRANSMUTATIONS,  3),
    APT(SP_CYNO,    		SK_FIRE_MAGIC,      3),
    APT(SP_CYNO,    		SK_ICE_MAGIC,       3),
    APT(SP_CYNO,    		SK_AIR_MAGIC,       3),
    APT(SP_CYNO,    		SK_EARTH_MAGIC,     3),
    APT(SP_CYNO,    		SK_POISON_MAGIC,    3),
    APT(SP_CYNO,    		SK_INVOCATIONS,     3),
    APT(SP_CYNO,    		SK_EVOCATIONS,      3),
};

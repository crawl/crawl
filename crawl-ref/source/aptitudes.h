...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_DEEP_ELF,        SK_SHORT_BLADES,   -1),
    APT(SP_DEEP_ELF,        SK_LONG_BLADES,    -1),
    APT(SP_DEEP_ELF,        SK_AXES,           -1),
    APT(SP_DEEP_ELF,        SK_MACES_FLAILS,   -1),
    APT(SP_DEEP_ELF,        SK_POLEARMS,       -1),
    APT(SP_DEEP_ELF,        SK_STAVES,         -1),
    APT(SP_DEEP_ELF,        SK_SLINGS,         -1),
    ...
    APT(SP_HALFLING,        SK_SHORT_BLADES,   -1),
    APT(SP_HALFLING,        SK_LONG_BLADES,    -1),
    APT(SP_HALFLING,        SK_AXES,           -1),
    APT(SP_HALFLING,        SK_MACES_FLAILS,   -1),
    APT(SP_HALFLING,        SK_POLEARMS,       -1),
    APT(SP_HALFLING,        SK_STAVES,         -1),
    APT(SP_HALFLING,        SK_SLINGS,          2),
    APT(SP_HALFLING,        SK_BOWS,            2),
    APT(SP_HALFLING,        SK_CROSSBOWS,       2),
    ...
    APT(SP_HILL_ORC,        SK_SHORT_BLADES,    1),
    APT(SP_HILL_ORC,        SK_LONG_BLADES,     1),
    APT(SP_HILL_ORC,        SK_AXES,            1),
    ...
    APT(SP_KOBOLD,          SK_SHORT_BLADES,    0),
    APT(SP_KOBOLD,          SK_LONG_BLADES,     0),
    APT(SP_KOBOLD,          SK_AXES,            0),
    APT(SP_KOBOLD,          SK_MACES_FLAILS,    0),
    APT(SP_KOBOLD,          SK_POLEARMS,        0),
    APT(SP_KOBOLD,          SK_STAVES,          0),
    APT(SP_KOBOLD,          SK_SLINGS,          1),
    ...
    APT(SP_TROLL,           SK_MACES_FLAILS,   -2),
    ...
    APT(SP_SPRIGGAN,        SK_MACES_FLAILS,   -2),
    APT(SP_SPRIGGAN,        SK_POLEARMS,       -2),
    APT(SP_SPRIGGAN,        SK_STAVES,         -2),
    APT(SP_SPRIGGAN,        SK_SLINGS,          1),
    APT(SP_SPRIGGAN,        SK_BOWS,            1),
    APT(SP_SPRIGGAN,        SK_CROSSBOWS,       1),
    ...
    APT(SP_MERFOLK,         SK_SHORT_BLADES,    0),
    APT(SP_MERFOLK,         SK_LONG_BLADES,     0),
    APT(SP_MERFOLK,         SK_AXES,            0),
    APT(SP_MERFOLK,         SK_MACES_FLAILS,    0),
    APT(SP_MERFOLK,         SK_POLEARMS,        0),
    APT(SP_MERFOLK,         SK_STAVES,          0),
    ...
    APT(SP_VAMPIRE,         SK_MACES_FLAILS,   -1),
    APT(SP_VAMPIRE,         SK_POLEARMS,       -1),
    APT(SP_VAMPIRE,         SK_STAVES,         -1),
    ...
    APT(SP_DEEP_DWARF,      SK_SHORT_BLADES,    0),
    APT(SP_DEEP_DWARF,      SK_LONG_BLADES,     0),
    APT(SP_DEEP_DWARF,      SK_AXES,            0),
    APT(SP_DEEP_DWARF,      SK_MACES_FLAILS,    0),
    APT(SP_DEEP_DWARF,      SK_POLEARMS,        0),
    APT(SP_DEEP_DWARF,      SK_STAVES,          0),
    APT(SP_DEEP_DWARF,      SK_SLINGS,          0),
    APT(SP_DEEP_DWARF,      SK_BOWS,            0),
    APT(SP_DEEP_DWARF,      SK_CROSSBOWS,       0),

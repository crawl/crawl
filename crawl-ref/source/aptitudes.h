...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_FELID,           SK_DODGING,         2),
    APT(SP_FELID,           SK_STEALTH,         2),
    ...
    // SP_OCTOPUS
    APT(SP_OCTOPUS,         SK_FIGHTING,        0),
    APT(SP_OCTOPUS,         SK_SHORT_BLADES,    0),
    APT(SP_OCTOPUS,         SK_LONG_BLADES,     0),
    APT(SP_OCTOPUS,         SK_AXES,            0),
    APT(SP_OCTOPUS,         SK_MACES_FLAILS,    0),
    APT(SP_OCTOPUS,         SK_POLEARMS,        0),
    APT(SP_OCTOPUS,         SK_STAVES,          0),
    APT(SP_OCTOPUS,         SK_SLINGS,          0),
    APT(SP_OCTOPUS,         SK_BOWS,            0),
    APT(SP_OCTOPUS,         SK_CROSSBOWS,       0),
    APT(SP_OCTOPUS,         SK_THROWING,        0),
    APT(SP_OCTOPUS,         SK_ARMOUR,         -4),
    APT(SP_OCTOPUS,         SK_DODGING,         0),
    APT(SP_OCTOPUS,         SK_STEALTH,         3),
    APT(SP_OCTOPUS,         SK_STABBING,        0),
    APT(SP_OCTOPUS,         SK_SHIELDS,         0),
    APT(SP_OCTOPUS,         SK_TRAPS_DOORS,     1),
    APT(SP_OCTOPUS,         SK_UNARMED_COMBAT,  0),
    APT(SP_OCTOPUS,         SK_SPELLCASTING,    0),
    APT(SP_OCTOPUS,         SK_CONJURATIONS,    0),
    ...
    APT(SP_OCTOPUS,         SK_FIRE_MAGIC,      0),
    APT(SP_OCTOPUS,         SK_ICE_MAGIC,       0),
    APT(SP_OCTOPUS,         SK_AIR_MAGIC,       0),
    APT(SP_OCTOPUS,         SK_EARTH_MAGIC,     0),
    APT(SP_OCTOPUS,         SK_POISON_MAGIC,    2),
    APT(SP_OCTOPUS,         SK_INVOCATIONS,     0),
    APT(SP_OCTOPUS,         SK_EVOCATIONS,      1),
};

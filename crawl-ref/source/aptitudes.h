...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    // SP_GROTESK
    APT(SP_GROTESK,         SK_FIGHTING,        1),
    APT(SP_GROTESK,         SK_SHORT_BLADES,   -1),
    APT(SP_GROTESK,         SK_LONG_BLADES,    -1),
    APT(SP_GROTESK,         SK_AXES,           -1),
    APT(SP_GROTESK,         SK_MACES_FLAILS,    1),
    APT(SP_GROTESK,         SK_POLEARMS,       -1),
    APT(SP_GROTESK,         SK_STAVES,         -1),
    APT(SP_GROTESK,         SK_SLINGS,         -1),
    APT(SP_GROTESK,         SK_BOWS,            0),
    APT(SP_GROTESK,         SK_CROSSBOWS,       0),
    APT(SP_GROTESK,         SK_THROWING,        0),
    APT(SP_GROTESK,         SK_ARMOUR,         -2),
    APT(SP_GROTESK,         SK_DODGING,        -1),
    APT(SP_GROTESK,         SK_STEALTH,         2),
#if TAG_MAJOR_VERSION == 34
    APT(SP_GROTESK,         SK_STABBING,        0),
#endif
    APT(SP_GROTESK,         SK_SHIELDS,        -2),
    APT(SP_GROTESK,         SK_TRAPS,          -1),
    APT(SP_GROTESK,         SK_UNARMED_COMBAT,  2),
    APT(SP_GROTESK,         SK_SPELLCASTING,   -1),
    APT(SP_GROTESK,         SK_CONJURATIONS,    2),
    APT(SP_GROTESK,         SK_HEXES,          -1),
    APT(SP_GROTESK,         SK_CHARMS,         -2),
    APT(SP_GROTESK,         SK_SUMMONINGS,     -1),
    APT(SP_GROTESK,         SK_NECROMANCY,     -3),
    APT(SP_GROTESK,         SK_TRANSLOCATIONS, -1),
    APT(SP_GROTESK,         SK_TRANSMUTATIONS, -2),
    APT(SP_GROTESK,         SK_FIRE_MAGIC,     -1),
    APT(SP_GROTESK,         SK_ICE_MAGIC,       1),
    APT(SP_GROTESK,         SK_AIR_MAGIC,      -3),
    APT(SP_GROTESK,         SK_EARTH_MAGIC,     3),
    APT(SP_GROTESK,         SK_POISON_MAGIC,    0),
    APT(SP_GROTESK,         SK_INVOCATIONS,     1),
    APT(SP_GROTESK,         SK_EVOCATIONS,      0),

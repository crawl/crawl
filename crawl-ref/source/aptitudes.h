...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_LACERTILIAN,    SK_SHORT_BLADES,    -2),
    APT(SP_LACERTILIAN,    SK_LONG_BLADES,     -2),
    APT(SP_LACERTILIAN,    SK_AXES,            -2),
    APT(SP_LACERTILIAN,    SK_MACES_FLAILS,    -2),
    APT(SP_LACERTILIAN,    SK_POLEARMS,        -2),
    APT(SP_LACERTILIAN,    SK_STAVES,          -2),
    APT(SP_LACERTILIAN,    SK_SLINGS,          -2),
    APT(SP_LACERTILIAN,    SK_BOWS,            -2),
    APT(SP_LACERTILIAN,    SK_CROSSBOWS,       -2),
    APT(SP_LACERTILIAN,    SK_THROWING,        -2),
...
#endif
    APT(SP_LACERTILIAN,    SK_UNARMED_COMBAT,  -2),
    APT(SP_LACERTILIAN,    SK_SPELLCASTING,    -2),
    APT(SP_LACERTILIAN,    SK_CONJURATIONS,     1),
    APT(SP_LACERTILIAN,    SK_HEXES,            1),
    APT(SP_LACERTILIAN,    SK_CHARMS,           1),
    APT(SP_LACERTILIAN,    SK_SUMMONINGS,       1),
    APT(SP_LACERTILIAN,    SK_NECROMANCY,       1),
    APT(SP_LACERTILIAN,    SK_TRANSLOCATIONS,   1),
    APT(SP_LACERTILIAN,    SK_TRANSMUTATIONS,   1),

...
const char *dngn_feature_names[] =
{
    ...
    "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
    "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
    "", "", "", "", "lava", "deep_water", "", "", "shallow_water",
    "water_stuck", "floor", "floor_special", "floor_reserved",
    "exit_hell", "enter_hell", "open_door", "", "", "trap_mechanical",
    ...
    "altar_kikubaaqudgha", "altar_yredelemnul", "altar_xom",
    "altar_vehumet", "altar_okawaru", "altar_makhleb",
    "altar_sif_muna", "altar_trog", "altar_nemelex_xobeh",
    "altar_elyvilon", "altar_lugonu", "altar_beogh", "", "", "", "",
    "", "", "blue_fountain", "dry_fountain_i", "sparkling_fountain",
    "dry_fountain_ii", "dry_fountain_iii", "dry_fountain_iv",
    "dry_fountain_v", "dry_fountain_vi", "dry_fountain_vii",

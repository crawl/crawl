...
static const char *weapon_brands_terse[] =
{
    ...
    "evade", "confuse",
#endif
    "penet", "reap", "pacify", "slug", "slime", "spect", "buggy-num", "acid", 
#if TAG_MAJOR_VERSION > 34
    "confuse",
#endif
    "debug",
...
static const char *weapon_brands_verbose[] =
{
    ...
    "evasion", "confusion",
#endif
    "penetration", "reaping", "pacifing", "sluggish", "slimifying", "spectralizing", "buggy-num", "acid", 
#if TAG_MAJOR_VERSION > 34
    "confusion",
#endif
    "debug",
...
static const char *weapon_brands_adj[] =
{
    ...
    "evasive", "confusing",
#endif
    "penetrating", "reaping", "pacifing", "sluggish", "slimifying", "spectral", "buggy-num", "acidic",
#if TAG_MAJOR_VERSION > 34
    "confusing",
#endif
    "debug",
...
bool is_good_item(const item_def &item)
{
    ...
    {
    case OBJ_SCROLLS:
        return item.sub_type == SCR_ACQUIREMENT || item.sub_type == SCR_COLLECTION || item.sub_type == SCR_WISH;
    case OBJ_POTIONS:
        if (you.species == SP_MUMMY || you.species == SP_LICH ||  you.species == SP_WIGHT)
            return false;
        switch (item.sub_type)

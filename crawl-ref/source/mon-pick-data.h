...
{ // Dungeon (OOD cap: 27)
  { -2,  3,  515, SEMI, MONS_GIANT_COCKROACH },
  { -2,  3,  192, PEAK, MONS_BALL_PYTHON },
  { -1,  3,  640, SEMI, MONS_FRILLED_LIZARD},
  { -1,  3,  136, SEMI, MONS_OOZE },
  ...
  {  1,  5,  515, SEMI, MONS_LEOPARD_GECKO },
  {  1,  5,  335, SEMI, MONS_JACKAL },
  {  1,  5,  192, PEAK, MONS_GNOLL },
  {  2,  5,  515, FALL, MONS_WORM },
  ...
  {  4,  8,   52, SEMI, MONS_GNOLL_SHAMAN },
  {  4,  8,  136, SEMI, MONS_ORC_PRIEST },
  {  4,  8,  925, FLAT, MONS_WORKER_ANT },
  {  4,  8,  825, SEMI, MONS_HOUND },
  {  4,  8,  515, SEMI, MONS_ORC_WIZARD },
  {  4,  9,  825, SEMI, MONS_OGRE },
  {  4,  9,  515, SEMI, MONS_IGUANA },
  {  4,  9,  515, SEMI, MONS_SCORPION },
  {  4,  9,  335, SEMI, MONS_PHANTOM },
  {  4,  9,  335, SEMI, MONS_HOWLER_MONKEY },
  {  4,  9, 1000, FLAT, MONS_SKELETON },
  {  5,  6,  650, FLAT, MONS_CRIMSON_IMP },
...
{ // Dungeon Zot
  { 1, 1, 825, SEMI, MONS_TROLL },
  { 1, 1, 192, PEAK, MONS_VAMPIRE },
  { 1, 1, 194, PEAK, MONS_SOLDIER_ANT },
  { 1, 1, 370, SEMI, MONS_GARGOYLE },
  { 1, 1, 335, SEMI, MONS_WRAITH },
  { 1, 1, 515, SEMI, MONS_UNSEEN_HORROR },
  { 1, 1, 192, PEAK, MONS_KOMODO_DRAGON },
  { 1, 1, 235, SEMI, MONS_KOBOLD_DEMONOLOGIST },
  { 1, 1, 750, FLAT, MONS_UGLY_THING },
  { 1, 1, 520, SEMI, MONS_MANTICORE },
  { 1, 1, 825, SEMI, MONS_CYCLOPS },
  { 1, 1, 380, SEMI, MONS_SHADOW },
  { 1, 1, 335, SEMI, MONS_ACID_DRAGON },
  { 1, 1, 260, PEAK, MONS_BASILISK },
  { 1, 1, 192, PEAK, MONS_SKELETAL_WARRIOR },
  { 1, 1, 192, PEAK, MONS_DEATH_KNIGHT },
  { 1, 1, 515, SEMI, MONS_HYDRA },
  { 1, 1, 475, SEMI, MONS_DEEP_ELF_MAGE },
  { 1, 1, 500, SEMI, MONS_VAMPIRE_MOSQUITO },
  { 1, 1, 440, FALL, MONS_SLIME_CREATURE },
  { 1, 1, 150, SEMI, MONS_MELIAI },
  { 1, 1,  89, PEAK, MONS_RAKSHASA },
  { 1, 1, 925, FLAT, MONS_CENTAUR_WARRIOR },
  { 1, 1, 925, FALL, MONS_CENTAUR_WARRIOR },
  { 1, 1, 365, SEMI, MONS_TENGU_WARRIOR },
  { 1, 1, 205, SEMI, MONS_TENGU_CONJURER },
  { 1, 1, 285, SEMI, MONS_EFREET },
  { 1, 1, 675, SEMI, MONS_SHAPESHIFTER },
  { 1, 1,  89, FALL, MONS_CATOBLEPAS },
  { 0,0,0,FLAT,MONS_0 }
};
// { // Zot
//   {  1,  1,  970, FLAT, MONS_MOTH_OF_WRATH },
//   {  1,  1,  113, FLAT, MONS_BLACK_DRACONIAN },
//   {  1,  1,  113, FLAT, MONS_YELLOW_DRACONIAN },
//   {  1,  1,  113, FLAT, MONS_GREEN_DRACONIAN },
//   {  1,  1,  113, FLAT, MONS_PURPLE_DRACONIAN },
//   {  1,  1,  113, FLAT, MONS_RED_DRACONIAN },
//   {  1,  1,  113, FLAT, MONS_WHITE_DRACONIAN },
//   {  1,  1,   70, FLAT, MONS_DRACONIAN_STORMCALLER },
//   {  1,  1,   70, FLAT, MONS_DRACONIAN_MONK },
//   {  1,  1,   70, FLAT, MONS_DRACONIAN_SHIFTER },
//   {  1,  1,   70, FLAT, MONS_DRACONIAN_ANNIHILATOR },
//   {  1,  1,   70, FLAT, MONS_DRACONIAN_KNIGHT },
//   {  1,  1,   70, FLAT, MONS_DRACONIAN_SCORCHER },
//   {  2,  1,   52, SEMI, MONS_KILLER_KLOWN },
//   {  1,  1,  335, FLAT, MONS_DEATH_COB },
//   {  1,  1,  150, RISE, MONS_CURSE_TOE },
//   {  1,  1,  515, FLAT, MONS_TENTACLED_MONSTROSITY },
//   {  1,  1,   89, FALL, MONS_ELECTRIC_GOLEM },
//   {  1,  1,   42, FLAT, MONS_ORB_OF_FIRE },
//   { 0,0,0,FLAT,MONS_0 }
// };
#if TAG_MAJOR_VERSION == 34

...
{ // Snake Pit
  ...
  {  1,  9,  217, PEAK, MONS_SHOCK_SERPENT },
  {  1,  9,  217, PEAK, MONS_MANA_VIPER },
  { -3,  5,  572, SEMI, MONS_NAGA },
  {  1,  9,  244, SEMI, MONS_NAGA_WARRIOR },
  {  1,  9,  244, SEMI, MONS_NAGA_MAGE },
  {  1,  9,  244, SEMI, MONS_NAGA_RITUALIST },
  {  1,  9,  122, SEMI, MONS_NAGA_SHARPSHOOTER },
...
{ // Depths (OOD cap: 14)
  ...
  { -2, 10,  295, PEAK, MONS_FIRE_GIANT },
  { -2, 10,  325, PEAK, MONS_FROST_GIANT },
  { -2, 10,  735, PEAK, MONS_ETTIN },
  ...
  {  1,  6,  400, UP,   MONS_DEEP_TROLL_SHAMAN },
  {  1,  6,  400, UP,   MONS_DEEP_TROLL_EARTH_MAGE },
  {  1,  7,  295, DOWN, MONS_FIRE_DRAGON },
  {  1,  7,  295, DOWN, MONS_ICE_DRAGON },
  ...
  {  1, 14,   45, SEMI, MONS_SPHINX },
  {  2,  8,  150, SEMI, MONS_SPRIGGAN_AIR_MAGE },
  {  2,  8,  215, SEMI, MONS_SPRIGGAN_BERSERKER },
  {  3,  7,  120, PEAK, MONS_SPRIGGAN_DEFENDER },
  {  4, 14,   80, UP,   MONS_SPRIGGAN_DEFENDER },
  {  4, 14,  185, SEMI, MONS_TENTACLED_MONSTROSITY },
  {  4, 14,  100, UP,   MONS_STORM_DRAGON },
  {  4, 14,  100, UP,   MONS_SHADOW_DRAGON },
  {  4, 14,   25, UP,   MONS_BONE_DRAGON },
  {  4, 14,   45, UP,   MONS_QUICKSILVER_DRAGON },
  {  4, 14,   50, UP,   MONS_IRON_DRAGON },
  {  4, 14,  135, SEMI, MONS_GOLDEN_DRAGON },

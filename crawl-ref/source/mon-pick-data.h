...
{ // Abyss
  {  2,  3,   50, FLAT, MONS_SHAPESHIFTER },
  {  3,  5,   10, FLAT, MONS_GLOWING_SHAPESHIFTER },
  {  2,  5,   35, FLAT, MONS_UNSEEN_HORROR },
  {  2,  3, 1000, FALL, MONS_ABOMINATION_SMALL },
  {  3,  5, 1000, FALL, MONS_ABOMINATION_LARGE },
  {  3,  5,   16, FLAT, MONS_TENTACLED_MONSTROSITY },
  {  3,  5,  335, FLAT, MONS_WRETCHED_STAR },
  {  3,  5,  335, FLAT, MONS_TENTACLED_STARSPAWN },
  {  2,  5,  335, FLAT, MONS_ANCIENT_ZYME },
  {  3,  5,  335, FLAT, MONS_STARCURSED_MASS },
  {  3,  5,  335, FLAT, MONS_THRASHING_HORROR },
  {  3,  5,   89, FLAT, MONS_LURKING_HORROR },
  {  2,  5,  180, FLAT, MONS_SPATIAL_MAELSTROM },
  {  2,  5,   89, FLAT, MONS_APOCALYPSE_CRAB },
  {  3,  5,  300, FLAT, MONS_RAIJU },
  {  1,  5,  165, FALL, MONS_WORLDBINDER },
  {  3,  5,   52, FLAT, MONS_VERY_UGLY_THING },
  // Demons
  {  1,  3,   25, FALL, MONS_CRIMSON_IMP },
  {  1,  3,  192, FALL, MONS_WHITE_IMP },
  {  1,  3,  192, FALL, MONS_QUASIT },
  {  1,  3,  192, FALL, MONS_UFETUBUS },
  {  1,  3,  192, FALL, MONS_IRON_IMP },
  {  1,  3,   25, FALL, MONS_SHADOW_IMP },
  {  2,  4,    8, FALL, MONS_RED_DEVIL },
  {  2,  4,   25, FALL, MONS_ICE_DEVIL },
  {  2,  4,   36, FALL, MONS_RUST_DEVIL },
  {  2,  4,   73, FALL, MONS_HELLWING },
  {  2,  5,   91, FALL, MONS_SIXFIRHY },
  {  2,  4,  125, FALL, MONS_ORANGE_DEMON },
  {  2,  4,  315, FALL, MONS_YNOXINUL },
  {  2,  4,  225, FALL, MONS_NEQOXEC },
  {  3,  4,  300, FALL, MONS_SMOKE_DEMON },
  {  1,  3,  400, FALL, MONS_CHAOS_SPAWN },
  {  3,  4,   22, FALL, MONS_SUN_DEMON },
  {  3,  4,   14, FALL, MONS_SOUL_EATER },
  {  3,  5,   25, RISE, MONS_HELLION },
  {  3,  4,   25, FLAT, MONS_LOROCYPROCA },
  {  3,  5,   21, RISE, MONS_TORMENTOR },
  {  3,  4,   12, FLAT, MONS_REAPER },
  {  3,  5,   22, RISE, MONS_GREEN_DEATH },
  {  3,  5,   22, RISE, MONS_BLIZZARD_DEMON },
  {  3,  5,   22, RISE, MONS_BALRUG },
  {  3,  5,   25, RISE, MONS_CACODEMON },
  {  3,  5,   16, RISE, MONS_SHADOW_DEMON },
  {  3,  5,   25, RISE, MONS_EXECUTIONER },
  {  3,  5,   10, RISE, MONS_HELL_SENTINEL },
  {  3,  4,   63, FLAT, MONS_EFREET },
  {  3,  5,   66, FLAT, MONS_RAKSHASA },
  {  2,  3,   25, FLAT, MONS_DEMONIC_CRAWLER },
  {  2,  4,   30, FALL, MONS_HELL_HOUND },
  {  2,  4,   40, FALL, MONS_HELL_HOG },
  {  3,  5,   16, FLAT, MONS_HELLEPHANT },
  // Misc Undead
  {  1,  3,  110, FLAT, MONS_SKELETON },
  {  2,  4,  110, FLAT, MONS_ZOMBIE },
  {  3,  5,  110, FLAT, MONS_SIMULACRUM },
  {  1,  2,   25, FALL, MONS_WIGHT },
  {  1,  3,   30, FALL, MONS_HUNGRY_GHOST },
  {  1,  3,   52, FALL, MONS_FLYING_SKULL },
  {  2,  3,   52, FALL, MONS_PHANTOM },
  {  2,  3,   52, FALL, MONS_WRAITH },
  {  2,  4,   30, FALL, MONS_SHADOW },
  {  3,  4,   21, FALL, MONS_VAMPIRE },
  {  3,  5,   40, FLAT, MONS_FREEZING_WRAITH },
  {  3,  4,   23, FLAT, MONS_SHADOW_WRAITH },
  {  1,  5,    8, FLAT, MONS_SILENT_SPECTRE },
  {  3,  5,    8, FLAT, MONS_PHANTASMAL_WARRIOR },
  {  3,  5,   22, RISE, MONS_PROFANE_SERVITOR },
  {  3,  5,   80, RISE, MONS_BONE_DRAGON },
  {  3,  5,    9, FLAT, MONS_REVENANT },
  {  3,  5,   46, RISE, MONS_LICH },
  {  3,  5,   20, RISE, MONS_ANCIENT_LICH },
  // Thematic branch representatives, outsiders
  {  2,  4,    8, FLAT, MONS_ORC_SORCERER },
  {  2,	 4,    4, FLAT, MONS_DEEP_ELF_MAGE },
  {  3,  5,    8, FLAT, MONS_DEEP_ELF_SORCERER },
  {  3,  5,    5, FLAT, MONS_DEEP_ELF_DEMONOLOGIST },
  {  3,  5,    8, FLAT, MONS_DEEP_ELF_ELEMENTALIST },
  {  1,  5,   29, FLAT, MONS_BLINK_FROG },
  {  2,  4,    4, FALL, MONS_BASILISK },
  {  2,  4,    8, FLAT, MONS_MANA_VIPER },
  {  3,  5,   25, FLAT, MONS_GUARDIAN_SERPENT },
  {  1,  5,   35, FALL, MONS_INSUBSTANTIAL_WISP },
  {  1,  5,    8, FLAT, MONS_ORB_SPIDER },
  {  3,  5,    4, FLAT, MONS_GHOST_MOTH },
  {  3,  5,   17, FLAT, MONS_EIDOLON },
  {  1,  5,   18, FLAT, MONS_FLAYED_GHOST },
  {  3,  4,   12, FLAT, MONS_VAMPIRE_MAGE },
  {  2,  4,    3, FLAT, MONS_DANCING_WEAPON },
  {  1,  3,   21, FALL, MONS_JELLY },
  {  1,  5,   46, FLAT, MONS_EYE_OF_DRAINING },
  {  2,  5,    8, FLAT, MONS_SHINING_EYE },
  {  1,  5,   33, FLAT, MONS_GOLDEN_EYE },
  {  3,  5,    8, FLAT, MONS_EYE_OF_DEVASTATION },
  {  3,  5,   33, FLAT, MONS_GREAT_ORB_OF_EYES },
  {  2,  5,   52, FLAT, MONS_GLOWING_ORANGE_BRAIN },
  {  2,  4,    5, FLAT, MONS_BLACK_DRACONIAN },
  {  3,  4,    5, FLAT, MONS_YELLOW_DRACONIAN },
  {  3,  4,    5, FLAT, MONS_GREEN_DRACONIAN },
  {  3,  4,    5, FLAT, MONS_PURPLE_DRACONIAN },
  {  3,  4,    5, FLAT, MONS_RED_DRACONIAN },
  {  3,  4,    5, FLAT, MONS_WHITE_DRACONIAN },
  {  3,  5,    3, FLAT, MONS_DRACONIAN_STORMCALLER },
  {  3,  5,    3, FLAT, MONS_DRACONIAN_MONK },
  {  3,  5,    5, FLAT, MONS_DRACONIAN_SHIFTER },
  {  3,  5,    3, FLAT, MONS_DRACONIAN_ANNIHILATOR },
  {  3,  5,    3, FLAT, MONS_DRACONIAN_KNIGHT },
  {  3,  5,    3, FLAT, MONS_DRACONIAN_SCORCHER },
  {  3,  5,    1, FLAT, MONS_CORRUPTER },
  // Misc
  {  2,  3,    8, FLAT, MONS_DEATH_DRAKE },
  {  3,  5,    2, FLAT, MONS_SHADOW_DRAGON },
  {  3,  5,    2, FLAT, MONS_QUICKSILVER_DRAGON },
  {  3,  5,    2, FLAT, MONS_CRYSTAL_GUARDIAN },
  {  1,  5,    1, FLAT, MONS_TOENAIL_GOLEM },
  {  2,  4,   18, FLAT, MONS_EARTH_ELEMENTAL },
  {  2,  4,    6, FLAT, MONS_FIRE_ELEMENTAL },
  {  2,  4,    6, FLAT, MONS_AIR_ELEMENTAL },
  {  2,  4,    6, FLAT, MONS_WATER_ELEMENTAL },
  {  1,  2,   46, FALL, MONS_FIRE_BAT },
  {  1,  2,   21, FALL, MONS_ICE_BEAST },
  {  1,  2,   21, FALL, MONS_SKY_BEAST },
  {  1,  2,   14, FALL, MONS_KOBOLD_DEMONOLOGIST },
  {  3,  4,    8, FLAT, MONS_DEATH_KNIGHT },
  {  3,  5,    8, FLAT, MONS_HELL_KNIGHT },
  {  2,  4,    8, FLAT, MONS_NECROMANCER },
  {  2,  4,    8, FLAT, MONS_WIZARD },
  {  3,  4,   11, FLAT, MONS_ANGEL },
  {  3,  5,   14, FLAT, MONS_DAEVA },
  {  3,  5,    8, FLAT, MONS_OPHAN },
  { 0,0,0,FLAT,MONS_0 }
};

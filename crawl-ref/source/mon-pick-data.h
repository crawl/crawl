...
{ // Lair
  { -6,  4,  825, SEMI, MONS_IGUANA },
  { -4,  6,  750, SEMI, MONS_RIVER_RAT },
  { -3,  3,   52, SEMI, MONS_BLACK_BEAR },
  { -2,  4,   25, PEAK, MONS_SCORPION },
  { -2,  6,  260, SEMI, MONS_BASILISK },
  { -2,  6,  260, SEMI, MONS_WOLF },
  ...
  { -1,  7,  420, SEMI, MONS_BLINK_FROG },
  { -1,  7,  275, SEMI, MONS_SHEEP },
  { -1,  9,  515, SEMI, MONS_HYDRA },
  { -1,  9,  455, SEMI, MONS_BLACK_MAMBA },
  { -1,  9,  275, PEAK, MONS_RIME_DRAKE },
  {  0,  4,    8, PEAK, MONS_WASP },
  {  0,  6,   25, PEAK, MONS_HELL_RAT },
  {  0,  6,   25, PEAK, MONS_STEAM_DRAGON },
  {  0,  6,   52, SEMI, MONS_POLAR_BEAR },
  {  0,  8,   89, PEAK, MONS_WYVERN },
  {  0, 10,  275, PEAK, MONS_ELEPHANT },
  {  0, 10,  192, PEAK, MONS_GRIFFON },
  {  1,  6,  192, RISE, MONS_DEATH_YAK },
  {  1,  7,   80, SEMI, MONS_TORPOR_SNAIL },
  {  1,  7,   52, SEMI, MONS_CATOBLEPAS },
  {  1,  7,   25, PEAK, MONS_OKLOB_PLANT },
  {  2,  6,   89, RISE, MONS_BOULDER_BEETLE },
  {  2,  8,   52, SEMI, MONS_POLAR_BEAR },
  {  2,  8,   25, PEAK, MONS_LINDWURM },
  {  3, 10,   66, RISE, MONS_FIRE_CRAB },
  { -1,  4, 4500, FLAT, MONS_NO_MONSTER }, // Roughly old D:1 chaff weight
  { 0,0,0,FLAT,MONS_0 }
};

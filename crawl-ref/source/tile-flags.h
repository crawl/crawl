...
enum tile_flags ENUM_INT64
{
    ...
    TILE_FLAG_THREAT_MASK  = 0x7000000000000000ULL,
    TILE_FLAG_TRIVIAL      = 0x1000000000000000ULL,
    TILE_FLAG_EASY         = 0x2000000000000000ULL,
    TILE_FLAG_TOUGH        = 0x4000000000000000ULL,
    TILE_FLAG_NASTY        = 0x7000000000000000ULL,

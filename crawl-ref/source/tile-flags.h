...
enum tile_flags ENUM_INT64
{
    ...
    TILE_FLAG_POISON_MASK  = 0x100000000800000ULL,
    TILE_FLAG_POISON       = 0x000000000800000ULL,
    TILE_FLAG_MORE_POISON  = 0x100000000000000ULL,
    TILE_FLAG_MAX_POISON   = 0x100000000800000ULL,

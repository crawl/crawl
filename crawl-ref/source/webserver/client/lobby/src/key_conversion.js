...
const CK_PGUP = val++;
const CK_PGDN = val++;
const _CK_TAB_PLACEHOLDER = val++; // placeholder value, not used
...
const _CK_CTRL_SHIFT_TAB = val++;

// placeholders, not used except for math
const _CK_ENTER_PLACEHOLDER = val++;
const _CK_BKSP_PLACEHOLDER = val++;
const _CK_ESCAPE_PLACEHOLDER = val++;
const _CK_DELETE_PLACEHOLDER = val++;
const _CK_SPACE_PLACEHOLDER = val++;
...
val = -10009;
const _CK_MOUSE_MOVE = val++;
const _CK_MOUSE_CMD = val++;
const _CK_MOUSE_B1 = val++;
const _CK_MOUSE_B2 = val++;
const _CK_MOUSE_B3 = val++;
const _CK_MOUSE_B4 = val++;
const _CK_MOUSE_B5 = val++;
const _CK_MOUSE_CLICK = val++;

let key_conversion = {};
let shift_key_conversion = {};
let ctrl_key_conversion = {};
let ctrlshift_key_conversion = {};
let legacy_key_conversion = {};
let code_conversion = {};

let do_code_conversion = false;
...
export default {
  ...
  captured_control_keys,
  reset_keycodes,
  enable_code_conversion,
  code_conversion_enabled,
};

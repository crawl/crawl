...
static const spell_type xom_spells[] =
{
    ...
    SPELL_SWARM, SPELL_SUMMON_WRAITHS, SPELL_SHADOW_CREATURES,
    SPELL_SUMMON_ELEMENTAL, SPELL_SUMMON_HORRIBLE_THINGS,
    SPELL_SUMMON_LARGE_MAMMAL, SPELL_SUMMON_UGLY_THING,

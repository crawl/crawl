...
enum armour_type
{
    ...
    ARM_FIRST_DRAGON_ARMOUR = ARM_FIRE_DRAGON_ARMOUR,
#if TAG_MAJOR_VERSION == 34
    ARM_ICE_DRAGON_HIDE,
#endif
    ...
    ARM_LAST_DRAGON_ARMOUR = ARM_QUICKSILVER_DRAGON_ARMOUR,
#endif
...
const vector<misc_item_type> misc_types =
{
    ...
    MISC_CRYSTAL_BALL_OF_ENERGY, MISC_LIGHTNING_ROD, MISC_DISC_OF_STORMS, MISC_PHIAL_OF_FLOODS,
    MISC_QUAD_DAMAGE, MISC_SACK_OF_SPIDERS, MISC_PHANTOM_MIRROR, MISC_HEALING_MIST,
#if TAG_MAJOR_VERSION == 34
    MISC_XOMS_CHESSBOARD,
#endif
    MISC_ZIGGURAT,

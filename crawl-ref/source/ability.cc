...
static vector<ability_def> &_get_ability_list()
{
    ...
    //
    // The four numerical fields are: MP, HP, and piety. And zot points (for zot defence mode only)
    ...
    static vector<ability_def> Ability_List =
    {
        ...
        { ABIL_NON_ABILITY, "No ability", 0, 0, 0, {}, abflag::none , 0 },
        { ABIL_SPIT_POISON, "Spit Poison",
            0, 0, 0, {fail_basis::xl, 20, 1}, abflag::breath , 0 },

        { ABIL_BREATHE_FIRE, "Breathe Fire",
            0, 0, 0, {fail_basis::xl, 30, 1}, abflag::breath , 0 },
        ...
        { ABIL_TRAN_BAT, "Bat Form",
            2, 0, 0, {fail_basis::xl, 45, 2}, abflag::none , 0 },
        { ABIL_EXSANGUINATE, "Exsanguinate",
            0, 0, 0, {}, abflag::delay},
        { ABIL_REVIVIFY, "Revivify",
            0, 0, 0, {}, abflag::delay},
        { ABIL_DAMNATION, "Hurl Damnation",
            0, 150, 0, {fail_basis::xl, 50, 1}, abflag::none , 0 },
        { ABIL_WORD_OF_CHAOS, "Word of Chaos",
            6, 0, 0, {fail_basis::xl, 50, 1}, abflag::max_hp_drain , 0 },

        { ABIL_DIG, "Dig", 0, 0, 0, {}, abflag::instant | abflag::none , 0 },
        { ABIL_SHAFT_SELF, "Shaft Self", 0, 0, 0, {}, abflag::delay , 0 },

        { ABIL_HOP, "Hop", 0, 0, 0, {}, abflag::none , 0 },

        { ABIL_ROLLING_CHARGE, "Rolling Charge", 0, 0, 0, {}, abflag::none , 0 },
        { ABIL_BLINKBOLT, "Blinkbolt", 0, 0, 0, {}, abflag::none , 0 },

        { ABIL_HEAL_WOUNDS, "Heal Wounds",
            0, 0, 0, {fail_basis::xl, 45, 2}, abflag::none , 0 },

        // EVOKE abilities use Evocations and come from items.
        { ABIL_EVOKE_BLINK, "Evoke Blink",
            1, 0, 0, {fail_basis::evo, 40, 2}, abflag::none , 0 },
        { ABIL_EVOKE_TURN_INVISIBLE, "Evoke Invisibility",
            2, 0, 0, {fail_basis::evo, 60, 2}, abflag::max_hp_drain , 0 },

        // TODO: any way to automatically derive these from the artefact name?
        { ABIL_EVOKE_ASMODEUS, "Evoke the Sceptre of Asmodeus",
            0, 0, 0, {fail_basis::evo, 80, 3}, abflag::none , 0 },
        { ABIL_EVOKE_DISPATER, "Evoke the Staff of Dispater",
            4, 100, 0, {}, abflag::none , 0 },
        ...
        { ABIL_ZIN_RECITE, "Recite",
            0, 0, 0, {fail_basis::invo, 30, 6, 20}, abflag::none , 0 },
        { ABIL_ZIN_VITALISATION, "Vitalisation",
            2, 0, 1, {fail_basis::invo, 40, 5, 20}, abflag::none , 0 },
        { ABIL_ZIN_IMPRISON, "Imprison",
            5, 0, 4, {fail_basis::invo, 60, 5, 20}, abflag::none , 0 },
        { ABIL_ZIN_SANCTUARY, "Sanctuary",
            7, 0, 15, {fail_basis::invo, 80, 4, 25}, abflag::none , 0 },
        { ABIL_ZIN_DONATE_GOLD, "Donate Gold",
            0, 0, 0, {fail_basis::invo}, abflag::none , 0 },

        // The Shining One
        { ABIL_TSO_DIVINE_SHIELD, "Divine Shield",
            3, 0, 2, {fail_basis::invo, 40, 5, 20}, abflag::none , 0 },
        { ABIL_TSO_CLEANSING_FLAME, "Cleansing Flame",
            5, 0, 2, {fail_basis::invo, 70, 4, 25}, abflag::none , 0 },
        { ABIL_TSO_SUMMON_DIVINE_WARRIOR, "Summon Divine Warrior",
            8, 0, 5, {fail_basis::invo, 80, 4, 25}, abflag::none , 0 },
        ...
        { ABIL_KIKU_TORMENT, "Torment",
            4, 0, 8, {fail_basis::invo, 60, 5, 20}, abflag::none , 0 },
        { ABIL_KIKU_GIFT_CAPSTONE_SPELLS, "Receive Forbidden Knowledge", 0, 0, 0,
            {fail_basis::invo}, abflag::none , 0 },
        { ABIL_KIKU_BLESS_WEAPON, "Brand Weapon With Pain", 0, 0, 0,
            {fail_basis::invo}, abflag::pain , 0 },

        // Yredelemnul
        { ABIL_YRED_INJURY_MIRROR, "Injury Mirror",
            0, 0, 0, {fail_basis::invo, 40, 4, 20}, abflag::piety , 0 },
        { ABIL_YRED_ANIMATE_REMAINS, "Animate Remains",
            2, 0, 0, {fail_basis::invo, 40, 4, 20}, abflag::none , 0 },
        { ABIL_YRED_RECALL_UNDEAD_SLAVES, "Recall Undead Slaves",
            2, 0, 0, {fail_basis::invo, 50, 4, 20}, abflag::none , 0 },
        { ABIL_YRED_ANIMATE_DEAD, "Animate Dead",
            2, 0, 0, {fail_basis::invo, 40, 4, 20}, abflag::none , 0 },
        { ABIL_YRED_DRAIN_LIFE, "Drain Life",
            6, 0, 2, {fail_basis::invo, 60, 4, 25}, abflag::none , 0 },
        { ABIL_YRED_ENSLAVE_SOUL, "Enslave Soul",
            8, 0, 4, {fail_basis::invo, 80, 4, 25}, abflag::none , 0 },

        // Okawaru
        { ABIL_OKAWARU_HEROISM, "Heroism",
            2, 0, 1, {fail_basis::invo, 30, 6, 20}, abflag::none , 0 },
        { ABIL_OKAWARU_FINESSE, "Finesse",
            5, 0, 3, {fail_basis::invo, 60, 4, 25}, abflag::none , 0 },
        { ABIL_OKAWARU_DUEL, "Duel",
            7, 0, 8, {fail_basis::invo, 80, 4, 20}, abflag::none , 0 },

        // Makhleb
        { ABIL_MAKHLEB_MINOR_DESTRUCTION, "Minor Destruction",
            0, scaling_cost::fixed(1), 0, {fail_basis::invo, 40, 5, 20}, abflag::none , 0 },
        { ABIL_MAKHLEB_LESSER_SERVANT_OF_MAKHLEB, "Lesser Servant of Makhleb",
            0, scaling_cost::fixed(4), 2, {fail_basis::invo, 40, 5, 20}, abflag::hostile , 0 },
        { ABIL_MAKHLEB_MAJOR_DESTRUCTION, "Major Destruction",
            0, scaling_cost::fixed(6), generic_cost::range(0, 1),
            {fail_basis::invo, 60, 4, 25}, abflag::none , 0 },
        { ABIL_MAKHLEB_GREATER_SERVANT_OF_MAKHLEB, "Greater Servant of Makhleb",
            0, scaling_cost::fixed(10), 5,
            {fail_basis::invo, 90, 2, 5}, abflag::hostile , 0 },

        // Sif Muna
        { ABIL_SIF_MUNA_CHANNEL_ENERGY, "Channel Magic",
            0, 0, 2, {fail_basis::invo, 60, 4, 25}, abflag::none , 0 },
        { ABIL_SIF_MUNA_FORGET_SPELL, "Forget Spell",
            0, 0, 8, {fail_basis::invo}, abflag::none , 0 },
        { ABIL_SIF_MUNA_DIVINE_EXEGESIS, "Divine Exegesis",
            0, 0, 12, {fail_basis::invo, 80, 4, 25}, abflag::none , 0 },

        // Trog
        { ABIL_TROG_BERSERK, "Berserk",
            0, 0, 0, {fail_basis::invo, 45, 0, 2}, abflag::none , 0 },
        { ABIL_TROG_HAND, "Trog's Hand",
            0, 0, 2, {fail_basis::invo, piety_breakpoint(2), 0, 1}, abflag::none , 0 },
        { ABIL_TROG_BROTHERS_IN_ARMS, "Brothers in Arms",
            0, 0, generic_cost::range(5, 6),
            {fail_basis::invo, piety_breakpoint(5), 0, 1}, abflag::none , 0 },

        // Elyvilon
        { ABIL_ELYVILON_LIFESAVING, "Divine Protection",
            0, 0, 0, {fail_basis::invo}, abflag::piety , 0 },
        { ABIL_ELYVILON_LESSER_HEALING, "Lesser Healing", 1, 0,
            generic_cost::range(0, 1), {fail_basis::invo, 30, 6, 20}, abflag::none , 0 },
        { ABIL_ELYVILON_HEAL_OTHER, "Heal Other",
            2, 0, 2, {fail_basis::invo, 40, 5, 20}, abflag::none , 0 },
        { ABIL_ELYVILON_PURIFICATION, "Purification",
            3, 0, 3, {fail_basis::invo, 20, 5, 20}, abflag::conf_ok , 0 },
        { ABIL_ELYVILON_GREATER_HEALING, "Greater Healing",
            2, 0, 3, {fail_basis::invo, 40, 5, 20}, abflag::none , 0 },
        { ABIL_ELYVILON_DIVINE_VIGOUR, "Divine Vigour",
            0, 0, 6, {fail_basis::invo, 80, 4, 25}, abflag::none , 0 },

        // Lugonu
        { ABIL_LUGONU_ABYSS_EXIT, "Depart the Abyss",
            1, 0, 10, {fail_basis::invo, 30, 6, 20}, abflag::none , 0 },
        { ABIL_LUGONU_BEND_SPACE, "Bend Space",
            1, scaling_cost::fixed(2), 0, {fail_basis::invo, 40, 5, 20}, abflag::none , 0 },
        ...
        { ABIL_NEMELEX_TRIPLE_DRAW, "Triple Draw",
            2, 0, 6, {fail_basis::invo, 60, 5, 20}, abflag::none , 0 },
        { ABIL_NEMELEX_DEAL_FOUR, "Deal Four",
            8, 0, 4, {fail_basis::invo, -1}, abflag::none , 0 }, // failure special-cased
        { ABIL_NEMELEX_STACK_FIVE, "Stack Five",
            5, 0, 10, {fail_basis::invo, 80, 4, 25}, abflag::none , 0 },

        // Beogh
        { ABIL_BEOGH_SMITING, "Smiting",
            3, 0, generic_cost::fixed(3), {fail_basis::invo, 40, 5, 20}, abflag::none , 0 },
        { ABIL_BEOGH_RECALL_ORCISH_FOLLOWERS, "Recall Orcish Followers",
            2, 0, 0, {fail_basis::invo, 30, 6, 20}, abflag::none , 0 },
        { ABIL_BEOGH_GIFT_ITEM, "Give Item to Named Follower",
            0, 0, 0, {fail_basis::invo}, abflag::none , 0 },
        { ABIL_BEOGH_RESURRECTION, "Resurrection",
            0, 0, 28, {fail_basis::invo}, abflag::none , 0 },

        // Jiyva
        { ABIL_JIYVA_CALL_JELLY, "Request Jelly",
            2, 0, 1, {fail_basis::invo}, abflag::none , 0 },
        { ABIL_JIYVA_SLIMIFY, "Slimify",
            4, 0, 8, {fail_basis::invo, 90, 0, 2}, abflag::none , 0 },
        { ABIL_JIYVA_CURE_BAD_MUTATION, "Cure Bad Mutation",
            0, 0, 15, {fail_basis::invo}, abflag::none , 0 },
        ...
        { ABIL_FEDHAS_GROW_BALLISTOMYCETE, "Grow Ballistomycete",
            4, 0, 4, {fail_basis::invo, 60, 4, 25}, abflag::none , 0 },
        { ABIL_FEDHAS_OVERGROW, "Overgrow",
            8, 0, 12, {fail_basis::invo, 70, 5, 20}, abflag::none},
        { ABIL_FEDHAS_GROW_OKLOB, "Grow Oklob",
            6, 0, 6, {fail_basis::invo, 80, 4, 25}, abflag::none , 0 },

        // Cheibriados
        { ABIL_CHEIBRIADOS_TIME_BEND, "Bend Time",
            3, 0, 1, {fail_basis::invo, 40, 4, 20}, abflag::none , 0 },
        { ABIL_CHEIBRIADOS_DISTORTION, "Temporal Distortion",
            4, 0, 3, {fail_basis::invo, 60, 5, 20}, abflag::instant , 0 },
        { ABIL_CHEIBRIADOS_SLOUCH, "Slouch",
            5, 0, 8, {fail_basis::invo, 60, 4, 25}, abflag::none , 0 },
        { ABIL_CHEIBRIADOS_TIME_STEP, "Step From Time",
            10, 0, 10, {fail_basis::invo, 80, 4, 25}, abflag::none , 0 },

        // Ashenzari
        { ABIL_ASHENZARI_CURSE, "Curse Item",
            0, 0, 0, {fail_basis::invo}, abflag::none , 0 },
        { ABIL_ASHENZARI_UNCURSE, "Shatter the Chains",
            0, 0, 0, {fail_basis::invo}, abflag::curse , 0 },

        // Dithmenos
        { ABIL_DITHMENOS_SHADOW_STEP, "Shadow Step",
            4, 80, 5, {fail_basis::invo, 30, 6, 20}, abflag::none , 0 },
        { ABIL_DITHMENOS_SHADOW_FORM, "Shadow Form",
            9, 0, 12, {fail_basis::invo, 80, 4, 25}, abflag::max_hp_drain , 0 },

        // Ru
        { ABIL_RU_DRAW_OUT_POWER, "Draw Out Power", 0, 0, 0,
            {fail_basis::invo}, abflag::exhaustion|abflag::max_hp_drain|abflag::conf_ok , 0 },
        { ABIL_RU_POWER_LEAP, "Power Leap",
            5, 0, 0, {fail_basis::invo}, abflag::exhaustion , 0 },
        { ABIL_RU_APOCALYPSE, "Apocalypse",
            8, 0, 0, {fail_basis::invo}, abflag::exhaustion|abflag::max_hp_drain , 0 },

        { ABIL_RU_SACRIFICE_PURITY, "Sacrifice Purity",
            0, 0, 0, {fail_basis::invo}, abflag::sacrifice , 0 },
        ...
        { ABIL_GOZAG_POTION_PETITION, "Potion Petition",
            0, 0, 0, {fail_basis::invo}, abflag::gold , 0 },
        { ABIL_GOZAG_CALL_MERCHANT, "Call Merchant",
            0, 0, 0, {fail_basis::invo}, abflag::gold|abflag::none , 0 },
        { ABIL_GOZAG_BRIBE_BRANCH, "Bribe Branch",
            0, 0, 0, {fail_basis::invo}, abflag::gold , 0 },

        // Qazlal
        { ABIL_QAZLAL_UPHEAVAL, "Upheaval",
            4, 0, 3, {fail_basis::invo, 40, 5, 20}, abflag::none , 0 },
        { ABIL_QAZLAL_ELEMENTAL_FORCE, "Elemental Force",
            6, 0, 6, {fail_basis::invo, 60, 5, 20}, abflag::none , 0 },
        { ABIL_QAZLAL_DISASTER_AREA, "Disaster Area",
            7, 0, 10, {fail_basis::invo, 70, 4, 25}, abflag::none , 0 },

        // Uskayaw
        { ABIL_USKAYAW_STOMP, "Stomp",
            3, 0, generic_cost::fixed(20), {fail_basis::invo}, abflag::none , 0 },
        ...
        { ABIL_HEPLIAKLQANA_RECALL, "Recall Ancestor",
            2, 0, 0, {fail_basis::invo}, abflag::none , 0 },
        ...
        { ABIL_HEPLIAKLQANA_IDENTITY,  "Ancestor Identity",
            0, 0, 0, {fail_basis::invo}, abflag::instant , 0 },

        // Wu Jian
        { ABIL_WU_JIAN_SERPENTS_LASH, "Serpent's Lash",
            0, 0, 2, {fail_basis::invo}, abflag::exhaustion | abflag::instant , 0 },
        { ABIL_WU_JIAN_HEAVENLY_STORM, "Heavenly Storm",
            0, 0, 20, {fail_basis::invo, piety_breakpoint(5), 0, 1}, abflag::none , 0 },
        ...
        { ABIL_WU_JIAN_LUNGE, "Lunge", 0, 0, 0, {}, abflag::berserk_ok , 0 },
        { ABIL_WU_JIAN_WHIRLWIND, "Whirlwind", 0, 0, 0, {}, abflag::berserk_ok , 0 },
        { ABIL_WU_JIAN_WALLJUMP, "Wall Jump",
            0, 0, 0, {}, abflag::berserk_ok , 0 },

        // Ignis
        { ABIL_IGNIS_SEA_OF_FIRE, "Sea of Fire",
            0, 0, 6, /*avg 15 uses from 150 to <30 piety*/
            {fail_basis::invo}, abflag::quiet_fail , 0 },
        { ABIL_IGNIS_FOXFIRE, "Foxfire Swarm",
            0, 0, 9, {fail_basis::invo}, abflag::quiet_fail , 0 },
        { ABIL_IGNIS_RISING_FLAME, "Rising Flame",
            0, 0, 24, {fail_basis::invo}, abflag::none , 0 },

        { ABIL_STOP_RECALL, "Stop Recall", 0, 0, 0, {fail_basis::invo}, abflag::none , 0 },
		...
		{ ABIL_MAKE_FUNGUS, "Make mushroom circle", 0, 0, 0, {}, abflag::zotdef, 10 },
		{ ABIL_MAKE_PLANT, "Make plant", 0, 0, 0, {}, abflag::zotdef, 2 },
		{ ABIL_MAKE_OKLOB_SAPLING, "Make oklob sapling", 0, 0, 0, {}, abflag::zotdef, 60 },
		{ ABIL_MAKE_BURNING_BUSH, "Make burning bush", 0, 0, 0, {}, abflag::zotdef, 200 },
		{ ABIL_MAKE_OKLOB_PLANT, "Make oklob plant", 0, 0, 0, {}, abflag::zotdef, 250 },
		{ ABIL_MAKE_ICE_STATUE, "Make ice statue", 0, 0, 0, {}, abflag::zotdef, 2000 },

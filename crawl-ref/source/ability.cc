...
static vector<ability_def> &_get_ability_list()
{
    ...
    // The four numerical fields are: MP, HP, piety, and range. And zot points (for zot defence mode only)
    ...
    static vector<ability_def> Ability_List =
    {
        ...
        { ABIL_NON_ABILITY, "No ability", 0, 0, 0, -1, {}, abflag::none ,0},
        // Innate abilities:
        { ABIL_SPIT_POISON, "Spit Poison",
            0, 0, 0, 5, {fail_basis::xl, 20, 1},
            abflag::breath | abflag::dir_or_target ,0},
        ...
        { ABIL_BREATHE_LIGHTNING, "Breathe Lightning",
            0, 0, 0, LOS_MAX_RANGE, {fail_basis::xl, 30, 1}, abflag::breath ,0},
        ...
        { ABIL_BREATHE_ACID, "Breathe Acid",
            0, 0, 0, 3, {fail_basis::xl, 30, 1}, abflag::breath ,0},
        { ABIL_TRAN_BAT, "Bat Form",
            2, 0, 0, -1, {fail_basis::xl, 45, 2}, abflag::none ,0},
        { ABIL_EXSANGUINATE, "Exsanguinate",
            0, 0, 0, -1, {}, abflag::delay ,0},
        { ABIL_REVIVIFY, "Revivify",
            0, 0, 0, -1, {}, abflag::delay ,0},
        { ABIL_DAMNATION, "Hurl Damnation",
            0, 150, 0, 6, {fail_basis::xl, 50, 1}, abflag::none ,0},
        { ABIL_WORD_OF_CHAOS, "Word of Chaos",
            6, 0, 0, -1, {fail_basis::xl, 50, 1}, abflag::max_hp_drain ,0},
        { ABIL_DIG, "Dig",
            0, 0, 0, -1, {}, abflag::instant | abflag::none ,0},
        { ABIL_SHAFT_SELF, "Shaft Self",
            0, 0, 0, -1, {}, abflag::delay ,0},
        { ABIL_HOP, "Hop",
            0, 0, 0, -1, {}, abflag::none ,0}, // range special-cased
        { ABIL_ROLLING_CHARGE, "Rolling Charge",
            0, 0, 0, -1, {}, abflag::none ,0}, // range special-cased
        { ABIL_BLINKBOLT, "Blinkbolt",
            0, 0, 0, LOS_MAX_RANGE, {}, abflag::none ,0},
        { ABIL_HEAL_WOUNDS, "Heal Wounds",
            0, 0, 0, -1, {fail_basis::xl, 45, 2}, abflag::none ,0},
        { ABIL_END_TRANSFORMATION, "End Transformation",
            0, 0, 0, -1, {}, abflag::none ,0},

        // EVOKE abilities use Evocations and come from items.
        { ABIL_EVOKE_BLINK, "Evoke Blink",
            1, 0, 0, -1, {fail_basis::evo, 40, 2}, abflag::none ,0},
        { ABIL_EVOKE_TURN_INVISIBLE, "Evoke Invisibility",
            2, 0, 0, -1, {fail_basis::evo, 60, 2}, abflag::max_hp_drain ,0},
        // TODO: any way to automatically derive these from the artefact name?
        { ABIL_EVOKE_ASMODEUS, "Evoke the Sceptre of Asmodeus",
            0, 0, 0, -1, {fail_basis::evo, 80, 3}, abflag::none ,0},
        { ABIL_EVOKE_DISPATER, "Evoke the Staff of Dispater",
            4, 100, 0, 6, {}, abflag::none ,0},
        { ABIL_EVOKE_OLGREB, "Evoke the Staff of Olgreb",
            4, 0, 0, -1, {}, abflag::none ,0},

        // INVOCATIONS:
        // Zin
        { ABIL_ZIN_RECITE, "Recite",
            0, 0, 0, -1, {fail_basis::invo, 30, 6, 20}, abflag::none ,0},
        { ABIL_ZIN_VITALISATION, "Vitalisation",
            2, 0, 1, -1, {fail_basis::invo, 40, 5, 20}, abflag::none ,0},
        { ABIL_ZIN_IMPRISON, "Imprison",
            5, 0, 4, LOS_MAX_RANGE, {fail_basis::invo, 60, 5, 20},
            abflag::target | abflag::not_self ,0},
        { ABIL_ZIN_SANCTUARY, "Sanctuary",
            7, 0, 15, -1, {fail_basis::invo, 80, 4, 25}, abflag::none ,0},
        { ABIL_ZIN_DONATE_GOLD, "Donate Gold",
            0, 0, 0, -1, {fail_basis::invo}, abflag::none,0 },

        // The Shining One
        { ABIL_TSO_DIVINE_SHIELD, "Divine Shield",
            3, 0, 2, -1, {fail_basis::invo, 40, 5, 20}, abflag::none ,0},
        { ABIL_TSO_CLEANSING_FLAME, "Cleansing Flame",
            5, 0, 2, -1, {fail_basis::invo, 70, 4, 25}, abflag::none ,0},
        { ABIL_TSO_SUMMON_DIVINE_WARRIOR, "Summon Divine Warrior",
            8, 0, 5, -1, {fail_basis::invo, 80, 4, 25}, abflag::none ,0},
        ...
        { ABIL_KIKU_TORMENT, "Torment",
            4, 0, 8, -1, {fail_basis::invo, 60, 5, 20}, abflag::none ,0 },
        { ABIL_KIKU_GIFT_CAPSTONE_SPELLS, "Receive Forbidden Knowledge",
            0, 0, 0, -1, {fail_basis::invo}, abflag::none , 0},
        { ABIL_KIKU_BLESS_WEAPON, "Brand Weapon With Pain",
            0, 0, 0, -1, {fail_basis::invo}, abflag::pain , 0},

        // Yredelemnul
        { ABIL_YRED_RECALL_UNDEAD_HARVEST, "Recall Undead Harvest",
            2, 0, 0, -1, {fail_basis::invo, 20, 4, 25}, abflag::none ,0 },
        { ABIL_YRED_DARK_BARGAIN, "Dark Bargain",
            4, 0, 0, -1, {fail_basis::invo, 40, 4, 25}, abflag::souls , 0},
        { ABIL_YRED_DRAIN_LIFE, "Drain Life",
            6, 0, 0, -1, {fail_basis::invo, 60, 4, 25}, abflag::souls ,0},
        { ABIL_YRED_BIND_SOUL, "Bind Soul",
            8, 0, 0, LOS_MAX_RANGE, {fail_basis::invo, 80, 4, 25},
            abflag::target | abflag::not_self | abflag::souls ,0},

        // Okawaru
        { ABIL_OKAWARU_HEROISM, "Heroism",
            2, 0, 1, -1, {fail_basis::invo, 30, 6, 20}, abflag::none ,0},
        { ABIL_OKAWARU_FINESSE, "Finesse",
            5, 0, 3, -1, {fail_basis::invo, 60, 4, 25}, abflag::none ,0},
        ...
        { ABIL_MAKHLEB_MAJOR_DESTRUCTION, "Major Destruction",
            ...
            {fail_basis::invo, 60, 4, 25}, abflag::dir_or_target ,0},
        ...
        { ABIL_SIF_MUNA_CHANNEL_ENERGY, "Channel Magic",
            0, 0, 2, -1, {fail_basis::invo, 60, 4, 25}, abflag::none ,0},
        { ABIL_SIF_MUNA_FORGET_SPELL, "Forget Spell",
            0, 0, 8, -1, {fail_basis::invo}, abflag::none ,0},
        { ABIL_SIF_MUNA_DIVINE_EXEGESIS, "Divine Exegesis",
            0, 0, 12, -1, {fail_basis::invo, 80, 4, 25}, abflag::none ,0},

        // Trog
        { ABIL_TROG_BERSERK, "Berserk",
            0, 0, 1, -1, {fail_basis::invo, 45, 0, 2}, abflag::none ,0},
        ...
        { ABIL_ELYVILON_PURIFICATION, "Purification",
            2, 0, 2, -1, {fail_basis::invo, 20, 5, 20}, abflag::conf_ok ,0},
        { ABIL_ELYVILON_HEAL_OTHER, "Heal Other",
            2, 0, 2, -1, {fail_basis::invo, 40, 5, 20}, abflag::none ,0},
        { ABIL_ELYVILON_HEAL_SELF, "Heal Self",
            2, 0, 3, -1, {fail_basis::invo, 40, 5, 20}, abflag::none ,0},
        { ABIL_ELYVILON_DIVINE_VIGOUR, "Divine Vigour",
            0, 0, 6, -1, {fail_basis::invo, 80, 4, 25}, abflag::none ,0},

        // Lugonu
        { ABIL_LUGONU_ABYSS_EXIT, "Depart the Abyss",
            1, 0, 10, -1, {fail_basis::invo, 30, 6, 20}, abflag::none ,0},
        ...
        { ABIL_DITHMENOS_SHADOW_FORM, "Shadow Form",
            9, 0, 12, -1, {fail_basis::invo, 80, 4, 25}, abflag::max_hp_drain ,0},

        // Ru
        { ABIL_RU_DRAW_OUT_POWER, "Draw Out Power",
            0, 0, 0, -1, {fail_basis::invo},
            abflag::exhaustion | abflag::max_hp_drain | abflag::conf_ok ,0},
        { ABIL_RU_POWER_LEAP, "Power Leap",
            5, 0, 0, 3, {fail_basis::invo}, abflag::exhaustion ,0},
        { ABIL_RU_APOCALYPSE, "Apocalypse",
            8, 0, 0, -1, {fail_basis::invo},
            abflag::exhaustion | abflag::max_hp_drain ,0},

        { ABIL_RU_SACRIFICE_PURITY, "Sacrifice Purity",
            0, 0, 0, -1, {fail_basis::invo}, abflag::sacrifice ,0},
        ...
        { ABIL_GOZAG_POTION_PETITION, "Potion Petition",
            0, 0, 0, -1, {fail_basis::invo}, abflag::gold ,0},
        ...
        { ABIL_QAZLAL_ELEMENTAL_FORCE, "Elemental Force",
            5, 0, 6, -1, {fail_basis::invo, 60, 5, 20}, abflag::none ,0},
        { ABIL_QAZLAL_DISASTER_AREA, "Disaster Area",
            8, 0, 10, -1, {fail_basis::invo, 70, 4, 25}, abflag::none ,0},
        ...
        { ABIL_USKAYAW_LINE_PASS, "Line Pass",
            ...
            {fail_basis::invo}, abflag::none  ,0},
        { ABIL_USKAYAW_GRAND_FINALE, "Grand Finale",
            8, 0, generic_cost::fixed(0), LOS_MAX_RANGE,
            {fail_basis::invo, 120 + piety_breakpoint(4), 5, 1}, abflag::none ,0},

        // Hepliaklqana
        { ABIL_HEPLIAKLQANA_RECALL, "Recall Ancestor",
            2, 0, 0, -1, {fail_basis::invo}, abflag::none  ,0 },
        ...
        { ABIL_HEPLIAKLQANA_IDEALISE, "Idealise",
            4, 0, 4, -1, {fail_basis::invo, 60, 4, 25}, abflag::none ,0 },
        ...
        { ABIL_HEPLIAKLQANA_IDENTITY, "Ancestor Identity",
            0, 0, 0, -1, {fail_basis::invo}, abflag::instant ,0 },

        // Wu Jian
        { ABIL_WU_JIAN_SERPENTS_LASH, "Serpent's Lash",
            0, 0, 2, -1, {fail_basis::invo},
            abflag::exhaustion | abflag::instant ,0 },
        ...
        { ABIL_IGNIS_FOXFIRE, "Foxfire Swarm",
            0, 0, 12, -1, {fail_basis::invo}, abflag::quiet_fail ,0},
        ...
        { ABIL_WIZ_BUILD_TERRAIN, "Build terrain",
            0, 0, 0, LOS_MAX_RANGE, {}, abflag::instant ,0},
        { ABIL_WIZ_SET_TERRAIN, "Set terrain to build",
            0, 0, 0, -1, {}, abflag::instant,0 },
        { ABIL_WIZ_CLEAR_TERRAIN, "Clear terrain to floor",
            0, 0, 0, LOS_MAX_RANGE, {}, abflag::instant ,0 },
#endif

		 // zot defence abilities
		{ ABIL_MAKE_FUNGUS, "Make mushroom circle", 0, 0, 0,  LOS_MAX_RANGE, {}, abflag::zotdef, 10 },
		{ ABIL_MAKE_PLANT, "Make plant", 0, 0, 0,  LOS_MAX_RANGE,{}, abflag::zotdef, 2 },
		{ ABIL_MAKE_OKLOB_SAPLING, "Make oklob sapling", 0, 0, 0, LOS_MAX_RANGE, {}, abflag::zotdef, 60 },
		{ ABIL_MAKE_BURNING_BUSH, "Make burning bush", 0, 0, 0, LOS_MAX_RANGE, {}, abflag::zotdef, 200 },
		{ ABIL_MAKE_OKLOB_PLANT, "Make oklob plant", 0, 0, 0,  LOS_MAX_RANGE,{}, abflag::zotdef, 250 },
		{ ABIL_MAKE_ICE_STATUE, "Make ice statue", 0, 0, 0, LOS_MAX_RANGE, {}, abflag::zotdef, 2000 },
		{ ABIL_MAKE_OCS, "Make crystal statue", 0, 0, 0, LOS_MAX_RANGE, {}, abflag::zotdef, 2000 },
		{ ABIL_MAKE_OBSIDIAN_STATUE, "Make obsidian statue", 0, 0, 0, LOS_MAX_RANGE, {}, abflag::zotdef, 3000 },
		{ ABIL_MAKE_CURSE_SKULL, "Make curse skull",
		  0, 0, 0, LOS_MAX_RANGE, {}, abflag::zotdef | abflag::max_hp_drain, 10000    },
		{ ABIL_MAKE_TELEPORT, "Zot-teleport", 0, 0, 0, -1, {}, abflag::zotdef, 2 },
		{ ABIL_MAKE_ARROW_TRAP, "Make arrow trap", 0, 0, 0,  LOS_MAX_RANGE, {}, abflag::zotdef, 30 },
		{ ABIL_MAKE_BOLT_TRAP, "Make bolt trap", 0, 0, 0, LOS_MAX_RANGE, {}, abflag::zotdef, 300 },
		{ ABIL_MAKE_SPEAR_TRAP, "Make spear trap", 0, 0, 0, LOS_MAX_RANGE, {}, abflag::zotdef, 50 },
		{ ABIL_MAKE_DART_TRAP, "Make dart trap", 0, 0, 0, LOS_MAX_RANGE, {}, abflag::zotdef, 30 },
		{ ABIL_MAKE_NET_TRAP, "Make net trap", 0, 0, 0, LOS_MAX_RANGE, {}, abflag::zotdef, 2 },
		{ ABIL_MAKE_ALARM_TRAP, "Make alarm trap", 0, 0, 0, LOS_MAX_RANGE, {}, abflag::zotdef, 2 },
		{ ABIL_MAKE_BLADE_TRAP, "Make blade trap", 0, 0, 0, LOS_MAX_RANGE, {}, abflag::zotdef, 3000 },
		{ ABIL_MAKE_OKLOB_CIRCLE, "Make oklob circle", 0, 0, 0, LOS_MAX_RANGE, {}, abflag::zotdef, 1000 },
		{ ABIL_MAKE_ACQUIRE_GOLD, "Acquire gold",
		  0, 0, 0, -1, {}, abflag::zotdef | abflag::max_hp_drain, 1000   },
		{ ABIL_MAKE_ACQUIREMENT, "Acquirement",
		  0, 0, 0, -1, {}, abflag::zotdef | abflag::max_hp_drain, 10000   },
		{ ABIL_MAKE_WATER, "Make water", 0, 0, 0,-1, {}, abflag::zotdef, 10 },
		{ ABIL_MAKE_LIGHTNING_SPIRE, "Make lightning spire", 0, 0, 0,  LOS_MAX_RANGE, {}, abflag::zotdef, 100 },
		{ ABIL_MAKE_BAZAAR, "Make bazaar",
		  0, 30, 0, -1, {}, abflag::zotdef | abflag::max_hp_drain, 10000  },
		{ ABIL_MAKE_ALTAR, "Make altar", 0, 0, 0, -1, {}, abflag::zotdef, 50 },
		{ ABIL_MAKE_GRENADES, "Make grenades", 0, 0, 0, -1, {}, abflag::zotdef, 2 } 
...
ability_type ability_by_name(const string &key)
{
    for (const auto &abil : _get_ability_list())
    {
        ...
        if ((abil.flags & abflag::zotdef) && !crawl_state.game_is_zotdef())
            continue;
...
// TODO: Clean up these helper functions later
// taken from traps.cc or traps.h
// but changed since its only used in the following related code now.
int _zotdef_count_traps(trap_type ttyp)
{
    int num = 0;
...
// the following two functions USED to be in mon-util.cc  but now only used in zotdef related code
...
int _zotdef_count_monsters(monster_type mtyp, bool friendly_only)
{
...
static int _count_relevant_monsters(const ability_def& abil)
{
    ...
    if (mtyp == MONS_PROGRAM_BUG)
        return 0;
    return _zotdef_count_monsters(mtyp, true);        // Friendly ones only
}
...
static int _zp_cost(const ability_def& abil)
{
    ...
    switch (abil.ability)
    {
		...
		// TODO: Consider reworking this scaling cost.
        // Simple Traps
        ...
        case ABIL_MAKE_ALARM_TRAP:
            num = _zotdef_count_traps(_trap_for_ability(abil));
            scale10 = max(num-5, 0);   // First 5 at base cost
            break;

        case ABIL_MAKE_BLADE_TRAP:
            scale10 = _zotdef_count_traps(TRAP_BLADE); // Max of 18-ish at base cost 3000
            break;
    }
                         ...
                         bolt beam)
{
    ...
    case ABIL_MAKE_FUNGUS:{
		...
		//  I think this needs to be defined in here
		//instead of outside the case block where it used to be
		direction_chooser_args args;
        ...
        {
            place_monster(mgen_data(MONS_FUNGUS, BEH_FRIENDLY,  *ai,
                          you.pet_target), true);
    ...
    case ABIL_MAKE_OKLOB_CIRCLE:{
        ...
        for (adjacent_iterator ai(abild.target); ai; ++ai)
        {
            place_monster(mgen_data(MONS_OKLOB_PLANT, BEH_FRIENDLY, *ai, you.pet_target), true);
...
int find_ability_slot(const ability_type abil, char firstletter)
{
    ...
    // Skip over  a-E for ZotDef
    if (get_ability_def(abil).flags & abflag::zotdef)
        first_slot = letter_to_index('F'); // for *some* memory compat.
	// something about this feels rather messy.

...
bool item_is_rechargeable(const item_def& it, bool hide_charged = false, bool divine = false) PURE;
bool item_is_quickrechargeable(const item_def& it, bool hide_charged = false);

...
function vaults_default_options()
  ...
  -- Main options table
  local options = {
    max_rooms = 23, -- Maximum number of rooms to attempt to place
    ...
    max_room_tries = 15, -- How many *consecutive* rooms can fail to place before we exit the entire routine
    max_place_tries = 30, -- How many times we will attempt to place *each room* before picking another

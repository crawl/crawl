...
function vaults_default_options()
  ...
  local options = {
    ...
    room_type_weights = {
      ...
      -- Create tagged generators to represent ghost vaults and Wizlab portal
      -- entry vaults. The weights should be 0 since these generators are only
      -- chosen through a chance rolls.

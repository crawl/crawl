...
static const random_pick_entry<int> spell_level_weights[] = {
    // Low-level spells are, generally, most exciting early.
    ...
    // Mid-level spells have have more long-term utility.
    ...
    // Really high-level spells just stay useful.
    // (But we don't want a billion copies of
    // the Necronomicon etc floating around.)

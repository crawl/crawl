...
{
    habitable_features_set habitat = mons_class_habitable_features(mon_type);
...
{
    habitable_features_set habitat = habitable_features_for_any(mon_types,
                                                                types_count);
...
spret summon_shadow_creatures()
{
    ...
    if (!you_can_see_habitable_spot_near(habitable_features_for_flyer(), 2))
    {
        mpr("There is no available space!");
        return spret::abort;
    }
...
spret kiku_unearth_wretches(bool fail)
{
    ...
    if (!you_can_see_habitable_spot_near(habitable_features_for_flyer(), 4))
    {
        mpr("There is no available space!");
        return spret::abort;
    }

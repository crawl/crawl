...
enum command_type
{
    ...
    // CMD_MIN_SYNTHETIC and later commands cannot be bound to keys
    CMD_MIN_SYNTHETIC,
...
#ifdef USE_TILE_LOCAL
    CMD_MAP_TARGET_CURSOR,

    CMD_PICKUP_WITH_MENU_FOR_MULTIPLE_ITEMS,

    CMD_ACTIVATE_ABILITY_MIN,
    CMD_ACTIVATE_ABILITY_MAX = CMD_ACTIVATE_ABILITY_MIN + NUM_ABILITIES - 1,

    CMD_MEMORISE_SPELL_MIN,
    CMD_MEMORISE_SPELL_MAX = CMD_MEMORISE_SPELL_MIN + NUM_SPELLS - 1,

    CMD_CAST_SPELL_MIN,
    CMD_CAST_SPELL_MAX = CMD_CAST_SPELL_MIN + NUM_SPELLS - 1,

    CMD_WIZARD_SET_SKILL_MIN,
    CMD_WIZARD_SET_SKILL_MAX = CMD_WIZARD_SET_SKILL_MIN + NUM_SKILLS - 1,

    CMD_TRAVEL_TO_MIN,
    CMD_TRAVEL_TO_MAX = CMD_TRAVEL_TO_MIN + X_WIDTH * Y_WIDTH - 1,

    CMD_PRIMARY_ATTACK_AT_MIN,
    CMD_PRIMARY_ATTACK_AT_MAX = CMD_PRIMARY_ATTACK_AT_MIN
        + X_WIDTH * Y_WIDTH - 1,

    CMD_SECONDARY_ATTACK_AT_MIN,
    CMD_SECONDARY_ATTACK_AT_MAX = CMD_SECONDARY_ATTACK_AT_MIN
        + X_WIDTH * Y_WIDTH - 1,

    CMD_DROP_ITEM_AT_INDEX_MIN,
    CMD_DROP_ITEM_AT_INDEX_MAX = CMD_DROP_ITEM_AT_INDEX_MIN + ENDOFPACK - 1,

    CMD_DROP_ITEM_QUANTITY_AT_INDEX_MIN,
    CMD_DROP_ITEM_QUANTITY_AT_INDEX_MAX = CMD_DROP_ITEM_QUANTITY_AT_INDEX_MIN
        + ENDOFPACK - 1,

    CMD_PICKUP_ITEM_BY_INDEX_MIN,
    CMD_PICKUP_TIEM_BY_INDEX_MAX = CMD_PICKUP_ITEM_BY_INDEX_MIN
        + MAX_ITEMS - 1,

    CMD_PICKUP_ITEM_QUANTITY_BY_INDEX_MIN,
    CMD_PICKUP_TIEM_QUANTITY_BY_INDEX_MAX =
        CMD_PICKUP_ITEM_QUANTITY_BY_INDEX_MIN + MAX_ITEMS - 1,

    CMD_USE_ITEM_BY_INDEX_MIN,
    CMD_USE_ITEM_BY_INDEX_MAX = CMD_USE_ITEM_BY_INDEX_MIN + ENDOFPACK - 1,

    CMD_USE_ITEM_SECONDARY_BY_INDEX_MIN,
    CMD_USE_ITEM_SECONDARY_BY_INDEX_MAX = CMD_USE_ITEM_SECONDARY_BY_INDEX_MIN
        + ENDOFPACK - 1,

    CMD_DESCRIBE_SQUARE_MIN,
    CMD_DESCRIBE_SQUARE_MAX = CMD_DESCRIBE_SQUARE_MIN + X_WIDTH * Y_WIDTH - 1,

    CMD_DESCRIBE_INVENTORY_ITEM_MIN,
    CMD_DESCRIBE_INVENTORY_ITEM_MAX = CMD_DESCRIBE_INVENTORY_ITEM_MIN
        + ENDOFPACK - 1,

    CMD_DESCRIBE_FLOOR_ITEM_MIN,
    CMD_DESCRIBE_FLOOR_ITEM_MAX = CMD_DESCRIBE_FLOOR_ITEM_MIN + MAX_ITEMS - 1,
#endif

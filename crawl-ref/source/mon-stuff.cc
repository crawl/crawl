                             ...
                             int killer_index, bool pet_kill, bool wizard)
{
    ...
    else if (player_can_hear(mons->pos()) && !is_sanctuary(mons->pos()))
    {
        // "Clap of thunder" is the message generated for the only other
        // lightning explosion, generated by Orb of Electrocution effects
        // (Spark card, disc of storms)
        mprf(MSGCH_SOUND, "You hear %s!",
             mons->type == MONS_BALL_LIGHTNING ? "a clap of thunder"
                                               : "an explosion");
    }

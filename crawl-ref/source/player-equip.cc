...
static void _equip_amulet_of_regeneration()
{
	...
	else if (you.hp == you.hp_max)
	{
		...
		mpr("목걸이가 당신의 멀쩡한 몸과 동화되며 고동치기 시작했다.");
	}
	else
	{
		mpr("목걸이가 당신의 상처입은 몸과 동화되지 못하는 것이 느껴진다");

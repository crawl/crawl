                       ...
                       poly_power_type power)
{
    ...
    const bool was_invisible = mons->has_ench(ENCH_INVIS) && !you.can_see_invisible();
    bool could_see = you.can_see(*mons);
    ...
    const bool is_invisible = mons->has_ench(ENCH_INVIS) && !you.can_see_invisible();
    if (you.see_cell(mons->pos()))
    {
        if (was_invisible && !is_invisible && !mons->friendly())
        {

...
static bool _pray_ecumenical_altar()
{
    ...
    you.turn_is_over = true;
    {
        ...
        // Remove our form if the new god hates it.
        //
        // This will remove any temporary forms on top of the hated form, like
        // flux or hostile polymorphs. Possibly we could just call
        ...
        // Remove gear the chosen god won't tolerate, so they'll accept us
        // below.
        for (item_def* item : you.equipment.get_slot_items(SLOT_ALL_EQUIPMENT, true))
        {

...
habitat_type mons_habitat_type(monster_type mc, bool real_amphibious)
{
    const monsterentry *me = get_monster_data(mc);
...
{
    return mons_habitat_type(fixup_zombie_type(t, base_t),
                               real_amphibious);
}
...
{
    habitat_type ht = mons_habitat_type(mc);

...
HORNS_WEIGHT = 4;
TALONS_WEIGHT = 4;
STRONG_WILLED_WEIGHT = 4;
MUT_ROBUST_WEIGHT = 4;
MUT_HOOVES_WEIGHT = 4;
MUT_ANTENNAE_WEIGHT = 3;
MUT_POISON_RESISTANCE_WEIGHT = 3;
MUT_HEAT_RESISTANCE_WEIGHT = 3;
MUT_COLD_RESISTANCE_WEIGHT = 3;
MUT_MUTATION_RESISTANCE_WEIGHT = 3;
MUT_EVOLUTION_WEIGHT = 3;
MUT_PASSIVE_MAPPING_WEIGHT = 2;
MUT_SHOCK_RESISTANCE_WEIGHT = 2;
MUT_REGENERATION_WEIGHT = 2;
MUT_ACUTE_VISION_WEIGHT = 2;
MUT_NOISE_DAMPENING_WEIGHT = 2;
MUT_CLAWS_WEIGHT = 2;
MUT_SHAGGY_FUR_WEIGHT = 2;
MUT_HIGH_MAGIC_WEIGHT = 2;
MUT_LARGE_BONE_PLATES_WEIGHT = 2;
MUT_THIN_SKELETAL_STRUCTURE_WEIGHT = 2;
MUT_STURDY_FRAME_WEIGHT = 2;
MUT_PASSIVE_FREEZE_WEIGHT = 1;
MUT_FANGS_WEIGHT = 1;
MUT_BEAK_WEIGHT = 1;
MUT_CAMOUFLAGE_WEIGHT = 1;

Bad Mutations.
MUT_READ_SAFETY_WEIGHT = 9;
MUT_DETORIORATION_WEIGHT = 9;
MUT_FRAIL_WEIGHT = 9;
MUT_LOW_MAGIC_WEIGHT = 9;
MUT_DEFORMED_WEIGHT = 8;
MUT_WEAK_WEIGHT = 8;
MUT_DOPEY_WEIGHT = 8;
MUT_CLUMSY_WEIGHT = 8;
MUT_BERSERK_WEIGHT = 7;
MUT_SCREAM_WEIGHT = 6;
MUT_SUBDUED_MAGIC_WEIGHT = 6;
MUT_DEVOLUTION_WEIGHT = 4;
MUT_INHIBITED_REGENERATION_WEIGHT = 3;
MUT_TELEPORT_WEIGHT = 3;
MUT_NO_POTION_HEAL_WEIGHT = 3;
*/
...
{ MUT_STRONG, 5, 2, mutflag::good, false,
  "strong",
...
{ MUT_CLEVER, 5, 2, mutflag::good, false,
  "clever",
...
{ MUT_AGILE, 5, 2, mutflag::good, false,
  "agile",
...
{ MUT_POISON_RESISTANCE, 3, 1, mutflag::good, true,
  "poison resistance",
...
{ MUT_HEAT_RESISTANCE, 3, 3, mutflag::good, true,
  "fire resistance",
...
{ MUT_COLD_RESISTANCE, 3, 3, mutflag::good, true,
  "cold resistance",
...
{ MUT_STRONG_WILLED, 4, 3, mutflag::good, false,
  "strong-willed",
...
{ MUT_CLARITY, 5, 1, mutflag::good, false,
  "clarity",
...
{ MUT_DETERIORATION, 9, 2, mutflag::bad | mutflag::xom, false,
  "deterioration",
...
{ MUT_MUTATION_RESISTANCE, 3, 3, mutflag::good, false,
  "mutation resistance",
...
{ MUT_EVOLUTION, 3, 2, mutflag::good, false,
  "evolution",
...
{ MUT_ROBUST, 4, 3, mutflag::good, false,
  "robust",
...
// body-slot facets
{ MUT_HORNS, 4, 3, mutflag::good, true,
  "horns",
...
{ MUT_HOOVES, 4, 3, mutflag::good, true,
  "hooves",
...
{ MUT_ANTENNAE, 3, 3, mutflag::good, true,
  "antennae",
...
{ MUT_TALONS, 4, 3, mutflag::good, true,
  "talons",
...
{ MUT_WILD_MAGIC, 5, 3, mutflag::good, false,
  "wild magic",
...
{ MUT_PASSIVE_MAPPING, 2, 3, mutflag::good, false,
  "sense surroundings",
...
{ MUT_IRIDESCENT_SCALES, 6, 3, mutflag::good, true,
  "iridescent scales",
...
{ MUT_READ_SAFETY, 9, 1, mutflag::bad | mutflag::xom, false,
...
{ MUT_MP_WANDS, 5, 1, mutflag::good, false,
  "MP-powered wands",

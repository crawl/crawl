...
{ MUT_FORM_SHIFTER, 0, 3, mutflag::good, false,
  "form shifter",
  {"You can transform into a local monster.",
   "You can transform into local monsters somewhat frequently.",
   "You can continuously transform into local monsters."},
  {"You can now transform into native creatures.",
   "You can now transform into local monsters more frequently.",
   "You can now continuously transform into local monsters."},
  {"You can no longer transform into native creatures.",
   "You lose some transformative power.",
   "You lose some transformative power."},
},

...
static const map<monster_type, band_set> bands_by_leader = {
    ...
    { MONS_YAKTAUR_CAPTAIN, { {2}, {{ BAND_YAKTAUR_CAPTAIN, {2, 5}, true }}}},
    { MONS_YAKTAUR,         { {2}, {{ BAND_YAKTAURS, {2, 5} }}}},
    { MONS_YAKTAUR_FUSILIER,{ {2}, {{ BAND_YAKTAURS, {2, 5} }}}},
    ...
    { MONS_VAULT_WARDEN,    { {}, {{ BAND_YAKTAUR_CAPTAIN, {2, 6}, true },
...
static const map<band_type, vector<member_possibilities>> band_membership = {
    ...
    { BAND_YAKTAUR_CAPTAIN,     {{{MONS_YAKTAUR, 3},

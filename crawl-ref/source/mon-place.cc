                                   ...
                                   bool force_pos, bool dont_place)
{
    ...
    // The royal jelly and Dissolution belong to Jiyva.
    else if (mg.cls == MONS_ROYAL_JELLY || mg.cls == MONS_DISSOLUTION)
        mon->god = GOD_JIYVA;
...
static monster_type _band_member(band_type band, int power)
{
    ...
    case BAND_INSUBSTANTIAL_WISPS:
        mon_type = (one_chance_in(10) ? MONS_VAPOUR : MONS_INSUBSTANTIAL_WISP);
        break;

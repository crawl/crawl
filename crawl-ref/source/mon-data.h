...

{
    ...
    M_SPELLCASTER | M_SENSE_INVIS | M_WARM_BLOOD | M_GLOWS_LIGHT | M_FAKE_SPELLS,
    MR_NO_FLAGS,
...

{
    ...
    M_WARM_BLOOD | M_NO_SKELETON | M_SPELLCASTER | M_SEE_INVIS | M_FAKE_SPELLS,
    MR_RES_ASPHYX,
...

{
    ...
    M_NO_SKELETON | M_SPELLCASTER | M_SEE_INVIS | M_FAKE_SPELLS,
    MR_RES_POISON,
...

{
    ...
    M_NO_SKELETON | M_SPELLCASTER | M_SEE_INVIS | M_GLOWS_RADIATION | M_FAKE_SPELLS,
    MR_RES_ASPHYX,
...

{
    ...
    M_NO_SKELETON | M_SPELLCASTER | M_SEE_INVIS | M_GLOWS_LIGHT | M_FAKE_SPELLS,
    MR_RES_ASPHYX,
...
// nagas ('N')
{
    ...
    M_SPELLCASTER | M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS | M_FAKE_SPELLS,
    MR_RES_POISON,
...
// Demonic tentacle things.
{
    ...
    mrd(MR_RES_FIRE | MR_RES_HELLFIRE | MR_RES_POISON | MR_RES_COLD | MR_RES_ELEC, 3)
        | MR_RES_STICKY_FLAME | MR_RES_ACID,
...

{
    ...
    M_SPELLCASTER | M_SEE_INVIS | M_INSUBSTANTIAL | M_GLOWS_LIGHT
        | M_GLOWS_RADIATION,
    mrd(MR_RES_FIRE | MR_RES_HELLFIRE | MR_RES_POISON | MR_RES_ELEC, 3) | MR_RES_COLD,

...

{
    ...
    { 13, 3, 5, 0 },
    14, 3, MST_NO_SPELLS, CE_CLEAN, S_SILENT,
...

{
    ...
    { 6, 3, 5, 0 },
    8, 10, MST_NO_SPELLS, CE_CLEAN, S_SILENT,
...

{
    ...
    { 5, 3, 5, 0 },
    6, 13, MST_HELL_HOUND, CE_CLEAN, S_BARK,
    I_ANIMAL, HT_LAND, FL_NONE, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_QUADRUPED
},
...

{
    ...
    { 11, 3, 5, 0 },
    2, 9, MST_HELL_HOG, CE_CLEAN, S_SILENT,
    I_ANIMAL, HT_LAND, FL_NONE, 14, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_QUADRUPED
},
...

{
    ...
    { {AT_BITE, AF_PLAIN, 14}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 5, 5, 0 },
    3, 11, MST_SWAMP_DRAKE, CE_CLEAN, S_ROAR,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 4, 4, 0 },
    3, 12, MST_BASILISK, CE_CLEAN, S_HISS,
    I_REPTILE, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LITTLE, MON_SHAPE_QUADRUPED
},
...

{
    ...
    { 2, 3, 5, 0 },
    5, 11, MST_NO_SPELLS, CE_CLEAN, S_SILENT,
    I_ANIMAL, HT_AMPHIBIOUS, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_QUADRUPED
},

{
    ...
    { 3, 3, 5, 0 },
    7, 10, MST_NO_SPELLS, CE_CLEAN, S_ROAR,
    I_ANIMAL, HT_LAND, FL_NONE, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LITTLE, MON_SHAPE_QUADRUPED
},
...

{
    ...
    { 5, 3, 3, 0 },
    3, 10, MST_NO_SPELLS, CE_CLEAN, S_HISS,
...

{
    ...
    { {AT_POUNCE, AF_ENSNARE, 20}, {AT_BITE, AF_PLAIN, 8}, AT_NO_ATK,
       AT_NO_ATK },
    { 8, 2, 4, 0 },
    6, 12, MST_JUMPING_SPIDER, CE_CLEAN, S_HISS,
    I_INSECT, HT_LAND, FL_NONE, 15, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 13}, {AT_HIT, AF_PLAIN, 13}, {AT_HIT, AF_PLAIN, 13},
       AT_NO_ATK },
    { 9, 4, 5, 0 },
    10, 6, MST_NO_SPELLS, CE_CLEAN, S_SCREAM,
...

{
    ...
    { 8, 4, 5, 0 },
    9, 6, MST_FIRE_CRAB, CE_CLEAN, S_SILENT,
    I_INSECT, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_QUADRUPED // ??
},
...

{
    ...
    { {AT_BITE, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 3, 0 },
    1, 5, MST_BRAIN_WORM, CE_CLEAN, S_SILENT,
    I_INSECT, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_SNAKE
},
...
// dummy genus monster; not using DUMMY since it's also a dummy species
{
    ...
    { 20, 5, 3, 0 },
    2, 1, MST_NO_SPELLS, CE_CLEAN, S_SILENT,
...
// flying insects ('y')
{
    ...
    { {AT_STING, AF_POISON, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 3, 5, 0 },
    2, 18, MST_NO_SPELLS, CE_CLEAN, S_BUZZ,
...

{
    ...
    { 7, 3, 5, 0 },
    10, 10, MST_QUEEN_BEE, CE_CLEAN, S_SILENT,
...

{
    ...
    { 4, 3, 5, 0 },
    5, 14, MST_NO_SPELLS, CE_CLEAN, S_SILENT,
...

{
    ...
    { 8, 3, 5, 0 },
    7, 14, MST_NO_SPELLS, CE_CLEAN, S_BUZZ,
    I_INSECT, HT_LAND, FL_WINGED, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_INSECT_WINGED
},
...

{
    ...
    { {AT_BITE, AF_PLAIN, 18}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 13, 3, 5, 0 },
    0, 5, MST_NO_SPELLS, CE_CLEAN, S_ROAR,
    I_REPTILE, HT_AMPHIBIOUS, FL_NONE, 10, SWIM_ENERGY(6),
...

{
    ...
    { 9, 5, 5, 0 },
    7, 7, MST_SWAMP_DRAGON, CE_CLEAN, S_ROAR,
    I_ANIMAL, HT_LAND, FL_WINGED, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_GIANT, MON_SHAPE_QUADRUPED_WINGED
},

{
    ...
    { 5, 3, 5, 0 },
    5, 10, MST_MOTTLED_DRAGON, CE_CLEAN, S_SILENT,
    I_ANIMAL, HT_LAND, FL_WINGED, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_BIG, MON_SHAPE_QUADRUPED_WINGED
},
...

{
    ...
    { 18, 4, 4, 0 },
    15, 7, MST_GOLDEN_DRAGON, CE_CLEAN, S_ROAR,
    I_ANIMAL, HT_LAND, FL_WINGED, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_GIANT, MON_SHAPE_QUADRUPED_WINGED
},
...

{
    ...
    { 7, 3, 5, 0 },
    6, 9, MST_NO_SPELLS, CE_CLEAN, S_CROAK,
    I_REPTILE, HT_AMPHIBIOUS, FL_NONE, 12, SWIM_ENERGY(6),
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_QUADRUPED_TAILLESS
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 4}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 4, 5, 0 },
    2, 13, MST_KOBOLD_DEMONOLOGIST, CE_CLEAN, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_SMALL, MON_SHAPE_HUMANOID
},
...
// nagas ('N')
{
    ...
    { {AT_HIT, AF_PLAIN, 17}, {AT_CONSTRICT, AF_CRUSH, 3},
       AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 5, 0 },
    6, 10, MST_NAGA, CE_CLEAN, S_SHOUT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 17}, {AT_CONSTRICT, AF_CRUSH, 4},
       AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
    6, 10, MST_NAGA_MAGE, CE_CLEAN, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, MOVE_ENERGY(14),
    MONUSE_WEAPONS_ARMOUR, SIZE_LARGE, MON_SHAPE_NAGA
},

{
    ...
    { 9, 6, 4, 0 },
    6, 10, MST_NAGA_SNIPER, CE_CLEAN, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, MOVE_ENERGY(14),
    MONUSE_WEAPONS_ARMOUR, SIZE_LARGE, MON_SHAPE_NAGA
},

{
    ...
    { {AT_HIT, AF_PLAIN, 14}, {AT_CONSTRICT, AF_CRUSH, 4},
       AT_NO_ATK, AT_NO_ATK },
    { 8, 5, 5, 0 },
    6, 10, MST_NAGA_RITUALIST, CE_CLEAN, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, MOVE_ENERGY(14),
    MONUSE_WEAPONS_ARMOUR, SIZE_LARGE, MON_SHAPE_NAGA
},
...

{
    ...
    { {AT_BITE, AF_POISON, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 5, 0 },
    2, 15, MST_NO_SPELLS, CE_CLEAN, S_HISS,
    I_REPTILE, HT_AMPHIBIOUS, FL_NONE, 14, SWIM_ENERGY(6),
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_SNAKE
},

{
    ...
    { {AT_BITE, AF_POISON, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
    4, 15, MST_NO_SPELLS, CE_CLEAN, S_HISS,
...

{
    ...
    { 16, 3, 5, 0 },
    20, 4, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 7, DEFAULT_ENERGY,
...

{
    ...
    { 14, 3, 5, 0 },
    9, 5, MST_NO_SPELLS, CE_CLEAN, S_BELLOW,
    I_ANIMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_BIG, MON_SHAPE_QUADRUPED
},
...
// A kraken and its tentacles get a random colour from ETC_KRAKEN.
{
    ...
    { 16, 10, 6, 0 },
    20, 0, MST_KRAKEN, CE_CLEAN, S_SILENT,
...
// Snails and other gastropods.
{
    ...
    { {AT_BITE, AF_PLAIN, 40}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 20, 0, 0, 150 },
    2, 1, MST_GASTRONOK, CE_CLEAN, S_GURGLE,
...
// "K"obolds.
{
    ...
    { {AT_HIT, AF_PLAIN, 9}, {AT_HIT, AF_PLAIN, 5}, {AT_HIT, AF_PLAIN, 5},
       AT_NO_ATK },
    { 6, 0, 0, 30 },
    2, 24, MST_SONJA, CE_CLEAN, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 14, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_SMALL, MON_SHAPE_HUMANOID
},
...
// "N"agas.
{
    ...
    { 16, 0, 0, 160 },
    6, 10, MST_VASHNIA, CE_CLEAN, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, MOVE_ENERGY(14),
    MONUSE_WEAPONS_ARMOUR, SIZE_LARGE, MON_SHAPE_NAGA
},

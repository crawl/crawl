...

{
    ...
    { {AT_CLAW, AF_FIRE, 50}, {AT_BITE, AF_SEAR, 30}, AT_NO_ATK },
    18, 1600,
...

{
    ...
    M_FIGHTER | M_WARM_BLOOD | M_SPEAKS | M_GHOST_DEMON
        | M_NO_POLY_TO | M_NO_ZOMBIE | M_NO_GEN_DERIVED
        | M_PREFER_RANGED | M_FAST_REGEN,
    MR_NO_FLAGS,
    9, MONS_ORC, MONS_ORC, MH_NATURAL, -4,
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 675,
    2, 13, MST_GHOST, false, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    M_NO_SKELETON | M_NO_ZOMBIE | M_FLIES,
    MR_NO_FLAGS,
...

{
    ...
    { {AT_BITE, AF_SWOOP, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 605,
...

{
    ...
    { {AT_TOUCH, AF_DRAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 280,
...

{
    ...
    { {AT_HEADBUTT, AF_PLAIN, 16}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 240,
...

{
    ...
    M_NO_SKELETON | M_NO_ZOMBIE | M_BATTY | M_WEB_IMMUNE,
    MR_NO_FLAGS,
...

{
    ...
    M_WARM_BLOOD | M_NO_ZOMBIE | M_SPEAKS | M_FIGHTER | M_SEE_INVIS |
          M_MIASMA_RING,
    MR_RES_COLD,
...

{
    ...
    MR_RES_POISON,
    12, MONS_GIANT, MONS_PROTEAN_PROGENITOR, MH_NATURAL, 120,
...

{
    ...
    M_INSUBSTANTIAL | M_SPEAKS | M_FLIES | M_FAST_REGEN,
    MR_NO_FLAGS,
...
// on creation
{
    ...
    M_SEE_INVIS | M_INSUBSTANTIAL | M_FLIES | M_FAST_REGEN,
    MR_RES_COLD,
    11, MONS_WRAITH, MONS_SPECTRAL_THING, MH_UNDEAD, WILL_INVULN,
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 440,
...

{
    ...
    mrd(MR_RES_FIRE, 2) | MR_RES_COLD | MR_RES_ELEC,
    10, MONS_GOLEM, MONS_BLAZEHEART_GOLEM, MH_NONLIVING, WILL_INVULN,
    { {AT_PUNCH, AF_PLAIN, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 400,
...
// unique major demons ('&')
{
    ...
    { {AT_RANDOM, AF_CHAOTIC, 47}, {AT_RANDOM, AF_PLAIN, 41},
      {AT_RANDOM, AF_BLINK, 37}, AT_NO_ATK },
    17, 4210,

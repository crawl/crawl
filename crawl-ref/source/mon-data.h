...
// uses harpoon shot to reel you in, then it distortion-slaps you away
{
    ...
    { {AT_CONSTRICT, AF_CRUSH, 9},
      {AT_TENTACLE_SLAP, AF_REACH_DISTO, 9},
      {AT_TENTACLE_SLAP, AF_REACH_DISTO, 9},
      AT_NO_ATK  },
...

{
    ...
    mrd(MR_RES_COLD, 3),
    27, MONS_LICH, MONS_LICH, MH_UNDEAD, WILL_INVULN,
    { {AT_HIT, AF_COLD, 10}, {AT_TOUCH, AF_DRAIN, 15}, AT_NO_ATK,
       AT_NO_ATK },
    18, 1300,
...

{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_FAST_REGEN | M_MALE,
    MR_NO_FLAGS,
    10, MONS_TROLL, MONS_TROLL, MH_NATURAL, 100,
    { {AT_BITE, AF_PLAIN, 40}, {AT_CLAW, AF_PLAIN, 35},
      {AT_CLAW, AF_PLAIN, 35}, AT_NO_ATK },
    27, 1200,
    1, 12, MST_NO_SPELLS, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, SIZE_LARGE, MON_SHAPE_HUMANOID,
...

{
    ...
    15, MONS_VV, MONS_VV, MH_NONLIVING, 120,
    { {AT_HIT, AF_COLD, 27}, {AT_HIT, AF_FIRE, 27}, AT_NO_ATK, AT_NO_ATK },
    21, 2100,

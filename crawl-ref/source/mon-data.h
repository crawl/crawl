...
{
    MONS_ZOMAKA, 'n', LIGHTRED, "Zomaka",
    M_NO_ZOMBIE | M_UNIQUE | M_FEMALE | M_ARCHER | M_SPEAKS,
    MR_RES_COLD,
    10, MONS_GHOUL, MONS_GHOUL, MH_UNDEAD, 40,
    { {AT_HIT, AF_PLAIN, 9}, {AT_CLAW, AF_PLAIN, 9}, AT_NO_ATK, AT_NO_ATK },
    10, 600,
    2, 5, MST_NO_SPELLS, CE_NOXIOUS, S_MOAN,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_ZOMAKA}, TILE_ERROR
},

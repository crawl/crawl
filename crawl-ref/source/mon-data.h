...

{
    ...
    { 8, 3, 5, 0 },
    3, 12, MST_NO_SPELLS, CE_CONTAMINATED, Z_BIG, S_SILENT,
    I_ANIMAL, HT_FOREST, FL_FLY, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},
...
// Using 'm' for this is a bit of a stretch; suggestions are welcome.
{
    ...
    MR_VUL_FIRE,
    500, 10, MONS_MERMAID, MONS_DRYAD, MH_NATURAL, -7,
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 5, 3, 0 },
...
{
    MONS_LESHY, 'C', GREEN, "leshy",
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_WARM_BLOOD | M_SPEAKS,
    MR_VUL_FIRE,
    2700, 10, MONS_GIANT, MONS_LESHY, MH_NATURAL, -7,
    { {AT_HIT, AF_PLAIN, 45}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 16, 3, 5, 0 },
    12, 2, MST_LESHY, CE_CONTAMINATED, Z_BIG, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, MONEAT_NOTHING, SIZE_HUGE
},

...
{
    MONS_WATER_BEETLE, 'B', BLUE, "water beetle",
    M_NO_SKELETON,
    MR_VUL_POISON,
    10, MONS_BEETLE, MONS_WATER_BEETLE, MH_NATURAL, 20,
    { {AT_BITE, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 165,
    10, 5, MST_NO_SPELLS, CE_CLEAN, S_SILENT,
    I_ANIMAL, HT_AMPHIBIOUS, 10, SWIM_ENERGY(6),
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_INSECT,
    {TILEP_MONS_WATER_BEETLE}, TILE_CORPSE_WATER_BEETLE
},

...

{
    ...
    M_WARM_BLOOD | M_UNBLINDABLE | M_BLOOD_SCENT | M_MAINTAIN_RANGE,
    MR_RES_COLD,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 16}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 700,
    10, 5, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_VAULT_GUARD}, TILE_ERROR
},

{
    ...
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_NATURAL | MH_EVIL, 100,
    { {AT_HIT, AF_VAMPIRIC, 28}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 900,
    15, 5, MST_MERC_DEATH_KNIGHT, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_DEATH_KNIGHT}, TILE_ERROR
},

{
    ...
    M_WARM_BLOOD | M_FIGHTER | M_SPEAKS | M_NO_POLY_TO | M_NO_GEN_DERIVED,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_NATURAL | MH_HOLY, 100,
    { {AT_HIT, AF_HOLY, 28}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 900,
    15, 5, MST_MERC_PALADIN, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_FAST_REGEN | M_NO_POLY_TO | M_NO_GEN_DERIVED,
    MR_NO_FLAGS,
    10, MONS_MERFOLK, MONS_MERFOLK, MH_NATURAL, 80,
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 550,
    2, 15, MST_MERC_INFUSER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_AMPHIBIOUS, 10, SWIM_ENERGY(6),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_FAST_REGEN | M_SEE_INVIS | M_NO_POLY_TO | M_NO_GEN_DERIVED,
    MR_NO_FLAGS,
    10, MONS_MERFOLK, MONS_MERFOLK, MH_NATURAL, 120,
    { {AT_HIT, AF_PLAIN, 21}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 700,
    5, 25, MST_MERC_TIDEHUNTER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_AMPHIBIOUS, 10, SWIM_ENERGY(6),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    5, 250,
    0, 5, MST_MERC_WITCH, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 2}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 400,
    1, 10, MST_MERC_SORCERESS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
{
    MONS_MERC_ELEMENTALIST, 'e', LIGHTRED, "hired elementalist",
    M_WARM_BLOOD | M_SPEAKS | M_DONT_MELEE | M_MAINTAIN_RANGE | M_NO_POLY_TO | M_NO_GEN_DERIVED,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC ,
    10, MONS_ELF, MONS_ELF, MH_NATURAL, MAG_IMMUNE,
    { {AT_HIT, AF_PLAIN, 2}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 550,
    2, 15, MST_MERC_ELEMENTALIST, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_SHADOWSTAB, 8}, {AT_HIT, AF_SHADOWSTAB, 8}, AT_NO_ATK, AT_NO_ATK },
    10, 500,
    3, 15, MST_NO_SPELLS, CE_NOXIOUS, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_SMALL, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_SHADOWSTAB, 12}, {AT_HIT, AF_SHADOWSTAB, 12}, {AT_HIT, AF_SHADOWSTAB, 12}, AT_NO_ATK },
    15, 650,
    6, 25, MST_NO_SPELLS, CE_NOXIOUS, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_SMALL, MON_SHAPE_HUMANOID,

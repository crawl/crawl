...
// elementals (i)
{
    MONS_EARTH_ELEMENTAL, 'i', YELLOW, "earth elemental",
    M_NO_FLAGS,
...
{
    MONS_FIRE_ELEMENTAL, 'i', LIGHTRED, "fire elemental",
...
{
    MONS_WATER_ELEMENTAL, 'i', LIGHTBLUE, "water elemental",
    M_NO_FLAGS,
...
{
    MONS_AIR_ELEMENTAL, 'i', WHITE, "air elemental",

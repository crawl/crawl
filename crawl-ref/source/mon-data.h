...
// gargoyles ('9')
{
    ...
    M_ARTIFICIAL,
    MR_RES_POISON | MR_RES_COLD | MR_RES_NEG | mrd(MR_RES_ELEC, 2),
    0, 26, MONS_GARGOYLE, MONS_GARGOYLE, MH_NATURAL, -6,
...

{
    ...
    M_ARTIFICIAL,
    MR_RES_POISON | MR_RES_COLD | MR_RES_NEG | mrd(MR_RES_ELEC, 2),
    0, 18, MONS_GARGOYLE, MONS_METAL_GARGOYLE, MH_NATURAL, -6,
    { {AT_BITE, AF_PLAIN, 19}, {AT_CLAW, AF_PLAIN, 10},
      {AT_CLAW, AF_PLAIN, 10}, AT_NO_ATK },
    { 8, 3, 5, 0 },
    20, 4, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_NONE, 7, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    M_ARTIFICIAL,
    MR_RES_POISON | MR_RES_NEG | MR_RES_ELEC | mrd(MR_RES_FIRE, 3),
    0, 18, MONS_GARGOYLE, MONS_MOLTEN_GARGOYLE, MH_NATURAL, -6,

...
{   // both the guy and his ride as one monster
    MONS_BONE_RIDER, 'M', LIGHTBLUE, "bone rider",
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_SENSE_INVIS | M_SPEAKS,
    MR_RES_COLD | MR_RES_ELEC,
    0, 18, MONS_MUMMY, MONS_MUMMY, MH_UNDEAD, MAG_IMMUNE,
    // No claws because that reads funny.
    { {AT_HIT, AF_PLAIN, 50}, {AT_TRAMPLE, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK },
    { 25, 6, 6, 0 },
    20, 6, MST_MUMMY, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_WINGED, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_GIANT, MON_SHAPE_HUMANOID // ??
},

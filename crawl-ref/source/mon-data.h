...

{
    ...
    M_NO_SKELETON | M_WEB_SENSE | M_SEE_INVIS | M_UNBLINDABLE | M_JUMPY,
    MR_VUL_POISON,
...
{
    MONS_STORM_STRIDER, 's', BLUE, "storm strider",
    M_NO_SKELETON | M_JUMPY,
    mrd(MR_RES_COLD, 2) | MR_RES_ELEC | MR_VUL_POISON,
    1200, 10, MONS_SPIDER, MONS_WOLF_SPIDER, MH_NATURAL, 60,
    { {AT_HIT, AF_COLD, 25}, {AT_BITE, AF_ELEC, 25}, AT_NO_ATK, AT_NO_ATK },
    { 13, 3, 4, 0 },
    8, 10, MST_STORM_STRIDER, CE_POISONOUS, S_HISS,
    I_INSECT, HT_AMPHIBIOUS, FL_NONE, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE, MON_SHAPE_INSECT
},
...

{
    ...
    180, 12, MONS_SPARK_WASP, MONS_SPARK_WASP, MH_NATURAL, 40,
    { {AT_STING, AF_SHOCK, 33}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 12, 3, 5, 0 },
    9, 14, MST_RAIJU, CE_POISONOUS, S_BUZZ,
    I_INSECT, HT_LAND, FL_WINGED, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_TINY, MON_SHAPE_INSECT_WINGED
},

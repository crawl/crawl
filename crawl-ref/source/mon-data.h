...
// slugs ('j')
{
    ...
    M_NO_SKELETON,
    MR_NO_FLAGS,
    700, 4, MONS_GIANT_SLUG, MONS_GIANT_SLUG, MH_NATURAL, -3,
...

{
    ...
    M_NO_SKELETON,
    MR_NO_FLAGS,
    900, 2, MONS_GIANT_SLUG, MONS_GIANT_SNAIL, MH_NATURAL, -3,
...

{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    1500, 5, MONS_GIANT_SLUG, MONS_ELEPHANT_SLUG, MH_NATURAL, -3,
...
// lizards ('l')
{
    ...
    M_COLD_BLOOD,
    MR_NO_FLAGS,
    150, 10, MONS_GIANT_NEWT, MONS_GIANT_NEWT, MH_NATURAL, -3,
    { {AT_BITE, AF_PLAIN, 3}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 1, 2, 0 },
...

{
    ...
    M_COLD_BLOOD,
    MR_NO_FLAGS,
    500, 10, MONS_GIANT_NEWT, MONS_GILA_MONSTER, MH_NATURAL, -3,
    { {AT_BITE, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 4, 4, 0 },
...
// with draconians already, and a lightcyan l is unique. - jpeg, Feb 08
{
    ...
    M_SPECIAL_ABILITY | M_WARM_BLOOD,
    MR_NO_FLAGS,
    1000, 13, MONS_DRAGON, MONS_LINDWURM, MH_NATURAL, -3,
...

{
    ...
    M_NO_FLAGS,
    MR_RES_POISON | MR_RES_COLD,
    0, 10, MONS_GHOUL, MONS_ROTTING_HULK, MH_UNDEAD, -5,
...

{
    ...
    M_WARM_BLOOD,
    MR_NO_FLAGS,
    250, 13, MONS_RAT, MONS_GREEN_RAT, MH_NATURAL, -3,
...
// ugly things ('u')
{
    ...
    I_ANIMAL, HT_AMPHIBIOUS, FL_NONE, 11, ACTION_ENERGY(11),
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// worms ('w')
{
    ...
    M_NO_SKELETON,
    MR_NO_FLAGS,
    350, 3, MONS_WORM, MONS_WORM, MH_NATURAL, -2,
    { {AT_BITE, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 5, 0 },
...
// flying insects ('y')
{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    220, 15, MONS_YELLOW_WASP, MONS_YELLOW_WASP, MH_NATURAL, -3,
...

{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    400, 12, MONS_YELLOW_WASP, MONS_RED_WASP, MH_NATURAL, -3,
...

{
    ...
    M_SPELLCASTER | M_WARM_BLOOD,
    MR_RES_STEAM,
    1000, 29, MONS_DRAGON, MONS_STEAM_DRAGON, MH_NATURAL, -3,
...

{
    ...
    M_COLD_BLOOD,
    MR_NO_FLAGS,
    890, 6, MONS_GIANT_FROG, MONS_GIANT_TOAD, MH_NATURAL, -3,
    { {AT_HIT, AF_PLAIN, 14}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 3, 5, 0 },
...

{
    ...
    M_COLD_BLOOD,
    MR_RES_POISON,
    1000, 16, MONS_GIANT_FROG, MONS_SPINY_FROG, MH_NATURAL, -3,
...

{
    ...
    MR_NO_FLAGS,
    800, 13, MONS_BLINK_FROG, MONS_BLINK_FROG, MH_NATURAL, -5,
...
// hybrids ('H')
{
    ...
    M_WARM_BLOOD,
    MR_NO_FLAGS,
    1000, 8, MONS_HIPPOGRIFF, MONS_HIPPOGRIFF, MH_NATURAL, -3,
...

{
    ...
    M_WARM_BLOOD,
    MR_NO_FLAGS,
    1800, 8, MONS_GRIFFON, MONS_GRIFFON, MH_NATURAL, -3,
...

{
    ...
    MR_RES_POISON,
    1000, 9, MONS_HARPY, MONS_HARPY, MH_NATURAL, -3,
...

{
    ...
    M_WARM_BLOOD | M_SPELLCASTER,
    MR_RES_COLD,
    2500, 12, MONS_BEAR, MONS_POLAR_BEAR, MH_NATURAL, -3,
...

{
    ...
    M_WARM_BLOOD | M_SPELLCASTER,
    MR_NO_FLAGS,
    1800, 9, MONS_BEAR, MONS_BLACK_BEAR, MH_NATURAL, -3,
...
// monsters moving through rock
{
    ...
    M_NO_FLAGS,
    MR_RES_POISON | MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC,
    450, 12, MONS_WORM, MONS_ROCK_WORM, MH_NATURAL, -3,
...

{
    ...
    MR_RES_POISON,
    1800, 11, MONS_HYDRA, MONS_LERNAEAN_HYDRA, MH_NATURAL, -3,
    { {AT_BITE, AF_PLAIN, 18}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 30, 0, 0, 150 },
...

{
    ...
    M_SPELLCASTER | M_SEE_INVIS | M_SPEAKS | ACTUAL_SPELLS | M_UNIQUE,
    MR_RES_POISON | mrd(MR_RES_FIRE, 2),
...
// Mara.
{
    ...
    M_SPELLCASTER | M_SEE_INVIS | M_SPEAKS | ACTUAL_SPELLS,
    MR_RES_POISON | mrd(MR_RES_FIRE, 2),

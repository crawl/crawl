...
{
    MONS_LOST_HOUND, 'h', BLUE, "lost hound",
    M_SENSE_INVIS | M_WARM_BLOOD | M_BLOOD_SCENT | M_SPELLCASTER,
    MR_NO_FLAGS,
    550, 19, MONS_HOUND, MONS_LOST_HOUND, MH_NATURAL, -6,
    { {AT_BITE, AF_ELEC, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 4, 5, 0 },
    4, 15, MST_LOST_HOUND, CE_CONTAMINATED, Z_SMALL, S_BARK,
    I_ANIMAL, HT_LAND, FL_NONE, 17, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_MEDIUM
},
...

{
    ...
    M_SEE_INVIS | M_BATTY | M_SPELLCASTER | M_FAKE_SPELLS,
    MR_RES_POISON | MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC,
...
{
    MONS_TILLING_WORM, 'w', BLUE, "tilling worm",
    M_NO_SKELETON | M_BURROWS,
    MR_RES_POISON | MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC,
    850, 13, MONS_TILLING_WORM, MONS_TILLING_WORM, MH_NATURAL, -3,
    { {AT_BITE, AF_PLAIN, 26}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 5, 5, 0 },
    3, 12, MST_NO_SPELLS, CE_CONTAMINATED, Z_BIG, S_SILENT,
    I_PLANT, HT_INCORPOREAL, FL_NONE, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},
...
// "U"rsidae (Bears).
{
    ...
    { {AT_BITE, AF_KLOWN, 30}, {AT_CLAW, AF_KLOWN, 15}, {AT_CLAW, AF_KLOWN, 15},
       AT_NO_ATK },
    { 14, 4, 4, 0 },
    13, 8, MST_WARWICK, CE_CLEAN, Z_BIG, S_GROWL,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_BIG
},

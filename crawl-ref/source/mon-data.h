...

{
    ...
    M_NO_SKELETON | M_WEB_SENSE,
    MR_VUL_POISON,
    900, 3, MONS_SPIDER, MONS_WOLF_SPIDER, MH_NATURAL, -2,
...

{
    ...
    0, 21, MONS_MUMMY, MONS_BOG_BODY, MH_UNDEAD, -5,
...
// mimics
// TODO: give {AT_CONSTRICT, AF_CRUSH, 0} to inept and normal mimics
{
...

{
    ...
    { {AT_HIT, AF_PLAIN, 12}, {AT_HIT, AF_POISON, 12}, AT_NO_ATK, AT_NO_ATK },
    { 8, 3, 5, 0 },
    5, 1, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_TINY
...

{
    ...
    { {AT_HIT, AF_PLAIN, 16}, {AT_HIT, AF_POISON, 16},
      {AT_CONSTRICT, AF_CRUSH, 8}, AT_NO_ATK },
    { 12, 3, 5, 0 },
    5, 1, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_TINY
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, {AT_HIT, AF_POISON, 20},
      {AT_CONSTRICT, AF_CRUSH, 10}, AT_NO_ATK },
    { 16, 3, 5, 0 },
    5, 1, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_TINY

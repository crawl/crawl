...
{
    MONS_VAUD, 'n', YELLOW, "Vaud",
    M_UNIQUE | M_SPEAKS | M_SEE_INVIS | M_MALE | M_NO_ZOMBIE,
    MR_RES_COLD,
    22, MONS_GHOUL, MONS_VAUD, MH_UNDEAD, 50,
    { {AT_HIT, AF_PLAIN, 16}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 430,
    2, 8, MST_NO_SPELLS, false, S_SHOUT,
    I_HUMAN, HT_LAND, 8, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_VAUD}, TILE_CORPSE_GHOUL
},

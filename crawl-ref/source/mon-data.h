...
// Demonic tentacle things.
{
    ...
    0, 10, MONS_DEMONIC_TENTACLE, MONS_DEMONIC_TENTACLE, MH_NONLIVING, MAG_IMMUNE,
    { {AT_TENTACLE_SLAP, AF_PLAIN, 30}, {AT_CLAW, AF_PLAIN, 40}, AT_NO_ATK, AT_NO_ATK },
    { 16, 5, 5, 0 },
...
{
    MONS_DEMONIC_TENTACLE_SEGMENT, '*', BLACK, "demonic tentacle segment",
    M_NO_EXP_GAIN | M_STATIONARY | M_NO_POLY_TO | M_SEE_INVIS,
    mrd(MR_RES_FIRE | MR_RES_HELLFIRE | MR_RES_POISON | MR_RES_COLD, 3)
        | MR_RES_ELEC | MR_RES_STICKY_FLAME | MR_RES_ACID,
    0, 10, MONS_DEMONIC_TENTACLE, MONS_DEMONIC_TENTACLE_SEGMENT, MH_NONLIVING, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 16, 5, 5, 0 },
    13, 0, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_ANIMAL, HT_AMPHIBIOUS, FL_NONE, 12, DEFAULT_ENERGY,

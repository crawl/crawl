...
{
    MONS_NAGA_ENCHANTER, 'N', BROWN, "naga enchanter",
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS,
    MR_RES_POISON,
    1000, 14, MONS_NAGA, MONS_NAGA, MH_NATURAL, -6,
    { {AT_HIT, AF_PLAIN, 17}, {AT_CONSTRICT, AF_CRUSH, 4},
       AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
    6, 10, MST_NAGA_ENCHANTER, CE_POISONOUS, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 8, ACTION_ENERGY(8),
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_LARGE
},

{
    MONS_MARKSNAGA, 'N', LIGHTGRAY, "marksnaga",
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_SEE_INVIS | M_WARM_BLOOD
        | M_ARCHER | M_SPEAKS,
    MR_RES_POISON,
    1000, 14, MONS_NAGA, MONS_NAGA, MH_NATURAL, -6,
    ...
    { 8, 6, 3, 0 },
    6, 10, MST_MARKSNAGA, CE_POISONOUS, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 8, ACTION_ENERGY(8),
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_LARGE
},
...

{
    ...
    { 8, 3, 5, 0 },
    2, 15, MST_SHOCK_SERPENT, CE_POISONOUS, Z_SMALL, S_HISS,
    I_REPTILE, HT_LAND, FL_NONE, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    MONS_SAPPER_SNAKE, 'S', MAGENTA, "sapper snake",
    M_COLD_BLOOD | M_SENSE_INVIS,
    MR_RES_POISON,
    450, 10, MONS_SNAKE, MONS_SAPPER_SNAKE, MH_NATURAL, MAG_IMMUNE,
    { {AT_BITE, AF_ANTIMAGIC, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 3, 5, 0 },

...
// angelic beings ('A')
{
    ...
    M_FIGHTER | M_FLIES | M_SPELLCASTER | M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS,
...

{
    ...
    M_FIGHTER | M_LEVITATE | M_SPELLCASTER | M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS,
    MR_RES_POISON,
...

{
    ...
    M_FIGHTER | M_SPELLCASTER | M_WARM_BLOOD | M_SENSE_INVIS | M_EVIL | M_SPEAKS,
    mrd(MR_RES_FIRE, 2),
...

{
    ...
    M_WARM_BLOOD | M_SENSE_INVIS | M_EVIL | M_SPEAKS,
    MR_NO_FLAGS,
...

{
    ...
    M_WARM_BLOOD | M_EVIL | M_UNIQUE | M_SPEAKS,
    MR_NO_FLAGS,
    2500, 10, MONS_HILL_GIANT, MONS_CYCLOPS, MH_NATURAL, -3,

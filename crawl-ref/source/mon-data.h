...

{
    ...
    HT_LAND, -1, DEFAULT_ENERGY, MONUSE_NOTHING, SIZE_LARGE
},
...
// large abominations ('X')
{
    ...
    { 11, 2, 5, 0 },
    0, 0, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT, I_PLANT,
    HT_LAND, -1, DEFAULT_ENERGY, MONUSE_NOTHING, SIZE_BIG
},
...
// randomly created
{
    ...
    HT_LAND, -1, DEFAULT_ENERGY, MONUSE_OPEN_DOORS, SIZE_LARGE
},

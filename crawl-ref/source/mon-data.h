...
// It is also a good prototype for new monsters.
{
    ...
    I_PLANT, HT_LAND, 0, DEFAULT_ENERGY,
...
// ants and formicids ('a')
{
    ...
    I_INSECT, HT_LAND, 12, DEFAULT_ENERGY,
...

{
    ...
    I_INSECT, HT_LAND, 7, DEFAULT_ENERGY,
...

{
    ...
    I_INSECT, HT_LAND, 10, DEFAULT_ENERGY,
...
// dummy for recolouring
{
    ...
    I_NORMAL, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    I_INSECT, HT_LAND, 25, DEFAULT_ENERGY,
...

{
    ...
    I_NORMAL, HT_LAND, 16, DEFAULT_ENERGY,
...
// centaurs ('c')
{
    ...
    I_NORMAL, HT_LAND, 15, DEFAULT_ENERGY,
...

{
    ...
    I_HIGH, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_TAILED
},
...
{   // Base draconian - for use like MONS_HUMANMONS_ELF although we
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 6, 4, 0 },
    10, 11, MST_NO_SPELLS, CE_CLEAN, S_ROAR, I_HIGH, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    I_HIGH, HT_LAND, 15, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID
},

{
    ...
    { 15, 4, 2, 0 },
    0, 15, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HIGH, HT_LAND, 10, MISSILE_ENERGY(5),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID
},
...
// Mobile plants and fungi ('f')
{
    ...
    I_PLANT, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    I_NORMAL, HT_AMPHIBIOUS, 8, DEFAULT_ENERGY,
...

{
    ...
    I_NORMAL, HT_LAND, 12, DEFAULT_ENERGY,
...
{ // a dummy monster for recolouring
    ...
    I_HIGH, HT_LAND, 10, MOVE_ENERGY(8),
...
// spriggans ('i')
{
    ...
    I_HIGH, HT_LAND, 10, MOVE_ENERGY(6),
    MONUSE_WEAPONS_ARMOUR, SIZE_LITTLE, MON_SHAPE_HUMANOID
},
...

{
    ...
    I_NORMAL, HT_LAND, 10, MOVE_ENERGY(6),
    MONUSE_WEAPONS_ARMOUR, SIZE_LITTLE, MON_SHAPE_HUMANOID
},
...

{
    ...
    I_HIGH, HT_LAND, 16, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_LITTLE, MON_SHAPE_HUMANOID
},
...

{
    ...
    I_REPTILE, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_QUADRUPED
},
...

{
    ...
    I_REPTILE, HT_AMPHIBIOUS, 10, SWIM_ENERGY(6),
...

{
    ...
    { 1, 3, 5, 0 },
    1, 14, MST_NO_SPELLS, CE_CLEAN, S_SILENT,
    I_REPTILE, HT_LAND, 12, DEFAULT_ENERGY,
...
// merfolk ('m')
{
    ...
    I_NORMAL, HT_AMPHIBIOUS, 10, SWIM_ENERGY(6),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID
},

{
    ...
    I_NORMAL, HT_AMPHIBIOUS, 10, {10, 6, 6, 10, 10, 10, 10, 100},
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID
},
...

{
    ...
    I_NORMAL, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_HUMANOID
},
...
// rotting monsters ('n')
{
    ...
    I_NORMAL, HT_AMPHIBIOUS, 10, SWIM_ENERGY(14),
...

{
    ...
    I_HIGH, HT_LAND, 13, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID
},
...

{
    ...
    I_INSECT, HT_LAND, 15, DEFAULT_ENERGY,
...

{
    ...
    I_INSECT, HT_LAND, 13, DEFAULT_ENERGY,
...

{
    ...
    I_INSECT, HT_LAND, 12, SPELL_ENERGY(20),
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_ARACHNID
},
...

{
    ...
    I_REPTILE, HT_AMPHIBIOUS, 12, SWIM_ENERGY(6),
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_QUADRUPED
},

{
    ...
    I_REPTILE, HT_AMPHIBIOUS, 10, {10, 6, 8, 8, 8, 8, 8, 80},
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_QUADRUPED
},

{
    ...
    I_REPTILE, HT_AMPHIBIOUS, 8, {10, 6, 8, 8, 8, 8, 8, 80},
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_QUADRUPED_TAILLESS
},

{
    ...
    I_REPTILE, HT_AMPHIBIOUS, 8, SWIM_ENERGY(6),
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_QUADRUPED_TAILLESS
},
...

{
    ...
    I_INSECT, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_QUADRUPED
},
...
// vortices ('v')
{
    ...
    I_PLANT, HT_LAND, 15, DEFAULT_ENERGY,
...

{
    ...
    { 10, 6, 3, 0 },
    0, 5, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_PLANT, HT_LAND, 16, DEFAULT_ENERGY,
...

{
    ...
    I_INSECT, HT_WATER, 12, DEFAULT_ENERGY,
...

{
    ...
    I_INSECT, HT_AMPHIBIOUS, 8, SWIM_ENERGY(6),
...

{
    ...
    I_INSECT, HT_AMPHIBIOUS, 7, DEFAULT_ENERGY,
...
// dummy genus monster; not using DUMMY since it's also a dummy species
{
    ...
    I_INSECT, HT_LAND, 4, DEFAULT_ENERGY,
...

{
    ...
    I_PLANT, HT_LAND, 8, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_MISC
},

{
    ...
    { 1, 2, 2, 0 },
    1, 0, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_PLANT, HT_LAND, 5, DEFAULT_ENERGY,
...
// flying insects ('y')
{
    ...
    I_INSECT, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_INSECT_WINGED
},
...

{
    ...
    I_INSECT, HT_LAND, 19, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LITTLE, MON_SHAPE_INSECT_WINGED
},
...

{
    ...
    I_HIGH, HT_LAND, 10, MOVE_ENERGY(14),
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_MISC
},
...
// beetles ('B')
{
    ...
    { 5, 7, 6, 0 },
    10, 3, MST_NO_SPELLS, CE_CLEAN, S_SILENT,
    I_INSECT, HT_LAND, 5, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_INSECT
},
...

{
    ...
    I_INSECT, HT_LAND, 30, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LITTLE, MON_SHAPE_INSECT
},
...

{
    ...
    I_NORMAL, HT_LAND, 7, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, SIZE_GIANT, MON_SHAPE_HUMANOID
},
...

{
    ...
    I_PLANT, HT_LAND, 6, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_BIG, MON_SHAPE_MISC
},

{
    ...
    I_PLANT, HT_LAND, 13, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_BIG, MON_SHAPE_MISC
},

{
    ...
    I_PLANT, HT_AMPHIBIOUS, 10, SWIM_ENERGY(6),
    MONUSE_NOTHING, SIZE_BIG, MON_SHAPE_MISC
},

{
    ...
    I_PLANT, HT_LAND, 25, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_BIG, MON_SHAPE_MISC
},
...

{
    ...
    I_PLANT, HT_WATER, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_BIG, MON_SHAPE_MISC
},
...
// frogs ('F')
{
    ...
    I_REPTILE, HT_AMPHIBIOUS, 15, SWIM_ENERGY(6),
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_QUADRUPED_TAILLESS
},
...

{
    ...
    I_REPTILE, HT_AMPHIBIOUS, 14, SWIM_ENERGY(6),
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_QUADRUPED_TAILLESS
},
...
// eyes ('G')
{
    ...
    I_PLANT, HT_LAND, 3, DEFAULT_ENERGY,
...

{
    ...
    I_PLANT, HT_LAND, 7, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_ORB
},
...

{
    ...
    I_HIGH, HT_LAND, 11, DEFAULT_ENERGY,
...

{
    ...
    I_NORMAL, HT_LAND, 25, DEFAULT_ENERGY,
...

{
    ...
    I_PLANT, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
...

{
    ...
    { 15, 3, 5, 0 },
    5, 10, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_PLANT, HT_LAND, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_BLOB
},
...
// mummies ('M')
{
    ...
    I_NORMAL, HT_LAND, 6, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID
},

{
    ...
    I_NORMAL, HT_LAND, 8, DEFAULT_ENERGY,
...

{
    ...
    I_HIGH, HT_LAND, 8, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID
},
...
// nagas ('N')
{
    ...
    I_NORMAL, HT_LAND, 10, MOVE_ENERGY(14),
...

{
    ...
    { 10, 1, 1, 0 },
    10, 0, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_PLANT, HT_AMPHIBIOUS, 0, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_PLANT
},
...
// tengu ('Q')
{
    ...
    I_NORMAL, HT_LAND, 10, MOVE_ENERGY(9),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID
},
...

{
    ...
    { 17, 3, 4, 0 },
    2, 17, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HIGH, HT_LAND, 10, MOVE_ENERGY(9),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID
},
...

{
    ...
    I_REPTILE, HT_AMPHIBIOUS, 13, SWIM_ENERGY(6),
...

{
    ...
    I_REPTILE, HT_LAND, 18, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_SNAKE
},

{
    ...
    { 10, 4, 5, 0 },
    2, 15, MST_NO_SPELLS, CE_NOXIOUS, S_HISS,
    I_REPTILE, HT_AMPHIBIOUS, 12, SWIM_ENERGY(4),
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_SNAKE
},

{
    ...
    I_REPTILE, HT_AMPHIBIOUS, 18, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_SNAKE
},
...

{
    ...
    I_REPTILE, HT_LAND, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_SNAKE
},

{
    ...
    I_REPTILE, HT_LAND, 14, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_SNAKE
},
...

{
    ...
    I_NORMAL, HT_LAND, 14, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_GIANT, MON_SHAPE_MISC
},
...
// water monsters
{
    ...
    I_REPTILE, HT_WATER, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_SNAKE
},
...
// lava monsters
{
    ...
    I_REPTILE, HT_LAVA, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_SNAKE
},

{
    ...
    I_HIGH, HT_AMPHIBIOUS_LAVA, 10, {14, 10, 10, 10, 10, 10, 10, 100},
...

{
    ...
    { 15, 4, 5, 0 },
    5, 15, MST_NO_SPELLS, CE_CLEAN, S_SILENT,
    I_HIGH, HT_AMPHIBIOUS_LAVA, 10, {8, 7, 10, 10, 10, 10, 10, 100},
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_NAGA
},

{
    ...
    I_HIGH, HT_AMPHIBIOUS_LAVA, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_NAGA
},
...
// spectral weapon, for skalds!
{
    ...
    { 5, 3, 0, 0},
    5, 10, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_PLANT, HT_LAND, 30, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_MISC
},
...

{
    ...
    I_NORMAL, HT_LAND, 13, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_SMALL, MON_SHAPE_HUMANOID
},
...

{
    ...
    I_NORMAL, HT_LAND, 40, MOVE_ENERGY(6), // speed is cut to 1/3 later
    MONUSE_OPEN_DOORS, SIZE_LITTLE, MON_SHAPE_HUMANOID
},
...

{
    ...
    I_HIGH, HT_LAND, 12, DEFAULT_ENERGY,
...

{
    ...
    I_HIGH, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID
},
...

{
    ...
    I_HIGH, HT_LAND, 6, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_HUMANOID
},
...

{
    ...
    I_HIGH, HT_LAND, 14, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_WINGED_TAILED
},
...
// explodey things / orb of fire ('*')
{
    ...
    I_PLANT, HT_LAND, 20, DEFAULT_ENERGY,
...

{
    ...
    I_NORMAL, HT_LAND, 10, MOVE_ENERGY(8),
    MONUSE_NOTHING, SIZE_LITTLE, MON_SHAPE_ORB
},
...

{
    ...
    I_HIGH, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_GIANT, MON_SHAPE_HUMANOID
},
...
// "F"rogs.
{
    ...
    I_NORMAL, HT_AMPHIBIOUS, 14, SWIM_ENERGY(6),
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_QUADRUPED_TAILLESS
},
...
// Spr"i"ggans.
{
    ...
    I_HIGH, HT_LAND, 18, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_LITTLE, MON_SHAPE_HUMANOID
},
...
// "J"ellies.
{
    ...
    I_PLANT, HT_LAND, 14, DEFAULT_ENERGY,
...
// Snails and other gastropods.
{
    ...
    I_NORMAL, HT_AMPHIBIOUS, 5, DEFAULT_ENERGY,
...
// "m"erfolk.
{
    ...
    I_HIGH, HT_AMPHIBIOUS, 10, SWIM_ENERGY(6),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID
},
...
// over and over.
{
    ...
    I_PLANT, HT_AMPHIBIOUS, 14, SWIM_ENERGY(6),
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_MISC
},

...
{
    MONS_CAUSTIC_WASP, 'y', LIGHTCYAN, "caustic wasp",
    M_NO_SKELETON,
    MR_RES_COLD | MR_RES_FIRE,
    150, 15, MONS_CAUSTIC_WASP, MONS_CAUSTIC_WASP, MH_NATURAL, 100,
    { {AT_STING, AF_ACID, 34}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 14, 3, 5, 0 },
    10, 18, MST_NO_SPELLS, CE_CLEAN, Z_SMALL, S_BUZZ,
    I_INSECT, HT_LAND, FL_WINGED, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_TINY, MON_SHAPE_INSECT_WINGED
},

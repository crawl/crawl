...
// Hepliaklqana's ancestor - variable traits
{
    ...
    M_ANCESTOR | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_FLIES | M_FAST_REGEN | M_INSUBSTANTIAL,
    MR_NO_FLAGS,
    1, MONS_ANCESTOR, MONS_ANCESTOR, MH_UNDEAD, -5,
    { {AT_HIT, AF_PLAIN, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 1,
...
{
    MONS_ANCESTOR_KNIGHT, 'W', YELLOW, "knight",
    M_ANCESTOR | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_FLIES | M_FAST_REGEN | M_INSUBSTANTIAL,
    MR_NO_FLAGS,
    1, MONS_ANCESTOR, MONS_ANCESTOR_KNIGHT, MH_UNDEAD, -5,
    { {AT_HIT, AF_PLAIN, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 1,
    5, 10, MST_NO_SPELLS, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...
{
    MONS_ANCESTOR_BATTLEMAGE, 'W', YELLOW, "battlemage",
    M_ANCESTOR | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_FLIES | M_FAST_REGEN | M_INSUBSTANTIAL,
    MR_NO_FLAGS,
    1, MONS_ANCESTOR, MONS_ANCESTOR_BATTLEMAGE, MH_UNDEAD, -5,
    { {AT_HIT, AF_PLAIN, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 1,
    5, 10, MST_NO_SPELLS, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...
{
    MONS_ANCESTOR_HEXER, 'W', YELLOW, "hexer",
    M_ANCESTOR | M_NO_POLY_TO | M_NO_GEN_DERIVED | M_FLIES | M_FAST_REGEN | M_INSUBSTANTIAL,
    MR_NO_FLAGS,
    1, MONS_ANCESTOR, MONS_ANCESTOR_HEXER, MH_UNDEAD, -5,
    { {AT_HIT, AF_PLAIN, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 1,
    5, 10, MST_NO_SPELLS, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,

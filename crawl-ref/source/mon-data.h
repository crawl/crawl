...

{
    ...
    M_SENSE_INVIS | M_BLOOD_SCENT | M_FAKE_SPELLS,
    mrd(MR_RES_ELEC, 3),
...

{
    ...
    M_WARM_BLOOD | M_FAKE_SPELLS | M_DEFLECT_MISSILES,
    MR_NO_FLAGS,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_FAKE_SPELLS,
    MR_NO_FLAGS,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_FAKE_SPELLS | M_NO_GEN_DERIVED,
    MR_NO_FLAGS,
...

{
    ...
    M_NO_SKELETON | M_FAKE_SPELLS | M_WEB_SENSE | M_SENSE_INVIS,
    MR_VUL_POISON,
...

{
    ...
    M_NO_SKELETON | M_FAKE_SPELLS | M_WEB_SENSE
        | M_MAINTAIN_RANGE,
    MR_VUL_POISON,
...

{
    ...
    M_COLD_BLOOD | M_SUBMERGES | M_FAKE_SPELLS,
    MR_NO_FLAGS,
...

{
    ...
    M_SEE_INVIS | M_SPEAKS | M_NOISY_SPELLS,
...

{
    ...
    { 12, 5, 5, 0 },
    10, 8, MST_FIRE_BREATH, CE_CLEAN, Z_BIG, S_SILENT,
    I_ANIMAL, HT_LAND, FL_WINGED, 10, DEFAULT_ENERGY,
...

{
    ...
    M_WARM_BLOOD | M_FAKE_SPELLS | M_NOISY_SPELLS,
    MR_RES_STEAM,
...

{
    ...
    M_SEE_INVIS | M_WARM_BLOOD | M_FAKE_SPELLS | M_NOISY_SPELLS,
    MR_NO_FLAGS,
...

{
    ...
    M_SEE_INVIS | M_WARM_BLOOD | M_FAKE_SPELLS
...

{
    ...
    M_SEE_INVIS | M_WARM_BLOOD | M_GLOWS_LIGHT | M_NOISY_SPELLS,
    MR_NO_FLAGS,
...
// nagas ('N')
{
    ...
    M_FAKE_SPELLS | M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS,
    MR_RES_POISON,
...

{
    ...
    M_FIGHTER | M_FAKE_SPELLS | M_SEE_INVIS | M_WARM_BLOOD
        | M_SPEAKS,
    MR_RES_POISON,
...

{
    ...
    M_BATTY | M_FAKE_SPELLS | M_NO_POLY_TO,
    MR_RES_POISON | MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC,
...
// A kraken and its tentacles get a random colour from ETC_KRAKEN.
{
    ...
    M_NO_SKELETON | M_COLD_BLOOD | M_FAKE_SPELLS | M_FLEES,
    MR_NO_FLAGS,
...

{
    ...
    M_NO_FLAGS,
    MR_RES_POISON | mrd(MR_RES_ELEC, 2) | MR_RES_HELLFIRE | MR_RES_COLD,
    0, 10, MONS_IRON_DEVIL, MONS_IRON_DEVIL, MH_DEMONIC, 60,
...

{
    ...
    M_ARTIFICIAL | M_FAKE_SPELLS | M_STATIONARY | M_SPEAKS,
...

{
    ...
    M_ARTIFICIAL | M_SEE_INVIS | M_FAKE_SPELLS | M_FIGHTER,
...
// "D"ragons and hydras.
{
    ...
    { {AT_BITE, AF_PLAIN, 35}, {AT_CLAW, AF_PLAIN, 17},
      {AT_TRAMPLE, AF_PLAIN, 20}, AT_NO_ATK },
    { 19, 0, 0, 133 },
    15, 7, MST_FIRE_BREATH, CE_CLEAN, Z_NOZOMBIE, S_ROAR,
    I_NORMAL, HT_LAND, FL_WINGED, 10, DEFAULT_ENERGY,
...

{
    ...
    M_SEE_INVIS | M_UNIQUE | M_FAKE_SPELLS | M_NOISY_SPELLS,
...
// Skulls and "z" undead.
{
    ...
    M_UNIQUE | M_SEE_INVIS | M_NOISY_SPELLS | M_SPEAKS,
...

{
    ...
    M_UNIQUE | M_FIGHTER | M_SEE_INVIS | M_SPEAKS | M_FAKE_SPELLS,
    MR_NO_FLAGS,

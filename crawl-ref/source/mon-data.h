...
{
    MONS_ORB_OF_ICE, '*', LIGHTBLUE, "orb of ice",
    M_SEE_INVIS | M_INSUBSTANTIAL | M_FLIES,
    mrd(MR_RES_COLD | MR_RES_ELEC, 3) | MR_RES_FIRE,
    13, MONS_ORB_OF_ICE, MONS_ORB_OF_ICE, MH_NONLIVING, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    30, 1500,
    20, 20, MST_ORB_OF_ICE, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LITTLE, MON_SHAPE_ORB,
    {TILEP_MONS_ORB_OF_ICE}, TILE_ERROR
},

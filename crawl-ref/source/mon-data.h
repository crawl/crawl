...
// spectral weapon, for skalds!
{
    ...
    M_INSUBSTANTIAL | M_NO_REGEN | M_AVATAR | M_NOT_DANGEROUS | M_FLIES
        | M_GHOST_DEMON,
    MR_RES_FIRE | MR_RES_COLD |  MR_RES_ELEC,
...

{
    ...
    M_ARTIFICIAL | M_NO_POLY_TO | M_FLIES | M_NOT_DANGEROUS,
    mrd(MR_RES_FIRE | MR_RES_COLD, 2) | MR_RES_ELEC,
...

{
    ...
    M_INSUBSTANTIAL | M_MAINTAIN_RANGE | M_SUBMERGES | M_FLIES | M_NOT_DANGEROUS,
...
{ // not an actual monster, used by a spell
    ...
    M_GLOWS | M_NO_POLY_TO | M_STATIONARY | M_CONJURED | M_NOT_DANGEROUS
        | M_FLIES,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC,
...

{
    ...
    M_SEE_INVIS | M_INSUBSTANTIAL | M_GLOWS | M_NOT_DANGEROUS | M_NO_POLY_TO

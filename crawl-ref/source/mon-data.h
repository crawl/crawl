...
// Axed monsters.
    ...
    AXED_MON(MONS_TERPSICHORE)
    AXED_MON(MONS_SUBTRACTOR_SNAKE)
#endif
...

{
    ...
    { {AT_BITE, AF_CONFUSE, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 3, 5, 0 },
...

{
    ...
    MR_VUL_POISON,
    300, 7, MONS_SPIDER, MONS_JUMPING_SPIDER, MH_NATURAL, -3,
...

{
    ...
    M_NO_SKELETON | M_WEB_SENSE,
    MR_VUL_POISON,
    900, 6, MONS_SPIDER, MONS_WOLF_SPIDER, MH_NATURAL, -3,
    { {AT_BITE, AF_POISON_MEDIUM, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 4, 5, 0 },
...

{
    ...
    MR_VUL_POISON,
    240, 6, MONS_SPIDER, MONS_TRAPDOOR_SPIDER, MH_NATURAL, -3,
    { {AT_BITE, AF_POISON_MEDIUM, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 3, 5, 0 },
...

{
    ...
    M_NO_SKELETON | M_WEB_SENSE,
    MR_VUL_POISON,
    130, 5, MONS_SPIDER, MONS_REDBACK, MH_NATURAL, -3,
...

{
    ...
    900, 7, MONS_DEMONIC_CRAWLER, MONS_DEMONIC_CRAWLER, MH_DEMONIC, -6,

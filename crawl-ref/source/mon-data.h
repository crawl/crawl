...
{
    MONS_CYNO, 'H', YELLOW, "cyno",
    M_WARM_BLOOD | M_HYBRID | M_NO_POLY_TO | M_CANT_SPAWN,
    MR_NO_FLAGS,
    10, MONS_CYNO, MONS_CYNO, MH_NATURAL, 20,
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 400,
    3, 15, MST_NO_SPELLS, CE_CLEAN, S_BARK,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
	{TILEP_MONS_CYNO}, TILE_CORPSE_CYNO
},

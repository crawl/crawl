...
{
    MONS_RHINOCEROS_COCKROACH, 's', BROWN, "rhinoceros cockroach",
    M_NO_SKELETON,
    MR_VUL_POISON,
    10, MONS_RHINOCEROS_COCKROACH, MONS_RHINOCEROS_COCKROACH, MH_NATURAL, 0,
    ...
    {TILEP_MONS_RHINOCEROS_COCKROACH}, TILE_CORPSE_RHINOCEROS_COCKROACH
},
...
{
    MONS_NAGA_EXEMPLAR, 'N', LIGHTMAGENTA, "naga exemplar",
    M_FIGHTER | M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS,
    MR_RES_POISON,
    ...
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(14),
    MONUSE_WEAPONS_ARMOUR, SIZE_LARGE, MON_SHAPE_NAGA,
    {TILEP_MONS_NAGA_EXEMPLAR}, TILE_ERROR
},

...

{
    ...
    { {AT_BITE, AF_PLAIN, 45}, {AT_ENGULF, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK },
    { 15, 3, 5, 0 },
...

{
    ...
    { {AT_CONSTRICT, AF_CRUSH, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 12, 0, 2, 0 },
    5, 5, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, true, 17, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},

{
    MONS_STARSPAWN_TENTACLE_SEGMENT, '*', CYAN, "starspawn tentacle segment",
    M_NO_EXP_GAIN | M_STATIONARY | M_SUBMERGES | M_NO_POLY_TO,
    MR_NO_FLAGS,
    0, 10, MONS_TENTACLED_STARSPAWN, MONS_STARSPAWN_TENTACLE_SEGMENT, MH_DEMONIC, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 12, 0, 2, 0 },
    5, 5, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, true, 18, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},

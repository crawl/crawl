...
{
    MONS_AISHA, 'R', LIGHTBLUE, "Aisha",
    M_UNIQUE | M_SPEAKS | M_FEMALE | M_FLIES,
    mrd(MR_RES_FIRE, 2) | MR_VUL_COLD,
    10, MONS_DJINNI, MONS_DJINNI, MH_NONLIVING, 100,
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    27, 2600,
    10, 15, MST_AISHA, false, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_AISHA}, TILE_ERROR
},

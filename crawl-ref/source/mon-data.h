...

{
    ...
    M_SPEAKS,
    MR_RES_POISON | MR_RES_FIRE,
    10, MONS_CUBUS, MONS_CUBUS, MH_DEMONIC, 60,
    { {AT_HIT, AF_VAMPIRIC, 8}, {AT_HIT, AF_ANTIMAGIC, 8}, AT_NO_ATK, AT_NO_ATK },
    7, 385,
    12, 12, MST_CUBUS, CE_NOCORPSE, S_ROAR,
    I_HUMAN, HT_LAND, 13, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_CUBUS}, TILE_ERROR
},

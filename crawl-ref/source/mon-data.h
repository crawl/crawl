...

{
    ...
    { 12, 5, 5, 0 },
    10, 8, MST_COLD_BREATH, CE_CLEAN, Z_BIG, S_SILENT,
    I_ANIMAL, HT_LAND, FL_WINGED, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_GIANT, MON_SHAPE_QUADRUPED_WINGED
},
...

{
    ...
    M_SEE_INVIS | M_WARM_BLOOD | M_NOISY_SPELLS,
    MR_NO_FLAGS,
...

{
    ...
    M_SEE_INVIS | M_WARM_BLOOD | M_UNBREATHING | M_NOISY_SPELLS,
...

{
    ...
    M_SHADOW | M_SEE_INVIS | M_COLD_BLOOD | M_NOISY_SPELLS,
...

{
    ...
    M_SEE_INVIS | M_UNIQUE | M_NOISY_SPELLS,

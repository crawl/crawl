...
// note: these things regenerate
{
    ...
    M_SPEAKS,
    MR_RES_POISON | MR_RES_HELLFIRE | MR_VUL_COLD,
    0, 13, MONS_CRIMSON_IMP, MONS_IMP, MH_DEMONIC, -9,
    { {AT_HIT, AF_PLAIN, 4}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 3, 3, 0 },
...

{
    ...
    M_NO_FLAGS,
    MR_RES_POISON | MR_RES_FIRE | MR_RES_COLD,
    0, 13, MONS_QUASIT, MONS_IMP, MH_DEMONIC, 5,
...

{
    ...
    0, 10, MONS_WHITE_IMP, MONS_IMP, MH_DEMONIC, -3,
...

{
    ...
    M_NO_FLAGS,
    MR_RES_POISON,
    0, 10, MONS_LEMURE, MONS_IMP, MH_DEMONIC, -3,
...

{
    ...
    M_NO_FLAGS,
    MR_VUL_FIRE | MR_RES_COLD,
    0, 28, MONS_UFETUBUS, MONS_IMP, MH_DEMONIC, -3,
...

{
    ...
    0, 14, MONS_IRON_IMP, MONS_IMP, MH_DEMONIC, -3,
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 3, 5, 0 },
...

{
    ...
    0, 11, MONS_SHADOW_IMP, MONS_IMP, MH_DEMONIC, -3,
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 2, 3, 5, 0 },
...
// devils etc. ('4')
{
    ...
    M_NO_FLAGS,
    MR_RES_POISON | MR_VUL_FIRE | mrd(MR_RES_COLD, 3),
    0, 13, MONS_BLUE_DEVIL, MONS_DEVIL, MH_DEMONIC, -5,
    { {AT_HIT, AF_PLAIN, 21}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
...

{
    ...
    M_NO_FLAGS,
    MR_RES_POISON | mrd(MR_RES_ELEC, 2) | MR_RES_HELLFIRE | MR_RES_COLD,
    0, 10, MONS_IRON_DEVIL, MONS_DEVIL, MH_DEMONIC, -6,
...

{
    ...
    M_NO_FLAGS,
    MR_NO_FLAGS,
    0, 12, MONS_ORANGE_DEMON, MONS_DEMON, MH_DEMONIC, -6,
...

{
    ...
    M_FIGHTER,
    MR_RES_POISON | MR_RES_HELLFIRE | MR_VUL_COLD,
    0, 12, MONS_RED_DEVIL, MONS_DEVIL, MH_DEMONIC, -7,
...

{
    ...
    M_NO_FLAGS,
    MR_RES_POISON | MR_RES_COLD,
    0, 10, MONS_ROTTING_DEVIL, MONS_DEVIL, MH_DEMONIC, -7,
    { {AT_HIT, AF_ROT, 8}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 5, 0 },
...

{
    ...
    0, 6, MONS_SIXFIRHY, MONS_DEMON, MH_DEMONIC, -6,
...

{
    ...
    M_SPELLCASTER,
    MR_RES_POISON,
    0, 12, MONS_HELLWING, MONS_DEMON, MH_DEMONIC, -6,
...
// middle demons ('3')
{
    ...
    0, 14, MONS_SUN_DEMON, MONS_DEMON, MH_DEMONIC, -6,
...

{
    ...
    M_SPELLCASTER | M_SEE_INVIS,
    MR_RES_POISON | MR_RES_COLD,
    0, 12, MONS_SOUL_EATER, MONS_DEMON, MH_DEMONIC, -10,
...

{
    ...
    M_NO_FLAGS,
    MR_RES_POISON | MR_VUL_FIRE | mrd(MR_RES_COLD, 3),
    0, 11, MONS_ICE_DEVIL, MONS_DEVIL, MH_DEMONIC, -6,
...

{
    ...
    0, 12, MONS_SMOKE_DEMON, MONS_DEMON, MH_DEMONIC, -6,
...

{
    ...
    M_SPELLCASTER,
    MR_RES_POISON,
    0, 12, MONS_NEQOXEC, MONS_DEMON, MH_DEMONIC, -6,
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 3, 5, 0 },
...

{
    ...
    0, 12, MONS_YNOXINUL, MONS_DEMON, MH_DEMONIC, -6,
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 3, 5, 0 },
...

{
    ...
    M_SPELLCASTER | M_SEE_INVIS,
    MR_RES_POISON | mrd(MR_RES_COLD, 2),
    0, 12, MONS_SHADOW_DEMON, MONS_DEMON, MH_DEMONIC, -7,
    { {AT_HIT, AF_PLAIN, 21}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 3, 5, 0 },
...

{
    ...
    M_SPELLCASTER | M_SEE_INVIS,
    MR_RES_POISON,
    0, 13, MONS_GREEN_DEATH, MONS_DEMON, MH_DEMONIC, -9,
    { {AT_HIT, AF_PLAIN, 32}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 13, 3, 5, 0 },
...

{
    ...
    0, 13, MONS_BLIZZARD_DEMON, MONS_DEMON, MH_DEMONIC, -9,
...

{
    ...
    MR_RES_POISON | MR_RES_HELLFIRE | MR_VUL_COLD,
    0, 15, MONS_BALRUG, MONS_DEMON, MH_DEMONIC, -9,
...

{
    ...
    M_SPELLCASTER | M_SEE_INVIS,
    MR_RES_POISON | MR_RES_ELEC,
    0, 14, MONS_CACODEMON, MONS_DEMON, MH_DEMONIC, -9,
...

{
    ...
    MR_RES_POISON | MR_RES_HELLFIRE | MR_VUL_COLD,
    0, 12, MONS_HELLION, MONS_DEMON, MH_DEMONIC, -7,
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
...

{
    ...
    M_SPELLCASTER | M_SEE_INVIS | M_GLOWS_LIGHT,
    MR_RES_POISON | MR_VUL_FIRE | mrd(MR_RES_COLD, 3),
    0, 12, MONS_ICE_FIEND, MONS_FIEND, MH_DEMONIC, MAG_IMMUNE,
...

{
    ...
    0, 10, MONS_SHADOW_FIEND, MONS_FIEND, MH_DEMONIC, MAG_IMMUNE,

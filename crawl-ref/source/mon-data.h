...
{
    MONS_MLIOGLOTL, 'X', MAGENTA, "Mlioglotl",
    M_UNIQUE | M_SEE_INVIS | M_SPEAKS | M_MALE | M_TALL_TILE,
    MR_RES_ELEC | MR_RES_POISON | MR_RES_COLD,
    13, MONS_THRASHING_HORROR, MONS_MLIOGLOTL, MH_NONLIVING, 120,
    { {AT_HIT, AF_PLAIN, 15}, {AT_HIT, AF_CHAOTIC, 15},
       {AT_TRAMPLE, AF_TRAMPLE, 40}, AT_NO_ATK},
    18, 2400,
    20, 5, MST_MLIOGLOTL, false, S_SHOUT,
    I_HUMAN, HT_LAND, 14, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_GIANT, MON_SHAPE_MISC,

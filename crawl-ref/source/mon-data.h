...

{
    ...
    { {AT_STING, AF_MINIPARA, 27}, {AT_CONSTRICT, AF_CRUSH, 5},
        AT_NO_ATK, AT_NO_ATK },
    15, 800,
    0, 3, MST_BLINK_CLOSE, false, S_SILENT,
    I_BRAINLESS, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_BLOB /* close enough */,
...
{
    MONS_STONE_REMAINS, '8', BROWN, "pillar of stone",
    M_NOT_DANGEROUS | M_STATIONARY,
    MR_NO_FLAGS,
    10, MONS_STONE_REMAINS, MONS_STONE_REMAINS, MH_NONLIVING, WILL_INVULN,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 10,
    1, 0, MST_NO_SPELLS, false, S_SILENT,
    I_BRAINLESS, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, SIZE_MEDIUM, MON_SHAPE_MISC,
    {TILEP_MONS_PILLAR_OF_STONE}, TILE_ERROR
},

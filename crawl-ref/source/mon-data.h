...

{
    ...
    { 15, 4, 2, 0 },
    0, 15, MST_NO_SPELLS, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT, I_HIGH,
    HT_LAND, 10, MISSILE_ENERGY(6), MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM
},
...
// snakes ('S')
{
    ...
    HT_AMPHIBIOUS_LAND, 12, DEFAULT_ENERGY, MONUSE_NOTHING, SIZE_LITTLE
},
...

{
    ...
    M_FIGHTER | M_SPELLCASTER | M_ACTUAL_SPELLS | M_SEE_INVIS | M_EVIL
        | M_SPEAKS | M_BLOOD_SCENT,
    MR_RES_POISON | MR_RES_COLD,
...

{
    ...
    M_SPELLCASTER | M_ACTUAL_SPELLS | M_SEE_INVIS | M_FLIES | M_EVIL
        | M_SPEAKS | M_BLOOD_SCENT,
    MR_RES_POISON | MR_RES_COLD,

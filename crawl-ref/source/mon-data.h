...

{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 3, 4, 0 },
    0, 12, MST_BOGGART, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
...
// eyes ('G')
{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 3, 5, 0 },
    0, 1, MST_GIANT_EYEBALL, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
    3, 1, MST_DRAIN_GAZE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 3, 5, 0 },
    2, 4, MST_GIANT_ORANGE_BRAIN, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 12, 3, 5, 0 },
    10, 3, MST_GREAT_ORB_OF_EYES, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 3, 5, 0 },
    3, 1, MST_SHINING_EYE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 3, 5, 0 },
    12, 1, MST_EYE_OF_DEVASTATION, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_LEVITATE, 7, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_MEDIUM, MON_SHAPE_ORB
},
...

{
    ...
    { 9, 3, 5, 0 },
    3, 14, MST_NO_SPELLS, CE_NOCORPSE, Z_NOZOMBIE, S_HISS,
...
// lava monsters
{
    ...
    { 3, 3, 5, 0 },
    2, 17, MST_NO_SPELLS, CE_CLEAN, Z_SMALL, S_HISS,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 32}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 13, 3, 5, 0 },
    5, 7, MST_GREEN_DEATH, CE_NOCORPSE, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE, MON_SHAPE_HUMANOID
},
...

{
    ...
    { {AT_BITE, AF_FIRE, 35}, {AT_CLAW, AF_PLAIN, 15},
      {AT_TRAMPLE, AF_PLAIN, 15}, AT_NO_ATK },
    { 20, 0, 0, 280 },
    16, 12, MST_SERPENT_OF_HELL, CE_NOCORPSE, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_WINGED, 14, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_DOORS, SIZE_GIANT, MON_SHAPE_QUADRUPED_WINGED
},

{
    ...
    { {AT_BITE, AF_COLD, 35}, {AT_CLAW, AF_PLAIN, 15},
      {AT_TRAMPLE, AF_PLAIN, 15}, AT_NO_ATK },
    { 20, 0, 0, 280 },
    20, 12, MST_SERPENT_OF_HELL, CE_NOCORPSE, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_WINGED, 14, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_DOORS, SIZE_GIANT, MON_SHAPE_QUADRUPED_WINGED
},

{
    ...
    { 20, 0, 0, 400 },
    30, 12, MST_SERPENT_OF_HELL, CE_NOCORPSE, Z_NOZOMBIE, S_ROAR,

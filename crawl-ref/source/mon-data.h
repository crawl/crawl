...
{
    MONS_ICEGRIP_STALWART, 'p', BLUE, "icegrip stalwart",
    M_WARM_BLOOD | M_SPEAKS,
    MR_RES_COLD,
    12, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 40,
    { {AT_TOUCH, AF_COLD, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 600,
    0, 10, MST_ICEGRIP_STALWART, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_IRONBRAND_CONVOKER /*TODO*/}, TILE_ERROR
},
...
{
    MONS_IRONBOUND_THUNDERHULK, 'p', LIGHTCYAN, "ironbound thunderhulk",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 40,
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    ...
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_VAULT_GUARD /*TODO*/}, TILE_ERROR
},

{
    MONS_IRONWHIP_BEASTMASTER, 'p', BROWN, "ironwhip beastmaster",
    M_WARM_BLOOD | M_SPEAKS | M_REQUIRE_BAND,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 40,
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 550,
    0, 14, MST_IRONWHIP_BEASTMASTER, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_VAULT_GUARD /*TODO*/}, TILE_ERROR
},

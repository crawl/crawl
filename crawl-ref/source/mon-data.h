...
{
MONS_ENTROPY_WEAVER, 'a', LIGHTCYAN, "entropy weaver", "엔트로피 위버",
...
{
MONS_SATYR, 'c', LIGHTGREEN, "satyr", "사티르",
...
{
MONS_DEEP_ELF_BLADEMASTER, 'e', LIGHTCYAN, "deep elf blademaster", "딥 엘프 검주",
...
{
MONS_DEATHCAP, 'f', LIGHTMAGENTA, "deathcap", "광대버섯",
M_NO_FLAGS,
MR_RES_COLD,
...
{
MONS_SHAMBLING_MANGROVE, 'f', LIGHTRED, "shambling mangrove", "구불거리는 맹그로브",
M_NO_FLAGS,
MR_RES_POISON,
...
{
MONS_HOWLER_MONKEY, 'h', LIGHTGREEN, "howler monkey", "시끄러운 원숭이",
M_WARM_BLOOD,
MR_NO_FLAGS,
...
{
MONS_HELL_HOG, 'h', LIGHTRED, "hell hog", "지옥 돼지",
M_NO_FLAGS,
mrd(MR_RES_FIRE, 2),
...
{
MONS_LEOPARD_GECKO, 'l', YELLOW, "leopard gecko", "얼룩 도마뱀붙이",
M_COLD_BLOOD,
MR_NO_FLAGS,
...
{
MONS_NECROPHAGE, 'n', LIGHTGREY, "necrophage", "시체포식자",
M_NO_ZOMBIE,
MR_RES_COLD,
...
{
MONS_ORC_WARLORD, 'o', LIGHTCYAN, "orc warlord", "오크 사령관",
M_FIGHTER | M_WARM_BLOOD | M_SPEAKS,
MR_NO_FLAGS,
...
{
MONS_VAULT_WARDEN, 'p', LIGHTRED, "vault warden", "보물창고 감시병",
M_FIGHTER | M_WARM_BLOOD | M_SEE_INVIS | M_SPEAKS,
MR_NO_FLAGS,
...
{
MONS_IRONBRAND_CONVOKER, 'p', YELLOW, "ironbrand convoker", "강철인장 징집자",
M_WARM_BLOOD | M_SPEAKS,
MR_NO_FLAGS,
...
{
MONS_RIVER_RAT, 'r', LIGHTGREEN, "river rat", "뉴트리아",
M_WARM_BLOOD,
MR_NO_FLAGS,
...
{
MONS_REDBACK, 's', LIGHTRED, "redback", "붉은등과부거미",
M_NO_SKELETON | M_WEB_SENSE,
MR_VUL_POISON,
...
{
MONS_DEMONIC_CRAWLER, 's', LIGHTGREEN, "demonic crawler", "악마 벌레",
...
{
MONS_ANCIENT_CHAMPION, 'z', LIGHTCYAN, "ancient champion", "고대의 챔피언",
M_FIGHTER,
MR_RES_COLD,
...
{
MONS_CHERUB, 'A', LIGHTBLUE, "cherub", "쳬룹",
...
// eyes ('G')
{
MONS_FLOATING_EYE, 'G', WHITE, "floating eye", "부유하는 눈알",
M_SEE_INVIS | M_FLIES,
MR_NO_FLAGS,
...
{
MONS_GLOWING_ORANGE_BRAIN, 'G', LIGHTRED, "glowing orange brain", "빛나는 오랜지색 뇌",
...
{
MONS_GREAT_ORB_OF_EYES, 'G', LIGHTGREEN, "great orb of eyes", "거대한 눈알 구체",
M_SEE_INVIS | M_FLIES,
MR_RES_POISON,
...
{
MONS_EYE_OF_DEVASTATION, 'G', YELLOW, "eye of devastation", "파괴의 눈알",
M_SEE_INVIS | M_FLIES,
MR_NO_FLAGS,
...
{
MONS_MANTICORE, 'H', RED, "manticore", "만티코어",
M_WARM_BLOOD | M_HYBRID | M_FLIES,
MR_NO_FLAGS,
...
{
MONS_SLIME_CREATURE, 'J', GREEN, "slime creature", "슬라임 괴물",
M_FAST_REGEN | M_HERD,
MR_RES_POISON,
...
{
MONS_AZURE_JELLY, 'J', LIGHTBLUE, "azure jelly", "푸른색 젤리",
...
{
MONS_TOADSTOOL, 'P', COLOUR_UNDEF, "toadstool", "시체 버섯",
...
{
MONS_FUNGUS, 'P', LIGHTGREY, "fungus", "버섯",
M_NOT_DANGEROUS | M_STATIONARY,
MR_RES_POISON,
...
{
MONS_SNAPLASHER_VINE, 'w', LIGHTGREEN, "snaplasher vine", "낚아채는 덩굴",
M_NO_EXP_GAIN | M_STATIONARY | M_NO_POLY_TO,
MR_RES_POISON,
...
{
MONS_SNAPLASHER_VINE_SEGMENT, '*', LIGHTGREEN, "snaplasher vine segment", "낚아채는 덩굴의 일부",
...
{
MONS_ADDER, 'S', LIGHTGREEN, "adder", "살모사",
M_COLD_BLOOD,
MR_NO_FLAGS,
...
{
MONS_GUARDIAN_SERPENT, 'S', WHITE, "guardian serpent", "수호자 이무기",
M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS,
MR_RES_POISON,
...
{
MONS_SHOCK_SERPENT, 'S', LIGHTBLUE, "shock serpent", "방전 이무기",
M_COLD_BLOOD,
mrd(MR_RES_ELEC, 3),
...
{
MONS_DEEP_TROLL, 'T', YELLOW, "deep troll", "심연 트롤",
...
{
MONS_DEEP_TROLL_EARTH_MAGE, 'T', MAGENTA, "deep troll earth mage", "심연 트롤 대지술사",
...
{
MONS_DEEP_TROLL_SHAMAN, 'T', WHITE, "deep troll shaman", "심연 트롤 주술사",
M_WARM_BLOOD | M_SEE_INVIS | M_UNBLINDABLE | M_SPEAKS,
MR_NO_FLAGS,
...
{
MONS_SILENT_SPECTRE, 'W', CYAN, "silent spectre", "정적의 유령",
...
{
MONS_DROWNED_SOUL, 'W', LIGHTCYAN, "drowned soul", "익사자 영혼",
M_SEE_INVIS | M_INSUBSTANTIAL | M_SPEAKS | M_FLIES,
mrd(MR_RES_COLD, 3),
...
{
MONS_FREEZING_WRAITH, 'W', LIGHTBLUE, "freezing wraith", "얼어붙는 유령",
M_SEE_INVIS | M_INSUBSTANTIAL | M_FLIES,
...
{
MONS_EIDOLON, 'W', BROWN, "eidolon", "생령",
M_SEE_INVIS | M_INSUBSTANTIAL | M_FLIES,
MR_RES_COLD,
...
{
MONS_PHANTASMAL_WARRIOR, 'W', LIGHTGREEN, "phantasmal warrior", "영체 전사",
...
{
MONS_THRASHING_HORROR, 'X', YELLOW, "thrashing horror", "쇄도하는 공포",
...
{
MONS_DREAM_SHEEP, 'Y', CYAN, "dream sheep", "꿈꾸는 양",
M_WARM_BLOOD | M_HERD,
MR_NO_FLAGS,
...
{
MONS_HELLEPHANT, 'Y', LIGHTRED, "hellephant", "지옥끼리",
M_WARM_BLOOD,
MR_NO_FLAGS,
...
{
MONS_ICE_BEAST, 'Y', LIGHTBLUE, "ice beast", "얼음짐승",
M_NO_FLAGS,
...
{
MONS_SKY_BEAST, 'Y', LIGHTCYAN, "sky beast", "하늘짐승",
M_NO_SKELETON | M_FLIES,
mrd(MR_RES_ELEC, 3),
...
{
MONS_SPECTRAL_THING, 'Z', GREEN, "spectral thing", "심령체",
M_SEE_INVIS | M_INSUBSTANTIAL | M_FLIES,
MR_RES_COLD,
...
// devils etc. ('4')
{
MONS_RUST_DEVIL, '4', BROWN, "rust devil", "녹슨 악마",
M_NO_FLAGS,
MR_RES_POISON | MR_RES_ELEC | mrd(MR_RES_FIRE, 3) | MR_RES_COLD,
...
{
MONS_HELL_SENTINEL, '1', BROWN, "Hell Sentinel", "지옥의 파수꾼",
M_SEE_INVIS | M_SPINY,
MR_RES_DAMNATION
...
{
MONS_SALTLING, '8', WHITE, "saltling", "소글링",
M_NO_FLAGS,
MR_NO_FLAGS,
...
{
MONS_ICE_STATUE, '8', LIGHTBLUE, "ice statue", "얼음 동상",
...
{
MONS_OBSIDIAN_STATUE, '8', MAGENTA, "obsidian statue", "흑요석 석상",
...
{
MONS_ORANGE_STATUE, '8', LIGHTRED, "orange crystal statue", "주황색 수정 석상",
M_STATIONARY | M_SPEAKS | M_SEE_INVIS,
...
{ // always redefined
MONS_STATUE, '8', LIGHTGREY, "statue", "석상",
...
{ // not an actual monster, used by a spell
MONS_FULMINANT_PRISM, '*', ETC_MAGIC, "fulminant prism", "전격성 프리즘",
...
{
MONS_WRETCHED_STAR, '*', MAGENTA, "wretched star", "불쾌한 별",
M_SEE_INVIS | M_INSUBSTANTIAL | M_FLIES,
MR_RES_ELEC | MR_RES_FIRE | MR_RES_COLD,
...
{
MONS_SERPENT_OF_HELL, 'D', ETC_FIRE, "the Serpent of Hell", "게헨나의 타오르는 고룡",
...
{
MONS_SERPENT_OF_HELL_COCYTUS, 'D', ETC_ICE, "the Serpent of Hell", "코퀴투스의 얼어붙은 고룡",
M_SEE_INVIS | M_UNIQUE | M_CRASH_DOORS | M_FLIES | M_TALL_TILE,
...
{
MONS_SERPENT_OF_HELL_DIS, 'D', ETC_IRON, "the Serpent of Hell", "철의 도시 디스의 금속 고룡",
...
{
MONS_SERPENT_OF_HELL_TARTARUS, 'D', ETC_DEATH, "the Serpent of Hell", "타르타로스의 유령 고룡",
M_SEE_INVIS | M_UNIQUE | M_CRASH_DOORS | M_FLIES | M_TALL_TILE,
MR_RES_POISON | mrd(MR_RES_COLD, 2),

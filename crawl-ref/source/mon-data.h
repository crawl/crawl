...

{
    ...
    M_FAST_REGEN | M_HERD | M_WEB_IMMUNE | M_NO_SKELETON,
    MR_RES_POISON,
...
{
    MONS_YENNEFER, 'e', LIGHTMAGENTA, "Yennefer",
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_FEMALE,
    MR_NO_FLAGS,
    25, MONS_ELF, MONS_ELF, MH_NATURAL, 80,
    { {AT_HIT, AF_PLAIN, 8}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    13, 800,
    1, 15, MST_YENNEFER, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_YENNEFER}, TILE_ERROR
},
...
{
    MONS_CIRI, 'i', BROWN, "Ciri",
    M_UNIQUE | M_HERD | M_WARM_BLOOD | M_SPEAKS | M_FEMALE | M_FIGHTER,
    MR_NO_FLAGS,
    25, MONS_SPRIGGAN, MONS_SPRIGGAN, MH_HOLY | MH_DEMONIC, 100,
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    13, 990,
    3, 25, MST_CIRI, true, S_SHOUT,
    I_HUMAN, HT_LAND, 18, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_LITTLE, MON_SHAPE_HUMANOID,
    {TILEP_MONS_CIRI}, TILE_ERROR
},
...
{
    MONS_GERALT, '6', LIGHTGREY, "Geralt",
    M_UNIQUE | M_SEE_INVIS | M_FAST_REGEN | M_WARM_BLOOD 
        | M_MALE | M_FAST_REGEN | M_TWO_WEAPONS,
    MR_RES_POISON,
    25, MONS_DEMONSPAWN, MONS_DEMONSPAWN, MH_NATURAL, 80,
    { {AT_HIT, AF_PLAIN, 25}, {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK },
    13, 1500,
    8, 10, MST_GERALT, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_GERALT}, TILE_ERROR
},

...

{
    ...
    M_UNIQUE | M_COLD_BLOOD | M_SPEAKS | M_GENDER_NEUTRAL,
    MR_NO_FLAGS,
...
// eyes ('G')
{
    MONS_MORIORBY, 'G', LIGHTCYAN, "Moriorby",
    M_UNIQUE | M_MALE | M_SEE_INVIS | M_FLIES | M_NO_SKELETON,
    MR_NO_FLAGS,
    10, MONS_FLOATING_EYE, MONS_FLOATING_EYE, MH_NATURAL, 120,
    { {AT_BITE, AF_BLINK_WITH, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    20, 2100,
    7, 7, MST_MORIORBY, false, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, SIZE_LARGE, MON_SHAPE_ORB,
    {TILEP_MONS_MORIORBY}, TILE_ERROR
},

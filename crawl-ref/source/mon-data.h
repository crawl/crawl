...
{
    MONS_ACID_CRAB, 't', YELLOW, "acid crab",
    M_NO_SKELETON,
    MR_VUL_POISON | mrd(MR_RES_ACID, 3),
    25, MONS_CRAB, MONS_ACID_CRAB, MH_NATURAL, 40,
    { {AT_BITE, AF_ACID, 15}, {AT_CLAW, AF_ACID, 15}, AT_NO_ATK, AT_NO_ATK },
    8, 520,
    9, 6, MST_ACID_CRAB, CE_NOXIOUS, S_SILENT,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_QUADRUPED,
    {TILEP_MONS_ACID_CRAB}, TILE_CORPSE_ACID_CRAB
},

...
public:
    ...
    void render(crawl_view_buffer& vbuf, bool draw_tiles) override;
private:
...
private:
    ...
    void draw_beam(crawl_view_buffer &vbuf, bool draw_tiles);
    void highlight_summoner(crawl_view_buffer &vbuf, bool draw_tiles);

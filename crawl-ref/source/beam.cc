                                     ...
                                     spell_type origin_spell)
{
    ...
    case SPELL_GORGONSHOT:
        if (goldify)
            simple_monster_message(mon, " turns to stone, then dissolves into gold coins!");
        else
            simple_monster_message(mon, " turns into a crumbling mass of stone!");
        break;
    default:
        break;
    }
...
void bolt::kill_monster(monster &mon)
{
    ...
    case SPELL_GLACIATE:
    {
        ...
        const monster_type pillar_type =
            origin_spell == SPELL_GLACIATE ? MONS_BLOCK_OF_ICE
                                           : MONS_STONE_REMAINS;

        if (monster *pillar = create_monster(
                                             mgen_data(pillar_type,
                                                       BEH_HOSTILE,
                                                       where,
                                                       MHITNOT,

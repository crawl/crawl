...
PORTAL_ENTRANCE(DNGN_ENTER_DREAMS, "portal to the Realm of Dreams", "enter_dreams", BLUE),
#if TAG_MAJOR_VERSION == 34
...
PORTAL_EXIT(DNGN_EXIT_DREAMS, "portal leading back out of this place", "exit_dreams", BLUE),

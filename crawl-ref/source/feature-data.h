...
PORTAL_ENTRANCE(DNGN_ENTER_FORGE, "portal to a forge", "enter_forge", BROWN),
...
PORTAL_EXIT(DNGN_EXIT_FORGE, "portal leading back out of this place", "exit_forge", BROWN),
...
{
    DNGN_BODY_FORGE, "body forge", "body_forge",
    DCHAR_ARCH, NUM_DCHAR_TYPES,
    MAGENTA, LIGHTGREY, MAGENTA, MAGENTA, LIGHTGREY,
    FFT_NONE, MF_FEATURE,
},

{
    DNGN_WEAPON_FORGE, "weapon forge", "weapon_forge",
    DCHAR_ARCH, NUM_DCHAR_TYPES,
...
{
    DNGN_SOUL_FORGE, "soul forge", "soul_forge",
    DCHAR_ARCH, NUM_DCHAR_TYPES,
    LIGHTBLUE, LIGHTGREY, LIGHTBLUE, LIGHTBLUE, LIGHTGREY,
    FFT_NONE, MF_FEATURE,
},

...
ALTAR(DNGN_ALTAR_UKAYAW, "hide-covered altar to Ukayaw", "altar_ukayaw", ETC_INCARNADINE),
ALTAR(DNGN_ALTAR_HEPLIAKLQANA, "hazy altar of Hepliaklqana", "altar_hepliaklqana", BROWN),

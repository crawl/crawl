...
PORTAL_ENTRANCE(DNGN_ENTER_HIVE, "gateway to a hive", "enter_hive", YELLOW),
#if TAG_MAJOR_VERSION == 34
...
PORTAL_EXIT(DNGN_EXIT_HIVE, "gate leading back out of this place", "exit_hive", YELLOW),
...
ALTAR(DNGN_ALTAR_AGRAPHEDE, "swarming altar the Agraphede", "altar_agraphede", GREEN),
...
{
    DNGN_TEMPORARY_FLOOR, "temporary floor", "temporary_floor",
    DCHAR_FLOOR, DCHAR_FLOOR_MAGIC,
    COLOUR_IS(ETC_FLOOR),
    FFT_NONE, MF_FLOOR,
},
...
{
    DNGN_ICY_FLOOR, "icy floor", "icy_floor",
    DCHAR_FLOOR, DCHAR_FLOOR_MAGIC,
    COLOUR_IS(ETC_FLOOR),
    FFT_NONE, MF_FLOOR,
},

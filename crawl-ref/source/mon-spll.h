...
static const mon_spellbook mspell_list[] =
{
    ...
    {  MST_GIANT_ORANGE_BRAIN,
      {
       { SPELL_BRAIN_FEED, 10, MON_SPELL_INNATE },
       { SPELL_CAUSE_FEAR, 10, MON_SPELL_INNATE },
    ...
    {  MST_GREAT_ORB_OF_EYES,
      {
       { SPELL_PARALYSE, 12, MON_SPELL_INNATE },
       { SPELL_DISINTEGRATE, 12, MON_SPELL_INNATE },
    ...
    {  MST_STEAM_DRAGON,
      {
       { SPELL_STEAM_BALL, 54, MON_SPELL_INNATE },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
    ...
    {  MST_MOTTLED_DRAGON,
      {
       { SPELL_STICKY_FLAME_SPLASH, 55, MON_SPELL_INNATE },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
    ...
    {  MST_SHADOW_FIEND,
      {
       { SPELL_BOLT_OF_COLD, 17, MON_SPELL_INNATE },
    ...
    {  MST_STORM_DRAGON,
      {
       { SPELL_LIGHTNING_BOLT, 64, MON_SPELL_INNATE },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
    ...
    {  MST_CACODEMON,
      {
       { SPELL_ENERGY_BOLT, 13, MON_SPELL_INNATE },
       { SPELL_SLOW, 13, MON_SPELL_INNATE },
    ...
    {  MST_BALRUG,
      {
       { SPELL_BOLT_OF_FIRE, 16, MON_SPELL_INNATE },
    ...
    {  MST_BLIZZARD_DEMON,
      {
       { SPELL_LIGHTNING_BOLT, 16, MON_SPELL_INNATE },
    ...
    {  MST_GOLDEN_DRAGON,
      {
       { SPELL_BOLT_OF_FIRE, 23, MON_SPELL_INNATE },
       { SPELL_BOLT_OF_COLD, 23, MON_SPELL_INNATE },
       { SPELL_POISONOUS_CLOUD, 23, MON_SPELL_INNATE },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
      }
    ...
    {  MST_NAGA,
      {
       { SPELL_SPIT_POISON, 55, MON_SPELL_INNATE },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
    ...
    {  MST_SHADOW_DRAGON,
      {
       { SPELL_BOLT_OF_DRAINING, 67, MON_SPELL_INNATE },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
    ...
    {  MST_SWAMP_DRAGON,
      {
       { SPELL_POISONOUS_CLOUD, 59, MON_SPELL_INNATE },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
    ...
    {  MST_SWAMP_DRAKE,
      {
       { SPELL_NOXIOUS_CLOUD, 54, MON_SPELL_INNATE },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
    ...
    {  MST_SERPENT_OF_HELL,
      {
       { SPELL_SERPENT_OF_HELL_BREATH, 35, MON_SPELL_INNATE },
    ...
    {  MST_QUICKSILVER_DRAGON,
      {
       { SPELL_QUICKSILVER_BOLT, 66, MON_SPELL_INNATE },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
    ...
    {  MST_IRON_DRAGON,
      {
       { SPELL_METAL_SPLINTERS, 68, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
    ...
    {  MST_DEATH_DRAKE,
      {
       { SPELL_MIASMA_BREATH, 59, MON_SPELL_INNATE },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
    ...
    {  MST_ICE_STATUE,
      {
       { SPELL_BOLT_OF_COLD, 12, MON_SPELL_INNATE },
    ...
    {  MST_DISPATER,
      {
       { SPELL_SUMMON_GREATER_DEMON, 26, MON_SPELL_INNATE },
    ...
    {  MST_ERESHKIGAL,
      {
       { SPELL_BOLT_OF_COLD, 11, MON_SPELL_INNATE },
       { SPELL_SILENCE, 11, MON_SPELL_INNATE },
    ...
    {  MST_LOM_LOBON,
      {
       { SPELL_GLACIATE, 14, MON_SPELL_INNATE },
       { SPELL_CONJURE_BALL_LIGHTNING, 14, MON_SPELL_INNATE },
       { SPELL_MAJOR_HEALING, 14, MON_SPELL_INNATE },
       { SPELL_TORNADO, 28, MON_SPELL_INNATE },
       { SPELL_BLINK_RANGE, 14, MON_SPELL_INNATE },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
      }
    },
    ...
    {  MST_CEREBOV,
      {
       { SPELL_FIRE_STORM, 11, MON_SPELL_INNATE },
    ...
    {  MST_GLOORX_VLOQ,
      {
       { SPELL_POISON_ARROW, 13, MON_SPELL_INNATE },
       { SPELL_MIASMA_BREATH, 13, MON_SPELL_INNATE },
       { SPELL_SYMBOL_OF_TORMENT, 13, MON_SPELL_INNATE },
       { SPELL_BOLT_OF_DRAINING, 13, MON_SPELL_INNATE },
       { SPELL_DISPEL_UNDEAD, 13, MON_SPELL_INNATE },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
      }
    },
    ...
    {  MST_MARA,
      {
       { SPELL_BOLT_OF_FIRE, 14, MON_SPELL_INNATE },
    ...
    {  MST_HELLEPHANT,
      {
       { SPELL_FIRE_BREATH, 35, MON_SPELL_INNATE },
    ...
    {  MST_PEARL_DRAGON,
      {
       { SPELL_HOLY_BREATH, 68, MON_SPELL_INNATE },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
       { SPELL_NO_SPELL, 0, MON_SPELL_NO_FLAGS },
    ...
    {  MST_FRANCES,
      {
       { SPELL_THROW_ICICLE, 11, MON_SPELL_INNATE },
    ...
    {  MST_VASHNIA,
      {
       { SPELL_PORTAL_PROJECTILE, 0, MON_SPELL_WIZARD },

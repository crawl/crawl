...
static const mon_spellbook mspell_list[] =
{
    ...
    {  MST_LOM_LOBON,
      {
       { SPELL_GLACIATE, 30, MON_SPELL_INNATE },
       { SPELL_CONJURE_BALL_LIGHTNING, 30, MON_SPELL_INNATE },
    ...
    {  MST_GLOORX_VLOQ,
      {
       { SPELL_POISON_ARROW, 20, MON_SPELL_INNATE },
       { SPELL_MIASMA_BREATH, 20, MON_SPELL_INNATE },

...
{ JOB_ARCANE_MARKSMAN, {
    "AM", "Arcane Marksman",
    2, 5, 5,
    { SP_FORMICID, SP_DEEP_ELF, SP_FUNGOID, SP_SPRIGGAN, SP_TROLL, SP_CENTAUR, },
...
{ JOB_CONJURER, {
    "Cj", "Conjurer",
    0, 7, 5,
    { SP_DEEP_ELF, SP_NAGA, SP_TENGU, SP_FLAN, SP_DEMIGOD, },
...
{ JOB_ENCHANTER, {
    "En", "Enchanter",
    0, 7, 5,
    { SP_DEEP_ELF, SP_FELID, SP_PROFOUND_ELF, SP_SPRIGGAN, SP_NAGA, SP_VAMPIRE, },

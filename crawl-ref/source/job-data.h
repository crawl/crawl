...
{ JOB_ARCANE_MARKSMAN, {
    ...
    { "robe", "boomerang ego:dispersal q:5" },
    WCHOICE_RANGED,
...
{ JOB_HUNTER, {
    ...
    { },
    { "leather armour", "throwing net q:1" },
    WCHOICE_RANGED,
...
{ JOB_WARPER, {
    ...
    { "leather armour", "scroll of blinking", "boomerang ego:dispersal q:12" },
    WCHOICE_PLAIN,

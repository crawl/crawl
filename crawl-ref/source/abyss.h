...
bool is_level_incorruptible(bool quiet = false, bool megabyss = false);
bool lugonu_corrupt_level(int power, bool megabyss = false);
void run_corruption_effects(int duration, bool megabyss = false);

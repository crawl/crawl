...
bool actor_is_susceptible_to_vampirism(const actor& act, bool known = false, bool include_demonic = false);
bool actor_is_susceptible_to_vampirism(bool known, const actor& act, const actor& agent);

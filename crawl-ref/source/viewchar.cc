	...
	// It must be limited to stuff present both in CP437 and WGL4.
	{
		// wall .. altar
		 ...
		 U'\x2206', // WGL4 and DEC
		  ...
		  '\\',
 #endif
		  '}', U'\x2020', U'\xf7',  '$',  '"', U'\xa7', U'\x2663',
 #if TAG_MAJOR_VERSION == 34
		 U'\xa9',
 #endif
		 // transporter .. frame_top_left
		 U'\xa9', U'\xa9',  ' ',  '#',  '*', U'\xf7',  'X',  '`',  '#', U'\x2550', U'\x2551', U'\x2554',
		 // frame_top_right .. draw_down
		 U'\x2557', U'\x255a', U'\x255d', U'\x2500', U'\x2502',  '/', '\\', U'\x250c', U'\x2510', U'\x2514', U'\x2518',  'V',
		 // draw_up .. draw_left
		 U'\x39b',  '>',  '<',
	 },
	 // CSET_ASCII

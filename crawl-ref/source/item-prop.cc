...
{
    // Maces & Flails
    { WPN_CLUB,              "club",                5,  1, 13,
        SK_MACES_FLAILS, SIZE_LITTLE, SIZE_LITTLE,
        DAMV_CRUSHING, 10, 0, 5, CLUB_BRANDS },
#if TAG_MAJOR_VERSION == 34
    { WPN_SPIKED_FLAIL,      "old spiked flail",    5,  1, 13,
        SK_MACES_FLAILS, SIZE_LITTLE, SIZE_LITTLE,
        DAMV_CRUSHING, 0, 0, 0, {} },
#endif
    { WPN_WHIP,              "whip",                6,  1, 11,
        SK_MACES_FLAILS, SIZE_LITTLE, SIZE_LITTLE,
    ...
    { WPN_QUICK_BLADE,       "quick blade",         4,  2, 15,
        SK_SHORT_BLADES, SIZE_LITTLE, SIZE_LITTLE,
    ...
    { WPN_SHORT_SWORD,       "short sword",         5,  1, 10,
        SK_SHORT_BLADES, SIZE_LITTLE, SIZE_LITTLE,
        DAMV_PIERCING, 8, 0, 30, SBL_BRANDS },
    { WPN_RAPIER,           "rapier",               7,  1, 12,
        SK_SHORT_BLADES, SIZE_LITTLE, SIZE_LITTLE,
        DAMV_PIERCING, 8, 25, 55, SBL_BRANDS },
#if TAG_MAJOR_VERSION == 34
    { WPN_CUTLASS,          "old cutlass",          8,  1, 12,
        SK_SHORT_BLADES, SIZE_LITTLE, SIZE_LITTLE,
        DAMV_SLICING | DAM_PIERCE, 0, 0, 0, {}},
#endif

    // Long Blades
    { WPN_FALCHION,              "falchion",               8,  1, 13,
    ...
    { WPN_DEMON_BLADE,           "demon blade",           13, 0, 13,
        SK_LONG_BLADES,  SIZE_LITTLE, SIZE_LITTLE,
        DAMV_SLICING, 0, 13, 250, DEMON_BRANDS },
    { WPN_EUDEMON_BLADE,         "eudemon blade",         14, 0, 12,
        SK_LONG_BLADES,  SIZE_LITTLE, SIZE_LITTLE,
    ...
    { WPN_GREAT_SWORD,           "great sword",           17, 0, 17,
        SK_LONG_BLADES,  SIZE_MEDIUM, NUM_SIZE_LEVELS,
        DAMV_SLICING, 6, 20, 100, LBL_BRANDS },
    { WPN_TRIPLE_SWORD,          "triple sword",          19, -1, 18,
        SK_LONG_BLADES,  SIZE_MEDIUM, NUM_SIZE_LEVELS,
        DAMV_SLICING, 0, 24, 150, LBL_BRANDS },
#if TAG_MAJOR_VERSION == 34
    { WPN_BLESSED_FALCHION,      "old falchion",         8,  1, 13,
        SK_LONG_BLADES,  SIZE_LITTLE, SIZE_LITTLE,
        DAMV_SLICING, 0, 0, 0, {} },
    { WPN_BLESSED_LONG_SWORD,    "old long sword",      10,  1, 14,
        SK_LONG_BLADES,  SIZE_LITTLE, SIZE_LITTLE,
        DAMV_SLICING, 0, 0, 0, {} },
    { WPN_BLESSED_SCIMITAR,      "old scimitar",        12, 0, 14,
        SK_LONG_BLADES,  SIZE_LITTLE, SIZE_LITTLE,
        DAMV_SLICING, 0, 0, 0, {} },
    { WPN_BLESSED_DOUBLE_SWORD, "old double sword",     15, -1, 15,
        SK_LONG_BLADES,  SIZE_LITTLE, SIZE_MEDIUM,
        DAMV_SLICING, 0, 0, 0, {} },
    { WPN_BLESSED_GREAT_SWORD,   "old great sword",     17, 0, 16,
        SK_LONG_BLADES,  SIZE_MEDIUM, NUM_SIZE_LEVELS,
        DAMV_SLICING, 0, 0, 0, {} },
    { WPN_BLESSED_TRIPLE_SWORD,      "old triple sword", 19, -1, 18,
        SK_LONG_BLADES,  SIZE_MEDIUM, NUM_SIZE_LEVELS,
        DAMV_SLICING, 0, 0, 0, {} },
#endif

    // Axes
    { WPN_HAND_AXE,          "hand axe",            7,  1, 13,
    ...
    // Range weapons
#if TAG_MAJOR_VERSION == 34
    { WPN_BLOWGUN,           "old blowgun",         0,  1, 10,
    ...
    { WPN_HAND_CANNON,       "hand cannon",      16,  1, 19,
        SK_RANGED_WEAPONS,   SIZE_LITTLE, SIZE_LITTLE,
    ...
    { WPN_TRIPLE_CROSSBOW,   "triple crossbow",    23,  0, 23,

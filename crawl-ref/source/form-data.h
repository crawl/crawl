...
},
{
    ...
    FormScaling().Base(31).Scaling(7), true, FormScaling().Base(9), true,
    SPWPN_NORMAL, LIGHTGREY, "", DEFAULT_VERBS,
...

{
    ...
    FormScaling().Base(16).Scaling(2), true, FormScaling().Base(15).Scaling(9), true,
...

{
    ...
    DEFAULT_DURATION, 0, 0, SIZE_CHARACTER, 10,
    FormScaling().Base(15).Scaling(3), true, FormScaling().Base(26).Scaling(6), true,

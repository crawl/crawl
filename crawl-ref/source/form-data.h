...
struct form_entry
{
    ...
    bool use_assumed_monster_stats;
...
{
{
    ...
    FormDuration(0, PS_NONE, 0), 0, 0, 0, SIZE_CHARACTER, 10,
    {}, true, {},
    SPWPN_NORMAL, LIGHTGREY, "", DEFAULT_VERBS,
    FC_DEFAULT, FC_DEFAULT, false, true, false,
...
#if TAG_MAJOR_VERSION == 34
{
    ...
    FormDuration(10, PS_DOUBLE, 60), 0, 5, 0, SIZE_TINY, 10,
    {}, true, {},
    SPWPN_VENOM, LIGHTGREEN, "Fangs", ANIMAL_VERBS,
    FC_DEFAULT, FC_FORBID, false, false, true,
...
#endif
{
    ...
    FormDuration(10, PS_SINGLE, 100), 0, 0, 0, SIZE_CHARACTER, 10,
...
},
{
    ...
    DEFAULT_DURATION, 0, 0, 0, SIZE_CHARACTER, 13,
    FormScaling().Base(27).Scaling(11), true, FormScaling().Base(9),
    SPWPN_NORMAL, LIGHTGREY, "", DEFAULT_VERBS,
    FC_DEFAULT, FC_DEFAULT, false, true, true,
...

{
    ...
    DEFAULT_DURATION, 0, 0, 0, SIZE_CHARACTER, 10,
...

{
    ...
    DEFAULT_DURATION, 0, 5, 0, SIZE_TINY, 10,
...

{
    ...
    0, 0, NUM_TALISMANS,
    EQF_PHYSICAL | EQF_RINGS, MR_NO_FLAGS,
    BAD_DURATION, 0, 0, 0, SIZE_SMALL, 10,
...
#if TAG_MAJOR_VERSION == 34
{
    ...
    FormDuration(10, PS_DOUBLE, 60), 0, 0, 0, SIZE_CHARACTER, 10,
    {}, true, {},
    SPWPN_NORMAL, LIGHTGREY, "", DEFAULT_VERBS,
    FC_DEFAULT, FC_DEFAULT, false, true, false,
    FC_DEFAULT, FC_DEFAULT, FC_DEFAULT, FC_DEFAULT, FC_DEFAULT,
...
#if TAG_MAJOR_VERSION == 34
{
    ...
    0, 0, NUM_TALISMANS,
    EQF_ALL, MR_NO_FLAGS,
    BAD_DURATION, 0, 0, 0, SIZE_TINY, 10,
    {}, false, FormScaling().XLBased(),
    SPWPN_NORMAL, LIGHTGREY, "Teeth", ANIMAL_VERBS,
    FC_DEFAULT, FC_FORBID, false, false, true,
    FC_DEFAULT, FC_ENABLE, FC_ENABLE, FC_ENABLE, FC_ENABLE,
...
#if TAG_MAJOR_VERSION == 34
{
    ...
    0, 0, NUM_TALISMANS,
    EQF_PHYSICAL | EQF_RINGS, MR_NO_FLAGS,
    BAD_DURATION, 0, 0, 0, SIZE_CHARACTER, 10,
    {}, false, FormScaling().XLBased(),
    SPWPN_NORMAL, LIGHTGREY, "", DEFAULT_VERBS,
    FC_DEFAULT, FC_FORBID, false, false, true,
    FC_FORBID, FC_FORBID, FC_FORBID, FC_FORBID, FC_DEFAULT,
...
#if TAG_MAJOR_VERSION == 34
{
    ...
    FC_DEFAULT, FC_FORBID, false, true, true,
    FC_FORBID, FC_FORBID, FC_FORBID, FC_FORBID, FC_DEFAULT,
    "", 0, "", "", "", "shadow",
...
#if TAG_MAJOR_VERSION == 34
{
    ...
    0, 0, NUM_TALISMANS,
    EQF_PHYSICAL, MR_RES_POISON,
    DEFAULT_DURATION, 0, 0, 0, SIZE_GIANT, 13,
    {}, true, {},
...

{
    ...
    FC_ENABLE, FC_DEFAULT, false, false, true,
    FC_FORBID, FC_FORBID, FC_FORBID, FC_FORBID, FC_DEFAULT,
...

{
    ...
    FormDuration(50, PS_DOUBLE, 100), 0, 0, 0, SIZE_CHARACTER, 10,
    {}, true, {},
    SPWPN_NORMAL, LIGHTRED, "", DEFAULT_VERBS,
    FC_ENABLE, FC_FORBID, false, true, false,
    FC_DEFAULT, FC_DEFAULT, FC_DEFAULT, FC_DEFAULT, FC_DEFAULT,
    "", 0, "", "", "", "",
...
{
    transformation::dungeon_denizen, MONS_PROGRAM_BUG, "Denizen", "dungeon-creature-form", "dungeon-creature",
    "a random denizen of the dungeon",
    0, 0, NUM_TALISMANS,
    EQF_NONE, MR_NO_FLAGS,
    DEFAULT_DURATION, 0, 0, 0, SIZE_CHARACTER, 10,
    {}, true, {},
    SPWPN_NORMAL, LIGHTGREY, "", DEFAULT_VERBS,
    FC_DEFAULT, FC_DEFAULT, true, false, true,
    FC_DEFAULT, FC_DEFAULT, FC_DEFAULT, FC_DEFAULT, FC_DEFAULT,
    "", 0, "", "", "", "",
    { { "complete tranformation", "Your body is not your own. You have taken on the form of a local creature." }
    },
    {}
},
};

...
#if TAG_MAJOR_VERSION == 34
{
    ...
    FC_FORBID, FC_FORBID, FC_FORBID, FC_FORBID, FC_ENABLE,
...
},
{
    ...
    FC_ENABLE, FC_FORBID, FC_ENABLE, FC_FORBID, FC_ENABLE,
...

{
    ...
    FC_ENABLE, FC_FORBID, FC_ENABLE, FC_ENABLE, FC_ENABLE,
...

{
    ...
    FC_ENABLE, FC_FORBID, false, true,
    FC_ENABLE, FC_ENABLE, FC_ENABLE, FC_ENABLE, FC_ENABLE,

...
},
{
    ...
    FormScaling().Base(20).Scaling(18), true, 12, true,
    SPWPN_NORMAL, LIGHTGREY, "", DEFAULT_VERBS,
...
},
{
    ...
    FormScaling().Base(8).Scaling(4), true, 10, true,
...

{
    ...
    FormScaling().Base(14).Scaling(4), true, -1, true,
...

{
    ...
    {}, false, 1, false /*but special-cased*/,
...

{
    ...
    FormScaling().Base(20).Scaling(14).XLBased(), true, 12, false,
...

{
    ...
    EQF_ALL, mrd(MR_RES_FIRE, 2) | mrd(MR_RES_COLD, 2) | MR_RES_ELEC
             ...
             | MR_RES_PETRIFY,
    BAD_DURATION, 0, 0, SIZE_TINY, 10,
    FormScaling().Base(5).Scaling(14).XLBased(), false, 5, false,
...

{
    ...
    BAD_DURATION, 0, 0, SIZE_TINY, 10,
    FormScaling().Base(12), false, 12, false,
...

{
    ...
    DEFAULT_DURATION, 0, 0, SIZE_CHARACTER, 10,
    FormScaling().Base(8).Scaling(10), true, -1, true,

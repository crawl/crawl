...
{
{
    ...
    0, 0, 0, true, 0, 0, 3,
    SPWPN_NORMAL, LIGHTGREY, "", DEFAULT_VERBS, AF_PLAIN,
...
},
{
    ...
    2, 0, 0, true, 10, 10, 5,
    SPWPN_VENOM, LIGHTGREEN, "Fangs", ANIMAL_VERBS, AF_PLAIN,
...
},
{
    ...
    0, 0, 0, true, 20, 12, -1,
    SPWPN_NORMAL, RED, "", { "hit", "slash", "slice", "shred" }, AF_PLAIN,
    FC_DEFAULT, FC_DEFAULT, FC_DEFAULT, true, true,
    "", 0, "scythe-like blade", "", "", ""
},
{
...
},
{
    ...
    5, 7, 0, true, 0, 10, 12,
    SPWPN_FREEZING, WHITE, "", DEFAULT_VERBS, AF_COLD,
...

{
    ...
    6, 0, 0, true, 0, 10, 5,
    SPWPN_DRAINING, MAGENTA, "", DEFAULT_VERBS, AF_DRAIN_XP,
...

{
    ...
    0, 0, 0, false, 10, 12, -1,
    SPWPN_NORMAL, LIGHTGREY, "Teeth", ANIMAL_VERBS, AF_PLAIN,
    FC_ENABLE, FC_FORBID, FC_ENABLE, true, false,
...
#if TAG_MAJOR_VERSION == 34
{
    ...
    0, 0, 0, false, 0, 0, 3,
    SPWPN_NORMAL, LIGHTGREY, "", DEFAULT_VERBS, AF_ACID,
...

{
    ...
    0, 0, 0, true, 0, 0, 3,
    SPWPN_NORMAL, MAGENTA, "", DEFAULT_VERBS, AF_PLAIN,
...

{
    ...
    "",
    EQF_PHYSICAL, MR_RES_POISON,
    FormDuration(4, PS_STABLE_TENTH, 12), 8, 0, SIZE_BIG, 15, 6,
    6, 5, 0, true, 0, 10, -1,
    SPWPN_NORMAL, GREEN, "", { "nip at", "bite", "gouge", "chomp" }, AF_PLAIN,

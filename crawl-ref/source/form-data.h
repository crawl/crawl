...
#endif
{
    ...
    EQF_HELD | SLOTF(SLOT_GLOVES), MR_NO_FLAGS,
    0, 0, SIZE_CHARACTER, 10,
...
#if TAG_MAJOR_VERSION == 34
{
    ...
    "",
    0, 0, NUM_TALISMANS,
    SLOTF(SLOT_BOOTS) | SLOTF(SLOT_HELMET), MR_NO_FLAGS,
    0, 0, SIZE_CHARACTER, 10,
    {}, true, {},
    SPWPN_NORMAL, LIGHTGREY, "", DEFAULT_VERBS,
    FC_DEFAULT, FC_DEFAULT, true, false,
...

{
    ...
    "a tree.",
    0, 0, NUM_TALISMANS,
    EQF_AUXES | SLOTF(SLOT_BODY_ARMOUR), MR_RES_POISON,
    0, 0, SIZE_CHARACTER, 15,
...

{
    ...
    10, 19, TALISMAN_MAW,
    SLOTF(SLOT_BODY_ARMOUR), MR_NO_FLAGS,
    0, 0, SIZE_CHARACTER, 10,
...

{
    ...
    7, 14, TALISMAN_FLUX,
    EQF_HELD | SLOTF(SLOT_BODY_ARMOUR), MR_NO_FLAGS,
    0, 0, SIZE_CHARACTER, 10,
    {}, true, {},

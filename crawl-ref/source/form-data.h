...
#if TAG_MAJOR_VERSION == 34
{
    ...
    FC_FORBID, FC_FORBID, FC_FORBID, FC_FORBID,
...
},
{
    ...
    FC_FORBID, FC_FORBID, FC_FORBID, FC_DEFAULT,
...
},
{
    ...
    FC_ENABLE, FC_FORBID, FC_ENABLE, FC_FORBID,
...

{
    ...
    FC_ENABLE, FC_FORBID, FC_ENABLE, FC_ENABLE,
...

{
    ...
    FC_DEFAULT, FC_DEFAULT, true, true,
    FC_FORBID, FC_DEFAULT, FC_DEFAULT, FC_DEFAULT,
    "", 0, "", "", "", "fossilised flesh",
...

{
    ...
    FC_ENABLE, FC_FORBID, false, true,
    FC_ENABLE, FC_ENABLE, FC_ENABLE, FC_ENABLE,
...

{
    ...
    SPWPN_NORMAL, LIGHTGREY, "", DEFAULT_VERBS,
    FC_DEFAULT, FC_DEFAULT, true, false,
    FC_DEFAULT, FC_ENABLE, FC_DEFAULT, FC_DEFAULT,
    "", 0, "", "", "", "",

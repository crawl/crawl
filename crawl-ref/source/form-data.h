...
},
{
    ...
    FormScaling().Base(20).Scaling(18), true, FormScaling().Base(9), true,
    SPWPN_NORMAL, LIGHTGREY, "", DEFAULT_VERBS,
...
},
{
    ...
    FormScaling().Base(8).Scaling(4), true, FormScaling().Base(7), true,
...

{
    ...
    FormScaling().Base(14).Scaling(4), true, FormScaling().Base(15).Scaling(9), true,
...

{
    ...
    {}, false, FormScaling().Base(-2), false /*but special-cased*/,
...

{
    ...
    FormScaling().Base(20).Scaling(14).XLBased(), true, FormScaling().Base(9), false,
...

{
    ...
    EQF_ALL, mrd(MR_RES_FIRE, 2) | mrd(MR_RES_COLD, 2) | MR_RES_ELEC
             ...
             | MR_RES_PETRIFY,
    BAD_DURATION, 0, 0, SIZE_TINY, 10,
    FormScaling().Base(5).Scaling(14).XLBased(), false, FormScaling().Base(2), false,
...

{
    ...
    BAD_DURATION, 0, 0, SIZE_TINY, 10,
    FormScaling().Base(12), false, FormScaling().Base(9), false,
...

{
    ...
    DEFAULT_DURATION, 0, 0, SIZE_CHARACTER, 10,
    FormScaling().Base(8).Scaling(10), true, FormScaling().Base(26).Scaling(6), true,

...
static void _give_shield(monster* mon, int level)
{
    ...
    {
    case MONS_ASTERION:
        make_item_for_monster(mon, OBJ_ARMOUR, ARM_HOPLON,
                              level * 2 + 1, 1);
        break;
    case MONS_DAEVA:
    case MONS_MENNAS:
    ...
    case MONS_DRACONIAN_KNIGHT:
        ...
        {
            make_item_for_monster(mon, OBJ_ARMOUR,
                                  random_choose(ARM_PAVISE, ARM_HOPLON),
                                  level);
        }
        break;
    ...
    case MONS_GNOLL_SERGEANT:
        if (mon->type != MONS_TENGU_WARRIOR && !one_chance_in(3))
            break;
        make_item_for_monster(mon, OBJ_ARMOUR,
                              random_choose(ARM_BUCKLER, ARM_HOPLON),
                              level);
        break;
    ...
    case MONS_DONALD:
        shield = make_item_for_monster(mon, OBJ_ARMOUR, ARM_HOPLON,
                                       level * 2 + 1, 1);
        ...
        if (shield)
        {
            ...
            {
                shield->props["item_tile_name"] = "hoplon_donald";
                shield->props["worn_tile_name"] = "hoplon_donald";
                bind_item_tile(*shield);
            }
        }
    ...
    case MONS_BLACK_SUN:
        if (one_chance_in(3))
        {
            armour_type shield_type = random_choose(ARM_BUCKLER, ARM_HOPLON);

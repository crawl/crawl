...
{ SP_BARACHI, {
    ...
    { "+LOS", "swims", },
    { JOB_FIGHTER, JOB_BERSERKER, JOB_SUMMONER, JOB_ICE_ELEMENTALIST },
...
{ SP_GNOLL, {
    ...
    { JOB_WARPER, JOB_ARCANE_MARKSMAN, JOB_TRANSMUTER,
      JOB_WANDERER },
    { SK_MACES_FLAILS, SK_AXES, SK_POLEARMS, SK_LONG_BLADES, SK_STAVES,
      SK_BOWS, SK_CROSSBOWS, SK_SLINGS },
} },
...
{ SP_HALFLING, {
    ...
    {},
    {},
    { JOB_FIGHTER, JOB_HUNTER, JOB_BERSERKER, JOB_ABYSSAL_KNIGHT },
...
{ SP_MERFOLK, {
    ...
    { JOB_GLADIATOR, JOB_BERSERKER, JOB_TRANSMUTER, JOB_SUMMONER,
...
{ SP_HIGH_ELF, {
    ...
    {},
    {},
    { JOB_HUNTER, JOB_WIZARD, JOB_CONJURER, JOB_FIRE_ELEMENTALIST,

...
static const mon_spellbook mspell_list[] =
{
    ...
    {  MST_HELLION,
      {
       { SPELL_CALL_DOWN_DAMNATION, 57, MON_SPELL_DEMONIC },
      }
    },
    ...
    {  MST_FIEND,
      {
       { SPELL_HURL_DAMNATION, 34, MON_SPELL_DEMONIC },
    ...
    {  MST_HELL_SENTINEL,
      {
       { SPELL_HURL_DAMNATION, 28, MON_SPELL_DEMONIC },
    ...
    {  MST_TZITZIMITL,
      {
       { SPELL_BOLT_OF_COLD, 15, MON_SPELL_DEMONIC },
       { SPELL_BOLT_OF_DRAINING, 15, MON_SPELL_DEMONIC },
       { SPELL_SYMBOL_OF_TORMENT, 25, MON_SPELL_DEMONIC },
       { SPELL_DISPEL_UNDEAD, 25, MON_SPELL_DEMONIC },
      }
    },
    ...
    {  MST_AZRAEL,
      {
       ...
       { SPELL_HURL_DAMNATION, 13, MON_SPELL_DEMONIC },
       { SPELL_CALL_DOWN_DAMNATION, 13, MON_SPELL_DEMONIC | MON_SPELL_EMERGENCY },
      }
    },
    ...
    {  MST_ASMODEUS,
      {
       ...
       { SPELL_HURL_DAMNATION, 22, MON_SPELL_DEMONIC },

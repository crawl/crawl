    ...
    {  MST_AISHA,
      {
       ...
       { SPELL_MEPHITIC_CLOUD, 10, MON_SPELL_VOCAL },
       { SPELL_AIRSTRIKE, 10, MON_SPELL_VOCAL },
       { SPELL_PETRIFY, 10, MON_SPELL_VOCAL },
       { SPELL_IRRADIATE, 10, MON_SPELL_VOCAL },
       { SPELL_PLASMA_BEAM, 10, MON_SPELL_VOCAL },
       { SPELL_MONSTROUS_MENAGERIE, 10, MON_SPELL_VOCAL },
       { SPELL_OZOCUBUS_REFRIGERATION, 10, MON_SPELL_VOCAL },
       { SPELL_HAUNT, 10, MON_SPELL_VOCAL },
       { SPELL_SUMMON_HORRIBLE_THINGS, 10, MON_SPELL_VOCAL },
       { SPELL_LEHUDIBS_CRYSTAL_SPEAR, 10, MON_SPELL_VOCAL },
       { SPELL_FIRE_STORM, 10, MON_SPELL_VOCAL },
      }
    },

...
static const mon_spellbook mspell_list[] =
{
    ...
    {  MST_AISHA,
      {
       { SPELL_SLOW, 5, MON_SPELL_VOCAL },
       { SPELL_BLINK, 5, MON_SPELL_VOCAL },
       { SPELL_MEPHITIC_CLOUD, 5, MON_SPELL_VOCAL },
       { SPELL_AIRSTRIKE, 5, MON_SPELL_VOCAL },
       { SPELL_PETRIFY, 5, MON_SPELL_VOCAL },
       { SPELL_IRRADIATE, 5, MON_SPELL_VOCAL },
       { SPELL_PLASMA_BEAM, 5, MON_SPELL_VOCAL },
       { SPELL_MONSTROUS_MENAGERIE, 5, MON_SPELL_VOCAL },
       { SPELL_OZOCUBUS_REFRIGERATION, 5, MON_SPELL_VOCAL },
       { SPELL_HAUNT, 5, MON_SPELL_VOCAL },
       { SPELL_SUMMON_HORRIBLE_THINGS, 5, MON_SPELL_VOCAL },
       { SPELL_LEHUDIBS_CRYSTAL_SPEAR, 5, MON_SPELL_VOCAL },
       { SPELL_FIRE_STORM, 5, MON_SPELL_VOCAL },
      }
    },

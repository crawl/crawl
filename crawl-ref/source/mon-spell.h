...
static const mon_spellbook mspell_list[] =
{
    ...
    {  MST_REVENANT,
      {
       { SPELL_GHOSTLY_FIREBALL, 17, MON_SPELL_NATURAL },
       { SPELL_GHOSTLY_FLAMES, 17, MON_SPELL_NATURAL },
       { SPELL_DISPEL_UNDEAD, 17, MON_SPELL_NATURAL },
       { SPELL_BLINK_AWAY, 17, MON_SPELL_NATURAL | MON_SPELL_EMERGENCY },
      }
    },

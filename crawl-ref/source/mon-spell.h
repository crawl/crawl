...
static const mon_spellbook mspell_list[] =
{
    ...
    {  MST_ANNIHILATOR,
      {
       ...
       { SPELL_UNMAKING, 11, MON_SPELL_WIZARD },
    ...
    {  MST_ANCIENT_CHAMPION,
      {
       { SPELL_UNMAKING, 21, MON_SPELL_WIZARD },
    ...
    {  MST_YNOXINUL,
      {
       { SPELL_UNMAKING, 19, MON_SPELL_MAGICAL },
    ...
    {  MST_JORGRUN,
      {
       ...
       { SPELL_UNMAKING, 16, MON_SPELL_WIZARD },
    ...
    {  MST_DJRAEL,
      {
       { SPELL_SLOW, 10, MON_SPELL_NATURAL },
       { SPELL_BLINK, 10, MON_SPELL_NATURAL },
       { SPELL_MEPHITIC_CLOUD, 10, MON_SPELL_NATURAL },
       { SPELL_AIRSTRIKE, 10, MON_SPELL_NATURAL },
       { SPELL_PETRIFY, 10, MON_SPELL_NATURAL },
       { SPELL_IRRADIATE, 10, MON_SPELL_NATURAL },
       { SPELL_PLASMA_BEAM, 10, MON_SPELL_NATURAL },
       { SPELL_MONSTROUS_MENAGERIE, 10, MON_SPELL_NATURAL },
       { SPELL_OZOCUBUS_REFRIGERATION, 10, MON_SPELL_NATURAL },
       { SPELL_HAUNT, 10, MON_SPELL_NATURAL },
       { SPELL_SUMMON_HORRIBLE_THINGS, 10, MON_SPELL_NATURAL },
       { SPELL_LEHUDIBS_CRYSTAL_SPEAR, 10, MON_SPELL_NATURAL },
       { SPELL_FIRE_STORM, 10, MON_SPELL_NATURAL },
      }
    },
    ...
    { MST_ROXANNE,
      {
       { SPELL_BOLT_OF_MAGMA, 13, MON_SPELL_WIZARD },
       { SPELL_UNMAKING, 13, MON_SPELL_WIZARD },
    ...
    {  MST_FRANCES,
      {
       ...
       { SPELL_UNMAKING, 12, MON_SPELL_WIZARD },

...
static const vector<monster_info_flag_name> monster_info_flag_names = {
    ...
    { MB_CLOUD_RING_FLAMES, "", "surrounded by a ring of flames", "" },
    { MB_CLOUD_RING_CHAOS, "", "surrounded by a ring of chaotic energy", "" },
    { MB_CLOUD_RING_MUTATION, "", "surrounded by a ring of mutagenic energy", "" },
    { MB_CLOUD_RING_FOG, "", "surrounded by a ring of fog", "" },
    { MB_CLOUD_RING_ICE, "", "surrounded by a ring of freezing clouds", "" },
    { MB_CLOUD_RING_DRAINING, "", "surrounded by a ring of negative energy", "" },
    { MB_CLOUD_RING_ACID, "", "surrounded by a ring of acid", "" },
    { MB_CLOUD_RING_MIASMA, "", "surrounded by a ring of miasma", "" },
    // Vulnerabilities

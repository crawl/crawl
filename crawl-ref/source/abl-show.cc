...
static bool _do_ability(const ability_def& abil)
{
    ...
    case ABIL_MAKE_WATER:
        create_pond(&you, you.pos(), 3, false);
        break;
    ...
    case ABIL_MAKE_SAGE:
        sage_card(&you, 20, DECK_RARITY_RARE);
    ...
    case ABIL_DELAYED_FIREBALL:
    {
        ...
        targetter_beam tgt(&you, beam.range, BEAM_FIRE, true, 1, 1);
    ...
    case ABIL_KIKU_RECEIVE_CORPSES:
        kiku_receive_corpses(you.skill(SK_NECROMANCY, 4), you.pos(), &you);
        break;

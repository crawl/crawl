...
public:
    ...
    static void schedule(const coord_def &pos)
    {
        final_effect::schedule(new detonation_fineff(pos));
    }
protected:
    detonation_fineff(const coord_def &pos)
        : final_effect(&you, nullptr, pos)
    {
    }
};

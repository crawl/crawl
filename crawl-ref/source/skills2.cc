...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_HIGH_ELF,        SK_DODGING,          6),
    APT(SP_HIGH_ELF,        SK_STEALTH,          6),
    ...
    APT(SP_HALFLING,        SK_AIR_MAGIC,        6),
    ...
    APT(SP_HILL_ORC,        SK_UNARMED_COMBAT,   6),
    ...
    APT(SP_SPRIGGAN,        SK_SHORT_BLADES,     6),
    ...
    APT(SP_DEMONSPAWN,      SK_NECROMANCY,       6),
    ...
    APT(SP_VAMPIRE,         SK_SHORT_BLADES,     6),

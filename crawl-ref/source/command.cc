...
static void _add_formatted_hints_help(column_composer &cols)
{
    ...
    cols.add_formatted(0, " ", false, _cmdhelp_textfilter);
    ...
    cols.add_formatted(1, " ", false, _cmdhelp_textfilter);

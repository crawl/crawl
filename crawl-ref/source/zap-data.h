...

{
    ...
    "puff of flame",
    50,
    new dicedef_calculator<4, 4, 1, 10>,
...

{
    ...
    "magic dart",
    25,
    new dicedef_calculator<2, 3, 1, 5>,
...

{
    ...
    "bolt of fire",
    200,
    new calcdice_calculator<12, 18, 2, 3>,
...

{
    ...
    "great wave of water",
    200,
    new calcdice_calculator<8, 14, 3, 5>,
    new tohit_calculator<10, 1, 25>,
    LIGHTBLUE,
    false,
    BEAM_WATER,
...

{
    ...
    "fireball",
    200,
    new calcdice_calculator<6, 20, 2, 2>,
...

{
    ...
    "bolt of lightning",
    200,
    new calcdice_calculator<2, 22, 6, 5>,
...

{
    ...
    "bolt of poison",
    200,
    new calcdice_calculator<8, 32, 6, 5>,
...

{
    ...
    200,
    new calcdice_calculator<8, 30, 6, 5>,
    new tohit_calculator<8, 1, 20>,
    DARKGREY,
    false,
    BEAM_NEG,
...

{
    ...
    "crystal spear",
    200,
    new calcdice_calculator<20, 46, 2, 1>,
...

{
    ...
    1000,
    new calcdice_calculator<20, 80, 2, 1>,
...

{
    ...
    "orb of energy",
    100,
    new calcdice_calculator<4, 24, 2, 3>,
...

{
    ...
    "",
    100,
    new dicedef_calculator<2, 4, 1,5>,
...

{
    ...
    "",
    100,
    new calcdice_calculator<6, 40, 6, 4>,
    new tohit_calculator<0, 3, 2>,
    BLACK,
    true,
    BEAM_DISPEL_UNDEAD,
...

{
    ...
    "hellfire",
    200,
    new calcdice_calculator<6, 16, 6, 5>,
...

{
    ...
    "iron shot",
    200,
    new calcdice_calculator<18, 30, 6, 4>,
...

{
    ...
    "stone arrow",
    50,
    new dicedef_calculator<6, 5, 1, 8>,
    new tohit_calculator<8, 1, 10>,
    LIGHTGREY,
    false,
    BEAM_MMISSILE,
...

{
    ...
    "zap",
    25,
    new dicedef_calculator<2, 3, 1, 4>,
...

{
    ...
    "orb of electricity",
    200,
    new calcdice_calculator<0, 26, 8, 5>,
    new tohit_calculator<40>,
    LIGHTBLUE,
    false,
    BEAM_ELECTRICITY,
...

{
    ...
    "splash of poison",
    50,
    new dicedef_calculator<2, 4, 1, 2>,
...
// XXX: How loud should breath be?
{
    ...
    "fiery breath",
    50,
    new dicedef_calculator<6, 4, 1, 3>,
...

{
    ...
    "poison gas",
    50,
    new dicedef_calculator<6, 2, 1, 6>,
...

{
    ...
    50,
    new dicedef_calculator<6, 3, 1, 3>,
    new tohit_calculator<5, 1, 6>,
    BLUE,
    false,
    BEAM_MMISSILE,
...

{
    ...
    "",
    100,
    new calcdice_calculator<6, 30, 6, 4>,
...

{
    ...
    "ball of steam",
    50,
    new dicedef_calculator<6, 4, 1, 5>,
...

{
    ...
    "flame tongue",
    25,
    new dicedef_calculator<2, 8, 1, 4>,
...

{
    ...
    "bolt of magma",
    200,
    new calcdice_calculator<8, 32, 4, 3>,
...

{
    ...
    "poison arrow",
    200,
    new calcdice_calculator<8, 30, 2, 1>,
...

{
    ...
    "spray of energy",
    50,
    new calcdice_calculator<4, 16, 2, 4>,
...

{
    ...
    "lance of force",
    100,
    new dicedef_calculator<4, 6, 1, 6>,
    new tohit_calculator<10, 1, 7>,
    CYAN,
    false,
    BEAM_MMISSILE,
...

{
    ...
    "searing ray",
    50,
    new dicedef_calculator<4, 3, 1, 13>,
...

{
    ...
    "searing ray",
    50,
    new dicedef_calculator<6, 3, 1, 12>,
...

{
    ...
    "searing ray",
    50,
    new dicedef_calculator<8, 3, 1, 12>,
...

{
    ...
    "crystal bolt",
    200,
    new calcdice_calculator<12, 36, 4, 3>,
    new tohit_calculator<10, 1, 25>,
    GREEN,
    false,
    BEAM_CRYSTAL,
...

{
    ...
    "bolt of dispelling energy",
    200,
    new calcdice_calculator<12, 30, 8, 3>,
    new tohit_calculator<10, 1, 25>,
    BLUE,
    false,
    BEAM_MMISSILE,
...

{
    ...
    200,
    new calcdice_calculator<18, 16, 6, 8>,
    new tohit_calculator<7, 1, 15>,
    CYAN,
    false,
    BEAM_FRAG,

...
static const weapon_def Weapon_prop[NUM_WEAPONS] =
{
    ...
    { WPN_ROD,               "rod",                 5,  3, 13,  50,  7,
        SK_MACES_FLAILS, HANDS_ONE,    SIZE_LITTLE, MI_NONE,
        DAMV_CRUSHING, 0 },
    { WPN_WHIP,              "whip",                6,  2,  9,  30,  2,
        SK_MACES_FLAILS, HANDS_ONE,    SIZE_LITTLE, MI_NONE,
        DAMV_SLASHING, 0 },
    { WPN_HAMMER,            "hammer",              7,  3, 13,  90,  7,
        SK_MACES_FLAILS, HANDS_ONE,    SIZE_LITTLE, MI_NONE,
        DAMV_CRUSHING, 0 },
    { WPN_MACE,              "mace",                8,  3, 15, 120,  8,
        SK_MACES_FLAILS, HANDS_ONE,    SIZE_LITTLE, MI_NONE,
        DAMV_CRUSHING, 10 },
    { WPN_FLAIL,             "flail",              10,  0, 15, 130,  8,
        SK_MACES_FLAILS, HANDS_ONE,    SIZE_LITTLE, MI_NONE,
        DAMV_CRUSHING, 10 },
    { WPN_MORNINGSTAR,       "morningstar",        13, -2, 17, 140,  8,
        SK_MACES_FLAILS, HANDS_ONE,    SIZE_SMALL,  MI_NONE,
        DAMV_CRUSHING | DAM_PIERCE, 10 },
    { WPN_DEMON_WHIP,        "demon whip",         11,  1, 8,  30,  2,
        SK_MACES_FLAILS, HANDS_ONE,    SIZE_LITTLE, MI_NONE,
        DAMV_SLASHING, 2 },
    { WPN_SACRED_SCOURGE,    "sacred scourge",     12,  0,  8,  30,  2,
        SK_MACES_FLAILS, HANDS_ONE,    SIZE_LITTLE, MI_NONE,
        DAMV_SLASHING, 0 },
    { WPN_DIRE_FLAIL,        "dire flail",         13, -3, 13, 240,  9,
        SK_MACES_FLAILS, HANDS_TWO,    SIZE_LARGE,  MI_NONE,
        DAMV_CRUSHING | DAM_PIERCE, 10 },
    { WPN_EVENINGSTAR,       "eveningstar",        15, -1, 17, 180,  8,
        SK_MACES_FLAILS, HANDS_ONE,    SIZE_SMALL,  MI_NONE,
        DAMV_CRUSHING | DAM_PIERCE, 2 },
    { WPN_GREAT_MACE,        "great mace",         17, -4, 25, 270,  9,
        SK_MACES_FLAILS, HANDS_TWO,    SIZE_LARGE,  MI_NONE,
        DAMV_CRUSHING, 10 },
    { WPN_GIANT_CLUB,        "giant club",         20, -6, 25, 330, 10,
        SK_MACES_FLAILS, HANDS_TWO,    SIZE_BIG,    MI_NONE,
        DAMV_CRUSHING, 10 },
    { WPN_GIANT_SPIKED_CLUB, "giant spiked club",  22, -7, 30, 350, 10,
        SK_MACES_FLAILS, HANDS_TWO,    SIZE_BIG,    MI_NONE,
        DAMV_CRUSHING | DAM_PIERCE, 10 },

    // Short Blades
    { WPN_DAGGER,            "dagger",              4,  6,  8,  20,  1,
        SK_SHORT_BLADES, HANDS_ONE,    SIZE_LITTLE, MI_NONE,
        DAMV_STABBING | DAM_SLICE, 10 },
    { WPN_QUICK_BLADE,       "quick blade",         5,  6,  4,  50,  0,
        SK_SHORT_BLADES, HANDS_ONE,    SIZE_LITTLE, MI_NONE,
        DAMV_STABBING | DAM_SLICE, 2 },
    { WPN_SHORT_SWORD,       "short sword",         6,  4,  9,  80,  2,
        SK_SHORT_BLADES, HANDS_ONE,    SIZE_LITTLE,  MI_NONE,
        DAMV_SLICING | DAM_PIERCE, 10 },
    { WPN_CUTLASS,           "cutlass",             7,  4, 11,  90,  2,
        SK_SHORT_BLADES, HANDS_ONE,    SIZE_LITTLE,  MI_NONE,
        DAMV_SLICING | DAM_PIERCE, 10 },
    ...
    { WPN_BLESSED_FALCHION,      "blessed falchion",       9,  2, 11, 170,  3,
        SK_LONG_BLADES,  HANDS_ONE,    SIZE_LITTLE, MI_NONE,
        DAMV_SLICING, 0 },       // or perhaps DAMV_CHOPPING is more apt?
    { WPN_LONG_SWORD,            "long sword",            10,  1, 15, 160,  3,
        SK_LONG_BLADES,  HANDS_ONE,    SIZE_SMALL,  MI_NONE,
        DAMV_SLICING, 10 },
    { WPN_BLESSED_LONG_SWORD,    "blessed long sword",    11,  0, 13, 160,  3,
        SK_LONG_BLADES,  HANDS_ONE,    SIZE_SMALL,  MI_NONE,
        DAMV_SLICING, 0 },
    { WPN_SCIMITAR,              "scimitar",              12, -2, 15, 170,  3,
        SK_LONG_BLADES,  HANDS_ONE,    SIZE_SMALL,  MI_NONE,
        DAMV_SLICING, 10 },
    { WPN_BLESSED_SCIMITAR,      "blessed scimitar",      13, -3, 13, 170,  3,
        SK_LONG_BLADES,  HANDS_ONE,    SIZE_SMALL,  MI_NONE,
        DAMV_SLICING, 0 },
    { WPN_DEMON_BLADE,           "demon blade",           13, -1, 12, 200,  3,
        SK_LONG_BLADES,  HANDS_ONE,    SIZE_SMALL,  MI_NONE,
        DAMV_SLICING, 2 },
    { WPN_EUDEMON_BLADE,         "eudemon blade",         14, -2, 11, 200,  3,
        SK_LONG_BLADES,  HANDS_ONE,    SIZE_SMALL,  MI_NONE,
        DAMV_SLICING, 0 },
    { WPN_BASTARD_SWORD,          "bastard sword",        15, -1, 17, 220,  3,
        SK_LONG_BLADES,  HANDS_ONE,    SIZE_MEDIUM, MI_NONE,
        DAMV_SLICING, 2 },
    { WPN_BLESSED_BASTARD_SWORD, "blessed bastard sword", 16, -2, 15, 220,  3,
        SK_LONG_BLADES,  HANDS_ONE,    SIZE_MEDIUM, MI_NONE,
        DAMV_SLICING, 0 },
    { WPN_GREAT_SWORD,           "great sword",           16, -3, 20, 250,  5,
        SK_LONG_BLADES,  HANDS_TWO,    SIZE_LARGE,  MI_NONE,
        DAMV_SLICING, 10 },
    { WPN_BLESSED_GREAT_SWORD,   "blessed great sword",   17, -4, 17, 250,  5,
        SK_LONG_BLADES,  HANDS_TWO,    SIZE_LARGE,  MI_NONE,
        DAMV_SLICING, 0 },
    { WPN_CLAYMORE,              "claymore",              20, -4, 40, 260,  5,
        SK_LONG_BLADES,  HANDS_TWO,    SIZE_LARGE,  MI_NONE,
        DAMV_SLICING, 2 },
    { WPN_BLESSED_CLAYMORE,      "blessed claymore",      21, -5, 35, 260,  5,
        SK_LONG_BLADES,  HANDS_TWO,    SIZE_LARGE,  MI_NONE,
        DAMV_SLICING, 0 },

...
static const armour_def Armour_prop[NUM_ARMOURS] =
{
    ...
    { ARM_ICE_DRAGON_ARMOUR,    "ice dragon armour",      9, -11,  350,
        EQ_BODY_ARMOUR, SIZE_LITTLE, SIZE_GIANT },
    { ARM_PEARL_DRAGON_HIDE,    "pearl dragon hide",      3, -7,  400,
        EQ_BODY_ARMOUR, SIZE_LITTLE, SIZE_GIANT },
    { ARM_PEARL_DRAGON_ARMOUR,  "pearl dragon armour",   10, -7,  400,
        EQ_BODY_ARMOUR, SIZE_LITTLE, SIZE_GIANT },
...
static const weapon_def Weapon_prop[NUM_WEAPONS] =
{
    ...
    { WPN_EUDEMON_BLADE,         "eudemon blade",         14, -2, 12, 200,  3,
        SK_LONG_BLADES,  HANDS_ONE,    SIZE_SMALL,  MI_NONE,
        DAMV_SLICING, 0 },
    { WPN_BASTARD_SWORD,          "double sword",        15, -1, 15, 220,  3,
        SK_LONG_BLADES,  HANDS_ONE,    SIZE_MEDIUM, MI_NONE,
        DAMV_SLICING, 2 },
    { WPN_BLESSED_BASTARD_SWORD, "blessed double sword", 16, -2, 14, 220,  3,
        SK_LONG_BLADES,  HANDS_ONE,    SIZE_MEDIUM, MI_NONE,
        DAMV_SLICING, 0 },
    ...
    { WPN_BLESSED_GREAT_SWORD,   "blessed great sword",   17, -4, 15, 250,  5,
        SK_LONG_BLADES,  HANDS_TWO,    SIZE_LARGE,  MI_NONE,
        DAMV_SLICING, 0 },
    { WPN_CLAYMORE,              "triple sword",              19, -4, 19, 260,  5,
        SK_LONG_BLADES,  HANDS_TWO,    SIZE_LARGE,  MI_NONE,
        DAMV_SLICING, 2 },
    { WPN_BLESSED_CLAYMORE,      "blessed triple sword",      20, -5, 18, 260,  5,
        SK_LONG_BLADES,  HANDS_TWO,    SIZE_LARGE,  MI_NONE,
        DAMV_SLICING, 0 },
    ...
    { WPN_BROAD_AXE,         "broad axe",          13, -2, 16, 230,  8,
        ...
        DAMV_CHOPPING, 10 },
    { WPN_BATTLEAXE,         "battleaxe",          16, -4, 17, 250,  8,
        SK_AXES,         HANDS_TWO,    SIZE_LARGE,  MI_NONE,
        DAMV_CHOPPING, 10 },
    { WPN_EXECUTIONERS_AXE,  "executioner's axe",  19, -6, 20, 280,  9,
        SK_AXES,         HANDS_TWO,    SIZE_LARGE,  MI_NONE,
        DAMV_CHOPPING, 2 },
    ...
    { WPN_HAND_CROSSBOW,     "hand crossbow",       3,  4, 15,  70,  5,
        SK_CROSSBOWS,    HANDS_ONE,    SIZE_SMALL,  MI_DART,
        DAMV_NON_MELEE, 10 },

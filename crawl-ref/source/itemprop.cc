...
static const armour_def Armour_prop[] =
{
    ...
    { ARM_SWAMP_DRAGON_ARMOUR,  "swamp dragon armour",    7,  -7,
        EQ_BODY_ARMOUR, SIZE_LITTLE, SIZE_GIANT, false,
        ARMF_RES_POISON },
    { ARM_FIRE_DRAGON_HIDE,     "fire dragon hide",       4, -11,
        EQ_BODY_ARMOUR, SIZE_LITTLE, SIZE_GIANT, false,
    ...
    { ARM_ICE_DRAGON_ARMOUR,    "ice dragon armour",      9, -11,
        EQ_BODY_ARMOUR, SIZE_LITTLE, SIZE_GIANT, false,
        ard(ARMF_RES_COLD, 2) | ARMF_VUL_FIRE },
    { ARM_PEARL_DRAGON_HIDE,    "pearl dragon hide",      5, -11,
        EQ_BODY_ARMOUR, SIZE_LITTLE, SIZE_GIANT, false,
        ARMF_RES_NEG },
    { ARM_PEARL_DRAGON_ARMOUR,  "pearl dragon armour",   10, -11,
        EQ_BODY_ARMOUR, SIZE_LITTLE, SIZE_GIANT, false,
        ARMF_RES_NEG },
    { ARM_STORM_DRAGON_HIDE,    "storm dragon hide",      5, -15,
        EQ_BODY_ARMOUR, SIZE_LITTLE, SIZE_GIANT, false,
        ARMF_RES_ELEC },
    { ARM_STORM_DRAGON_ARMOUR,  "storm dragon armour",   10, -15,
        EQ_BODY_ARMOUR, SIZE_LITTLE, SIZE_GIANT, false,
        ARMF_RES_ELEC },
    { ARM_SHADOW_DRAGON_HIDE,    "shadow dragon hide",    5, -15,
        EQ_BODY_ARMOUR, SIZE_LITTLE, SIZE_GIANT, false,
        ard(ARMF_STEALTH, 4) },
    { ARM_SHADOW_DRAGON_ARMOUR,  "shadow dragon armour", 10, -15,
        EQ_BODY_ARMOUR, SIZE_LITTLE, SIZE_GIANT, false,
        ard(ARMF_STEALTH, 4) },
    { ARM_GOLD_DRAGON_HIDE,     "gold dragon hide",       6, -23,
        EQ_BODY_ARMOUR, SIZE_LITTLE, SIZE_GIANT, false,

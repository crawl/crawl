...
enum mutation_type
{
    ...
    MUT_SERPENTINE_SKIN,
    MUT_STONE_BODY,
    MUT_DRAC_BROWN_SCALES,
    MUT_DRAC_RED_SCALES,
    MUT_DRAC_WHITE_SCALES,
    MUT_DRAC_BLACK_SCALES,
    MUT_DRAC_GREY_SCALES,
    MUT_DRAC_GREEN_SCALES,
    MUT_DRAC_PURPLE_SCALES,
    MUT_DRAC_PALE_SCALES,
    MUT_DRAC_YELLOW_SCALES,
    MUT_DRAC_COMBUSTION_BREATH,
    MUT_DRAC_GLACIAL_BREATH,
    MUT_DRAC_GALVANIC_BREATH,
    MUT_DRAC_MUD_BREATH,
    MUT_DRAC_NOXIOUS_BREATH,
    MUT_DRAC_NULLIFYING_BREATH,
    MUT_DRAC_STEAM_BREATH,
    MUT_DRAC_CAUSTIC_BREATH,
    NUM_MUTATIONS,
    CATEGORY_MUTATIONS,

...
enum dungeon_feature_type
{
    ...
    DNGN_ENTER_ELF_PASSAGE,
        DNGN_ENTER_FIRST_BRANCH = DNGN_ENTER_ELF_PASSAGE,
    ...
    DNGN_RETURN_FROM_ELF_PASSAGE,
        DNGN_RETURN_FROM_FIRST_BRANCH = DNGN_RETURN_FROM_ELF_PASSAGE,

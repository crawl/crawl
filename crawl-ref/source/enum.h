...
enum tile_flags
{
    ...
    TILE_FLAG_ATT_MASK   = 0x00030000,
    TILE_FLAG_PET        = 0x00010000,
    TILE_FLAG_GD_NEUTRAL = 0x00020000,
    TILE_FLAG_NEUTRAL    = 0x00030000,

    TILE_FLAG_S_UNDER    = 0x00040000,
    TILE_FLAG_FLYING     = 0x00080000,

    // 3 mutually exclusive flags for behaviour.
    TILE_FLAG_BEH_MASK   = 0x00300000,
    TILE_FLAG_STAB       = 0x00100000,
    TILE_FLAG_MAY_STAB   = 0x00200000,
    TILE_FLAG_FLEEING    = 0x00300000,

    TILE_FLAG_NET        = 0x00400000,
    TILE_FLAG_POISON     = 0x00800000,
    TILE_FLAG_ANIM_WEP   = 0x01000000,
    TILE_FLAG_MIMIC      = 0x02000000,
    TILE_FLAG_STICKY_FLAME = 0x04000000,
    TILE_FLAG_BERSERK    = 0x08000000,
    TILE_FLAG_INNER_FLAME= 0x10000000,
    TILE_FLAG_CONSTRICTED= 0x20000000,

    // MDAM has 5 possibilities, so uses 3 bits.
    TILE_FLAG_MDAM_MASK  = 0x1C0000000,
    TILE_FLAG_MDAM_LIGHT = 0x040000000,
    TILE_FLAG_MDAM_MOD   = 0x080000000,
    TILE_FLAG_MDAM_HEAVY = 0x0C0000000,
    TILE_FLAG_MDAM_SEV   = 0x100000000,
    TILE_FLAG_MDAM_ADEAD = 0x1C0000000,

    // Demon difficulty has 5 possibilities, so uses 3 bits.
    TILE_FLAG_DEMON      = 0xE00000000,
    TILE_FLAG_DEMON_5    = 0x200000000,
    TILE_FLAG_DEMON_4    = 0x400000000,
    TILE_FLAG_DEMON_3    = 0x600000000,
    TILE_FLAG_DEMON_2    = 0x800000000,
    TILE_FLAG_DEMON_1    = 0xE00000000,

    // Background flags
    TILE_FLAG_RAY        = 0x00010000,
    TILE_FLAG_MM_UNSEEN  = 0x00020000,
    TILE_FLAG_UNSEEN     = 0x00040000,

    // 3 mutually exclusive flags for cursors.
    TILE_FLAG_CURSOR1    = 0x00180000,
    TILE_FLAG_CURSOR2    = 0x00080000,
    TILE_FLAG_CURSOR3    = 0x00100000,
    TILE_FLAG_CURSOR     = 0x00180000,

    TILE_FLAG_TUT_CURSOR = 0x00200000,
    TILE_FLAG_TRAV_EXCL  = 0x00400000,
    TILE_FLAG_EXCL_CTR   = 0x00800000,
    TILE_FLAG_RAY_OOR    = 0x01000000,
    TILE_FLAG_OOR        = 0x02000000,
    TILE_FLAG_WATER      = 0x04000000,
    TILE_FLAG_NEW_STAIR  = 0x08000000,
    TILE_FLAG_WAS_SECRET = 0x10000000,

    // Kraken tentacle overlays.
    TILE_FLAG_KRAKEN_NW  = 0x020000000,
    TILE_FLAG_KRAKEN_NE  = 0x040000000,
    TILE_FLAG_KRAKEN_SE  = 0x080000000,
    TILE_FLAG_KRAKEN_SW  = 0x100000000,

    // Eldritch tentacle overlays.
    TILE_FLAG_ELDRITCH_NW = 0x0200000000,
    TILE_FLAG_ELDRITCH_NE = 0x0400000000,
    TILE_FLAG_ELDRITCH_SE = 0x0800000000,
    TILE_FLAG_ELDRITCH_SW = 0x1000000000,

    // General
    TILE_FLAG_MASK       = 0x0000FFFF,
};
